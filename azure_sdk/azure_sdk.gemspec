...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency 'azure_mgmt_automanage', "~>#{gem_versions['management']['azure_mgmt_automanage']}"
  ...
  spec.add_runtime_dependency 'azure_mgmt_azurestack_hci', "~>#{gem_versions['management']['azure_mgmt_azurestack_hci']}"
  ...
  spec.add_runtime_dependency 'azure_mgmt_key_vault2', "~>#{gem_versions['management']['azure_mgmt_key_vault2']}"
  ...
  spec.add_runtime_dependency 'azure_mgmt_network2', "~>#{gem_versions['management']['azure_mgmt_network2']}"
  ...
  spec.add_runtime_dependency 'azure_mgmt_portal', "~>#{gem_versions['management']['azure_mgmt_portal']}"
  ...
  spec.add_runtime_dependency 'azure_mgmt_resource_health', "~>#{gem_versions['management']['azure_mgmt_resource_health']}"
  spec.add_runtime_dependency 'azure_mgmt_resourcegraph', "~>#{gem_versions['management']['azure_mgmt_resourcegraph']}"
  spec.add_runtime_dependency 'azure_mgmt_resources2', "~>#{gem_versions['management']['azure_mgmt_resources2']}"
  ...
  spec.add_runtime_dependency 'azure_mgmt_support', "~>#{gem_versions['management']['azure_mgmt_support']}"
  spec.add_runtime_dependency 'azure_mgmt_synapse', "~>#{gem_versions['management']['azure_mgmt_synapse']}"
