  ...
  module KeyVault
    ...
    class KeyVaultDataClass
      ...
      def add_telemetry(client)
        profile_information = "Profiles/azure_sdk/#{Azure::VERSION}/V2017_03_09/KeyVault"
    ...
    module Mgmt
      ...
      class KeyVaultManagementClass
        ...
        def add_telemetry(client)
          profile_information = "Profiles/azure_sdk/#{Azure::VERSION}/V2017_03_09/KeyVault/Mgmt"
          client.add_user_agent_information(profile_information)
        end
