...
module Azure::ServiceFabric::V7_0_0_42
  ...
  class MeshApplication
    ...
    def create_or_update_async(application_resource_name, application_resource_description, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ServiceFabric::V7_0_0_42::Models::ApplicationResourceDescription.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ServiceFabric::V7_0_0_42::Models::ApplicationResourceDescription.mapper()
    ...
    def list_async(custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ServiceFabric::V7_0_0_42::Models::PagedApplicationResourceDescriptionList.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # resource.
    #
    # Gets the upgrade progress information about the Application resource with the
    # given name. The information include percentage of completion and other
    # upgrade state information of the Application resource.
    #
    # @param application_resource_name [String] The identity of the application.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    ...
    #
    def get_upgrade_progress(application_resource_name, custom_headers:nil)
      response = get_upgrade_progress_async(application_resource_name, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def get_upgrade_progress_with_http_info(application_resource_name, custom_headers:nil)
      get_upgrade_progress_async(application_resource_name, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_upgrade_progress_async(application_resource_name, custom_headers:nil)
      api_version = '7.0'
      fail ArgumentError, 'application_resource_name is nil' if application_resource_name.nil?
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'Resources/Applications/{applicationResourceName}/$/GetUpgradeProgress'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ServiceFabric::V7_0_0_42::Models::ApplicationResourceUpgradeProgressInfo.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
