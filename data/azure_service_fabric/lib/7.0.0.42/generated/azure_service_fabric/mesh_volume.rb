...
module Azure::ServiceFabric::V7_0_0_42
  ...
  class MeshVolume
    ...
    def create_or_update_async(volume_resource_name, volume_resource_description, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ServiceFabric::V7_0_0_42::Models::VolumeResourceDescription.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ServiceFabric::V7_0_0_42::Models::VolumeResourceDescription.mapper()
    ...
    def list_async(custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ServiceFabric::V7_0_0_42::Models::PagedVolumeResourceDescriptionList.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
