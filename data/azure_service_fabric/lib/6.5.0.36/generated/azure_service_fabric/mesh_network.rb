...
module Azure::ServiceFabric::V6_5_0_36
  ...
  class MeshNetwork
    ...
    def create_or_update_async(network_resource_name, network_resource_description, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ServiceFabric::V6_5_0_36::Models::NetworkResourceDescription.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ServiceFabric::V6_5_0_36::Models::NetworkResourceDescription.mapper()
    ...
    def list_async(custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ServiceFabric::V6_5_0_36::Models::PagedNetworkResourceDescriptionList.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
