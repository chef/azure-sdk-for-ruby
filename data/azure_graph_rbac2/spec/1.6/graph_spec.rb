...
describe 'GraphRbacClient' do
  ...
  it 'should list all existing users using lazy paging' do
    ...
    expect(first_page.value[0]).to be_a(Azure::GraphRbac2::V1_6::Models::User)

    # Retrieve next page from first_page
    next_page = first_page.get_next_page
    expect(next_page).not_to be_nil
    expect(next_page.value).to be_a(Array)
    expect(next_page.value[0]).to be_a(Azure::GraphRbac2::V1_6::Models::User)
  end
  ...
  it 'should list all existing users synchronously' do
    ...
    expect(all_users[0]).to be_a(Azure::GraphRbac2::V1_6::Models::User)
  end

  it 'should create new user' do
    user_param = Azure::GraphRbac2::V1_6::Models::UserCreateParameters.new
    user_param.account_enabled = true
    user_param.password_profile = Azure::GraphRbac2::V1_6::Models::PasswordProfile.new.tap do |profile|
