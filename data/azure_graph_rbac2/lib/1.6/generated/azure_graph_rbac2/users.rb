...
module Azure::GraphRbac2::V1_6
  ...
  class Users
    ...
    def create_async(parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::GraphRbac2::V1_6::Models::UserCreateParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 201
          begin
            ...
            result_mapper = Azure::GraphRbac2::V1_6::Models::User.mapper()
    ...
    def list_async(filter:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::GraphRbac2::V1_6::Models::UserListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def update_async(upn_or_object_id, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::GraphRbac2::V1_6::Models::UserUpdateParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def get_member_groups_async(object_id, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::GraphRbac2::V1_6::Models::UserGetMemberGroupsParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::GraphRbac2::V1_6::Models::UserGetMemberGroupsResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
