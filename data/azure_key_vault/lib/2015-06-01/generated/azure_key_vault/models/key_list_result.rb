...
module Azure::KeyVault::V2015_06_01
  module Models
    ...
    class KeyListResult
      ...
      # in the vault along with a link to the next page of keys
      attr_accessor :value

      # @return [String] The URL to get the next set of keys.
      ...
      #
      # @return [KeyListResult] with next page content.
      #
      def get_next_page
              ...
              value: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'KeyItemElementType',
                      type: {
                        name: 'Composite',
                        class_name: 'KeyItem'
                      }
