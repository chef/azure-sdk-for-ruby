...
module Azure::Reservations::Mgmt::V2018_06_01_preview
  ...
  class Reservation
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Reservations::Mgmt::V2018_06_01_preview::Models::ReservationList.mapper()
    ...
    def get_async(reservation_id, reservation_order_id, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Reservations::Mgmt::V2018_06_01_preview::Models::ReservationResponse.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_split_async(reservation_order_id, body, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Reservations::Mgmt::V2018_06_01_preview::Models::SplitRequest.mapper()
    ...
    def begin_merge_async(reservation_order_id, body, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Reservations::Mgmt::V2018_06_01_preview::Models::MergeRequest.mapper()
      request_content = @client.serialize(request_mapper,  body)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_update_async(reservation_order_id, reservation_id, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Reservations::Mgmt::V2018_06_01_preview::Models::Patch.mapper()
