...
module Azure::Reservations::Mgmt::V2019_07_19_preview
  module Models
    ...
    class QuotaLimits
      ...
      # @return [Array<CurrentQuotaLimitBase>] List of Quota limits.
      attr_accessor :value
      ...
      #
      # @return [QuotaLimits] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for QuotaLimits class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'QuotaLimits',
          type: {
            name: 'Composite',
            class_name: 'QuotaLimits',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
