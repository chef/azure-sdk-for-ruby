...
module Azure::CustomerInsights::Mgmt::V2017_01_01
  ...
  class WidgetTypes
    ...
    #
    # Creates and initializes a new instance of the WidgetTypes class.
    ...
    #
    # @return [Array<WidgetTypeResourceFormat>] operation results.
    #
    ...
    def list_by_hub_async(resource_group_name, hub_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CustomerInsights/hubs/{hubName}/widgetTypes'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::CustomerInsights::Mgmt::V2017_01_01::Models::WidgetTypeListResult.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [WidgetTypeResourceFormat] operation results.
    #
    def get(resource_group_name, hub_name, widget_type_name, custom_headers:nil)
      response = get_async(resource_group_name, hub_name, widget_type_name, custom_headers:custom_headers).value!
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_async(resource_group_name, hub_name, widget_type_name, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'hub_name is nil' if hub_name.nil?
      fail ArgumentError, 'widget_type_name is nil' if widget_type_name.nil?
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CustomerInsights/hubs/{hubName}/widgetTypes/{widgetTypeName}'

      request_url = @base_url || @client.base_url

      options = {
          middlewares: [[MsRest2::RetryPolicyMiddleware, times: 3, retry: 0.02], [:cookie_jar]],
          path_params: {'resourceGroupName' => resource_group_name,'hubName' => hub_name,'widgetTypeName' => widget_type_name,'subscriptionId' => @client.subscription_id},
          query_params: {'api-version' => @client.api_version},
          headers: request_headers.merge(custom_headers || {}),
          base_url: request_url
      }
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CustomerInsights::Mgmt::V2017_01_01::Models::WidgetTypeResourceFormat.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # will be added to the HTTP request.
    #
    # @return [WidgetTypeListResult] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [WidgetTypeListResult] which provide lazy access to pages of the
    # response.
    #
