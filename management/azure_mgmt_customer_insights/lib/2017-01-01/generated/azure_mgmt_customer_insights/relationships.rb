...
module Azure::CustomerInsights::Mgmt::V2017_01_01
  ...
  class Relationships
    ...
    #
    # Creates and initializes a new instance of the Relationships class.
    ...
    def create_or_update_async(resource_group_name, hub_name, relationship_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::CustomerInsights::Mgmt::V2017_01_01::Models::RelationshipResourceFormat.mapper()
    ...
    def get_async(resource_group_name, hub_name, relationship_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CustomerInsights/hubs/{hubName}/relationships/{relationshipName}'

      request_url = @base_url || @client.base_url

      options = {
          middlewares: [[MsRest2::RetryPolicyMiddleware, times: 3, retry: 0.02], [:cookie_jar]],
          path_params: {'resourceGroupName' => resource_group_name,'hubName' => hub_name,'relationshipName' => relationship_name,'subscriptionId' => @client.subscription_id},
    ...
    def list_by_hub_async(resource_group_name, hub_name, custom_headers:nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CustomerInsights/hubs/{hubName}/relationships'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CustomerInsights::Mgmt::V2017_01_01::Models::RelationshipListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, hub_name, relationship_name, parameters, custom_headers:nil)
      ...
      fail ArgumentError, 'hub_name is nil' if hub_name.nil?
      fail ArgumentError, 'relationship_name is nil' if relationship_name.nil?
      fail ArgumentError, "'relationship_name' should satisfy the constraint - 'MaxLength': '512'" if !relationship_name.nil? && relationship_name.length > 512
      fail ArgumentError, "'relationship_name' should satisfy the constraint - 'MinLength': '1'" if !relationship_name.nil? && relationship_name.length < 1
      fail ArgumentError, "'relationship_name' should satisfy the constraint - 'Pattern': '^[a-zA-Z][a-zA-Z0-9_]+$'" if !relationship_name.nil? && relationship_name.match(Regexp.new('^^[a-zA-Z][a-zA-Z0-9_]+$$')).nil?
      ...
      # Serialize Request
      request_mapper = Azure::CustomerInsights::Mgmt::V2017_01_01::Models::RelationshipResourceFormat.mapper()
