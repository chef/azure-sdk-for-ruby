...
module Azure::CustomerInsights::Mgmt::V2017_04_26
  module Models
    ...
    #
    class RelationshipLinkListResult

      include MsRestAzure

      include MsRest2::JSONable
      # @return [Array<RelationshipLinkResourceFormat>] Results of the list
      # operation.
      attr_accessor :value
      ...
      #
      # @return [RelationshipLinkListResult] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for RelationshipLinkListResult class as Ruby Hash.
