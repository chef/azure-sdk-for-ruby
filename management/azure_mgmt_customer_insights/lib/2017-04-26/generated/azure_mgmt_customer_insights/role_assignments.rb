      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::CustomerInsights::Mgmt::V2017_04_26::Models::RoleAssignmentListResult.mapper()
    ...
    def create_or_update_async(resource_group_name, hub_name, assignment_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::CustomerInsights::Mgmt::V2017_04_26::Models::RoleAssignmentResourceFormat.mapper()
