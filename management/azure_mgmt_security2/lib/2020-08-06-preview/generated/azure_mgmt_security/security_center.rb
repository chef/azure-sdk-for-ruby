...
module Azure::Security2::Mgmt::V2020_08_06_preview
  ...
  class SecurityCenter < MsRestAzure2::AzureServiceClient
    ...
    # @return [IotDefenderSettings] iot_defender_settings
    attr_reader :iot_defender_settings

    # @return [IotSensors] iot_sensors
    attr_reader :iot_sensors

    # @return [DevicesForSubscription] devices_for_subscription
    attr_reader :devices_for_subscription

    # @return [DevicesForHub] devices_for_hub
    attr_reader :devices_for_hub

    # @return [DeviceOperations] device_operations
    attr_reader :device_operations

    # @return [OnPremiseIotSensors] on_premise_iot_sensors
    attr_reader :on_premise_iot_sensors
    ...
    #
    def add_telemetry
        sdk_information = 'azure_mgmt_security2'
