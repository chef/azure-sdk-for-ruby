...
module Azure::Security2::Mgmt::V2015_06_01_preview
  ...
  class AdaptiveNetworkHardenings
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Security2::Mgmt::V2015_06_01_preview::Models::AdaptiveNetworkHardeningsList.mapper()
    ...
    def get_async(resource_group_name, resource_namespace, resource_type, resource_name, adaptive_network_hardening_resource_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Security2::Mgmt::V2015_06_01_preview::Models::AdaptiveNetworkHardening.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_enforce_async(resource_group_name, resource_namespace, resource_type, resource_name, adaptive_network_hardening_resource_name, body, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Security2::Mgmt::V2015_06_01_preview::Models::AdaptiveNetworkHardeningEnforceRequest.mapper()
