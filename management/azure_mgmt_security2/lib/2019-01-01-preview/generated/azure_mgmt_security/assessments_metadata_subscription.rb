...
module Azure::Security2::Mgmt::V2019_01_01_preview
  ...
  class AssessmentsMetadataSubscription
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Security2::Mgmt::V2019_01_01_preview::Models::SecurityAssessmentMetadataList.mapper()
    ...
    def get_async(assessment_metadata_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Security2::Mgmt::V2019_01_01_preview::Models::SecurityAssessmentMetadata.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_async(assessment_metadata_name, assessment_metadata, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Security2::Mgmt::V2019_01_01_preview::Models::SecurityAssessmentMetadata.mapper()
