...
module Azure::Security2::Mgmt::V2017_08_01_preview
  ...
  #
  class IoTSecuritySolutionsAnalyticsRecommendations
    include MsRestAzure2

    #
    # Creates and initializes a new instance of the IoTSecuritySolutionsAnalyticsRecommendations class.
    ...
    # @param top [Integer] The number of results to retrieve.
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Security2::Mgmt::V2017_08_01_preview::Models::IoTSecurityAggregatedRecommendationList.mapper()
