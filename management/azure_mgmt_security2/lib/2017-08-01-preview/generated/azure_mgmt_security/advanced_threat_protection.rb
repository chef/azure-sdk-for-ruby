...
module Azure::Security2::Mgmt::V2017_08_01_preview
  ...
  class AdvancedThreatProtection
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Security2::Mgmt::V2017_08_01_preview::Models::AdvancedThreatProtectionSetting.mapper()
    ...
    def create_async(resource_id, advanced_threat_protection_setting, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Security2::Mgmt::V2017_08_01_preview::Models::AdvancedThreatProtectionSetting.mapper()
