...
module Azure::Security2::Mgmt::V2017_08_01_preview
  ...
  class InformationProtectionPolicies
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Security2::Mgmt::V2017_08_01_preview::Models::InformationProtectionPolicy.mapper()
    ...
    def create_or_update_async(scope, information_protection_policy_name, information_protection_policy, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Security2::Mgmt::V2017_08_01_preview::Models::InformationProtectionPolicy.mapper()
    ...
    def list_async(scope, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Security2::Mgmt::V2017_08_01_preview::Models::InformationProtectionPolicyList.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
