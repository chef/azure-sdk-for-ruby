...
module Azure::Security2::Mgmt::V2017_08_01_preview
  module Models
    ...
    class MqttD2CMessagesNotInAllowedRange < TimeWindowCustomAlertRule
      ...
      #
      # Mapper for MqttD2CMessagesNotInAllowedRange class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'MqttD2CMessagesNotInAllowedRange',
          type: {
            name: 'Composite',
            class_name: 'MqttD2CMessagesNotInAllowedRange',
            model_properties: {
              display_name: {
                client_side_validation: true,
                required: false,
