...
module Azure::Security2::Mgmt::V2017_08_01_preview
  module Models
    ...
    class AmqpC2DMessagesNotInAllowedRange < TimeWindowCustomAlertRule
      ...
      #
      # Mapper for AmqpC2DMessagesNotInAllowedRange class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'AmqpC2DMessagesNotInAllowedRange',
          type: {
            name: 'Composite',
            class_name: 'AmqpC2DMessagesNotInAllowedRange',
            model_properties: {
              display_name: {
                client_side_validation: true,
                required: false,
