...
module Azure::Security2::Mgmt::V2017_08_01_preview
  module Models
    ...
    class AmqpC2DRejectedMessagesNotInAllowedRange < TimeWindowCustomAlertRule
      ...
      #
      # Mapper for AmqpC2DRejectedMessagesNotInAllowedRange class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'AmqpC2DRejectedMessagesNotInAllowedRange',
          type: {
            name: 'Composite',
            class_name: 'AmqpC2DRejectedMessagesNotInAllowedRange',
            model_properties: {
              display_name: {
                client_side_validation: true,
                required: false,
