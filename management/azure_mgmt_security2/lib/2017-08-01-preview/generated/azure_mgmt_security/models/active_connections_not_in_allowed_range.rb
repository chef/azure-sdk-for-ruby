...
module Azure::Security2::Mgmt::V2017_08_01_preview
  module Models
    ...
    class ActiveConnectionsNotInAllowedRange < TimeWindowCustomAlertRule
      ...
      #
      # Mapper for ActiveConnectionsNotInAllowedRange class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ActiveConnectionsNotInAllowedRange',
          type: {
            name: 'Composite',
            class_name: 'ActiveConnectionsNotInAllowedRange',
            model_properties: {
              display_name: {
                client_side_validation: true,
                required: false,
