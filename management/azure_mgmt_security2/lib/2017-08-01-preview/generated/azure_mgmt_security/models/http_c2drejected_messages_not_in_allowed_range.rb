...
module Azure::Security2::Mgmt::V2017_08_01_preview
  module Models
    ...
    class HttpC2DRejectedMessagesNotInAllowedRange < TimeWindowCustomAlertRule
      ...
      #
      # Mapper for HttpC2DRejectedMessagesNotInAllowedRange class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'HttpC2DRejectedMessagesNotInAllowedRange',
          type: {
            name: 'Composite',
            class_name: 'HttpC2DRejectedMessagesNotInAllowedRange',
            model_properties: {
              display_name: {
                client_side_validation: true,
                required: false,
