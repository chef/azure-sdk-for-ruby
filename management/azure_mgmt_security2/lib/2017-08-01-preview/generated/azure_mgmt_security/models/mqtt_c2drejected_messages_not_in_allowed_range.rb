...
module Azure::Security2::Mgmt::V2017_08_01_preview
  module Models
    ...
    class MqttC2DRejectedMessagesNotInAllowedRange < TimeWindowCustomAlertRule
      ...
      #
      # Mapper for MqttC2DRejectedMessagesNotInAllowedRange class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'MqttC2DRejectedMessagesNotInAllowedRange',
          type: {
            name: 'Composite',
            class_name: 'MqttC2DRejectedMessagesNotInAllowedRange',
            model_properties: {
              display_name: {
                client_side_validation: true,
                required: false,
