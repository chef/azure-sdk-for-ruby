...
module Azure::Security2::Mgmt::V2017_08_01_preview
  module Models
    ...
    class DirectMethodInvokesNotInAllowedRange < TimeWindowCustomAlertRule
      ...
      #
      # Mapper for DirectMethodInvokesNotInAllowedRange class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'DirectMethodInvokesNotInAllowedRange',
          type: {
            name: 'Composite',
            class_name: 'DirectMethodInvokesNotInAllowedRange',
            model_properties: {
              display_name: {
                client_side_validation: true,
                required: false,
