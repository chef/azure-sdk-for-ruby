...
module Azure::Security2::Mgmt::V2017_08_01_preview
  ...
  class IotSecuritySolution
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Security2::Mgmt::V2017_08_01_preview::Models::IoTSecuritySolutionModel.mapper()
    ...
    def create_async(resource_group_name, solution_name, iot_security_solution_data, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Security2::Mgmt::V2017_08_01_preview::Models::IoTSecuritySolutionModel.mapper()
    ...
    def update_async(resource_group_name, solution_name, update_iot_security_solution_data, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Security2::Mgmt::V2017_08_01_preview::Models::UpdateIotSecuritySolutionData.mapper()
