...
module Azure::Security2::Mgmt::V2017_08_01_preview
  ...
  #
  class IoTSecuritySolutionsAnalyticsAggregatedAlerts
    include MsRestAzure

    #
    # Creates and initializes a new instance of the IoTSecuritySolutionsAnalyticsAggregatedAlerts class.
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Security2::Mgmt::V2017_08_01_preview::Models::IoTSecurityAggregatedAlertList.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [IoTSecurityAggregatedAlertList] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [IoTSecurityAggregatedAlertList] which provide lazy access to pages
    # of the response.
    #
