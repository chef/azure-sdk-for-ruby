...
module Azure::Security2::Mgmt::V2019_08_01
  ...
  class IotSecuritySolution
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Security2::Mgmt::V2019_08_01::Models::IoTSecuritySolutionsList.mapper()
    ...
    def get_async(resource_group_name, solution_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Security2::Mgmt::V2019_08_01::Models::IoTSecuritySolutionModel.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, solution_name, iot_security_solution_data, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Security2::Mgmt::V2019_08_01::Models::IoTSecuritySolutionModel.mapper()
    ...
    def update_async(resource_group_name, solution_name, update_iot_security_solution_data, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Security2::Mgmt::V2019_08_01::Models::UpdateIotSecuritySolutionData.mapper()
