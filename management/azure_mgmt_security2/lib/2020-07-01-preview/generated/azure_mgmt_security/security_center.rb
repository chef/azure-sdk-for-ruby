...
module Azure::Security2::Mgmt::V2020_07_01_preview
  ...
  class SecurityCenter < MsRestAzure2::AzureServiceClient
    ...
    def initialize(credentials = nil, base_url = nil, options = nil)
      ...
      @sql_vulnerability_assessment_scans = SqlVulnerabilityAssessmentScans.new(self)
      @sql_vulnerability_assessment_scan_results = SqlVulnerabilityAssessmentScanResults.new(self)
      @sql_vulnerability_assessment_baseline_rules = SqlVulnerabilityAssessmentBaselineRules.new(self)
