...
module Azure::Security2::Mgmt::V2020_01_01
  ...
  class Assessments
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Security2::Mgmt::V2020_01_01::Models::SecurityAssessmentList.mapper()
    ...
    def get_async(resource_id, assessment_name, expand:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Security2::Mgmt::V2020_01_01::Models::SecurityAssessment.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_id, assessment_name, assessment, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Security2::Mgmt::V2020_01_01::Models::SecurityAssessment.mapper()
