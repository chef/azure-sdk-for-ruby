...
module Azure::Resources2::Mgmt::V2019_10_01
  module Models
    ...
    class TagsResource
      ...
      # @return [String] The ID of the tags wrapper resource.
      attr_accessor :id

      # @return [String] The name of the tags wrapper resource.
      attr_accessor :name

      # @return [String] The type of the tags wrapper resource.
      attr_accessor :type
