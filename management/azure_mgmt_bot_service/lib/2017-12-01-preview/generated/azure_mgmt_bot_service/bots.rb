...
module Azure::BotService::Mgmt::V2017_12_01_preview
  ...
  class Bots
    ...
    def create_async(resource_group_name, resource_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::BotService::Mgmt::V2017_12_01_preview::Models::Bot.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::BotService::Mgmt::V2017_12_01_preview::Models::Bot.mapper()
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::BotService::Mgmt::V2017_12_01_preview::Models::BotResponseList.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_check_name_availability_async(parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::BotService::Mgmt::V2017_12_01_preview::Models::CheckNameAvailabilityRequestBody.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil

      path_template = 'providers/Microsoft.BotService/botServices/checkNameAvailability'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::BotService::Mgmt::V2017_12_01_preview::Models::CheckNameAvailabilityResponseBody.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
