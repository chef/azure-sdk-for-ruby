...
module Azure::Cosmosdb::Mgmt::V2020_06_01_preview
  ...
  class CosmosDBManagementClient < MsRestAzure::AzureServiceClient
    ...
    # @return [RestorableDatabaseAccounts] restorable_database_accounts
    attr_reader :restorable_database_accounts

    # @return [RestorableSqlDatabases] restorable_sql_databases
    attr_reader :restorable_sql_databases

    # @return [RestorableSqlContainers] restorable_sql_containers
    attr_reader :restorable_sql_containers

    # @return [RestorableSqlResources] restorable_sql_resources
    attr_reader :restorable_sql_resources

    # @return [RestorableMongodbDatabases] restorable_mongodb_databases
    attr_reader :restorable_mongodb_databases

    # @return [RestorableMongodbCollections] restorable_mongodb_collections
    attr_reader :restorable_mongodb_collections

    # @return [RestorableMongodbResources] restorable_mongodb_resources
    attr_reader :restorable_mongodb_resources
