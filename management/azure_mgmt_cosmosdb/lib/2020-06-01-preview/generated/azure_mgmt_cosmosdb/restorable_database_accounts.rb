...
module Azure::Cosmosdb::Mgmt::V2020_06_01_preview
  ...
  #
  class RestorableDatabaseAccounts
    include MsRestAzure
    ...
    #
    # @return [RestorableDatabaseAccountsListResult] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [RestorableDatabaseAccountGetResult] operation results.
    #
