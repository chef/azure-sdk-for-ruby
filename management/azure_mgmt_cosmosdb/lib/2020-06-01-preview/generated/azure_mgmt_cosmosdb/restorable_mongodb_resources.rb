...
module Azure::Cosmosdb::Mgmt::V2020_06_01_preview
  ...
  #
  class RestorableMongodbResources
    include MsRestAzure

    #
    # Creates and initializes a new instance of the RestorableMongodbResources class.
    ...
    # account.
    # @param restore_location [String] The location where the restorable resources
    # are located.
    # @param restore_timestamp_in_utc [String] The timestamp when the restorable
    # resources existed.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [RestorableMongodbResourcesListResult] operation results.
    #
    ...
    def list_async(location, instance_id, restore_location:nil, restore_timestamp_in_utc:nil, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}/restorableDatabaseAccounts/{instanceId}/restorableMongodbResources'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Cosmosdb::Mgmt::V2020_06_01_preview::Models::RestorableMongodbResourcesListResult.mapper()
