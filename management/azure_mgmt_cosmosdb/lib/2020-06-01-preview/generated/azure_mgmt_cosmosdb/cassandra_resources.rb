...
module Azure::Cosmosdb::Mgmt::V2020_06_01_preview
  ...
  class CassandraResources
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Cosmosdb::Mgmt::V2020_06_01_preview::Models::CassandraKeyspaceListResult.mapper()
    ...
    def get_cassandra_keyspace_async(resource_group_name, account_name, keyspace_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Cosmosdb::Mgmt::V2020_06_01_preview::Models::CassandraKeyspaceGetResults.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_cassandra_tables_async(resource_group_name, account_name, keyspace_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Cosmosdb::Mgmt::V2020_06_01_preview::Models::CassandraTableListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_cassandra_table_async(resource_group_name, account_name, keyspace_name, table_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Cosmosdb::Mgmt::V2020_06_01_preview::Models::CassandraTableGetResults.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_update_cassandra_keyspace_async(resource_group_name, account_name, keyspace_name, create_update_cassandra_keyspace_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Cosmosdb::Mgmt::V2020_06_01_preview::Models::CassandraKeyspaceCreateUpdateParameters.mapper()
    ...
    def begin_create_update_cassandra_table_async(resource_group_name, account_name, keyspace_name, table_name, create_update_cassandra_table_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Cosmosdb::Mgmt::V2020_06_01_preview::Models::CassandraTableCreateUpdateParameters.mapper()
