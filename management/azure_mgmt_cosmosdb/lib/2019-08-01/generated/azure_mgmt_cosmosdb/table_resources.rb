...
module Azure::Cosmosdb::Mgmt::V2019_08_01
  ...
  class TableResources
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Cosmosdb::Mgmt::V2019_08_01::Models::TableListResult.mapper()
    ...
    def get_table_async(resource_group_name, account_name, table_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Cosmosdb::Mgmt::V2019_08_01::Models::TableGetResults.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_update_table_async(resource_group_name, account_name, table_name, create_update_table_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Cosmosdb::Mgmt::V2019_08_01::Models::TableCreateUpdateParameters.mapper()
