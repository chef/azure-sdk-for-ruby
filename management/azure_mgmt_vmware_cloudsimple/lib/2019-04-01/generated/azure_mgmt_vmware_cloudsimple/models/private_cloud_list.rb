...
module Azure::VMwareCloudSimple::Mgmt::V2019_04_01
  module Models
    ...
    class PrivateCloudList
      ...
      #
      # @return [PrivateCloudList] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for PrivateCloudList class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'PrivateCloudList',
          type: {
            name: 'Composite',
            class_name: 'PrivateCloudList',
            model_properties: {
              next_link: {
                client_side_validation: true,
                required: false,
              ...
              value: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'PrivateCloudElementType',
                      type: {
                        name: 'Composite',
