...
module Azure::VMwareCloudSimple::Mgmt::V2019_04_01
  module Models
    ...
    class UsageListResponse
      ...
      #
      # @return [UsageListResponse] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for UsageListResponse class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'UsageListResponse',
          type: {
            name: 'Composite',
            class_name: 'UsageListResponse',
            model_properties: {
              next_link: {
                client_side_validation: true,
                required: false,
