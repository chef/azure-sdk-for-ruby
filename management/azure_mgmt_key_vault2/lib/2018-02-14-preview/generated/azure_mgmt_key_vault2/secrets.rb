...
module Azure::KeyVault2::Mgmt::V2018_02_14_preview
  ...
  class Secrets
    ...
    def create_or_update_async(resource_group_name, vault_name, secret_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::KeyVault2::Mgmt::V2018_02_14_preview::Models::SecretCreateOrUpdateParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 201
          begin
            ...
            result_mapper = Azure::KeyVault2::Mgmt::V2018_02_14_preview::Models::Secret.mapper()
    ...
    def update_async(resource_group_name, vault_name, secret_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::KeyVault2::Mgmt::V2018_02_14_preview::Models::SecretPatchParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def list_async(resource_group_name, vault_name, top:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::KeyVault2::Mgmt::V2018_02_14_preview::Models::SecretListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
