...
module Azure::DataMigration::Mgmt::V2018_04_19
  module Models
    ...
    class ProjectList
      ...
      # @return [String] URL to load the next page of projects
      ...
      #
      # @return [ProjectList] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for ProjectList class as Ruby Hash.
