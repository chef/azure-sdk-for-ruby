...
module Azure::DataMigration::Mgmt::V2018_03_31_preview
  ...
  class Projects
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::DataMigration::Mgmt::V2018_03_31_preview::Models::ProjectList.mapper()
    ...
    def create_or_update_async(parameters, group_name, service_name, project_name, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::DataMigration::Mgmt::V2018_03_31_preview::Models::Project.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DataMigration::Mgmt::V2018_03_31_preview::Models::Project.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
