...
module Azure::DataMigration::Mgmt::V2018_03_31_preview
  ...
  class Operations
    ...
    def list_async(custom_headers:nil)
      ...
      path_template = 'providers/Microsoft.DataMigration/operations'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::DataMigration::Mgmt::V2018_03_31_preview::Models::ServiceOperationList.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [ServiceOperationList] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [ServiceOperationList] which provide lazy access to pages of the
    # response.
    #
