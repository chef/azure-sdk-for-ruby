...
module Azure::DataMigration::Mgmt::V2018_07_15_preview
  ...
  class Usages
    ...
    #
    # This method returns region-specific quotas and resource usage information for
    ...
    #
    # @return [Array<Quota>] operation results.
    #
    ...
    def list_async(location, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/providers/Microsoft.DataMigration/locations/{location}/usages'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::DataMigration::Mgmt::V2018_07_15_preview::Models::QuotaList.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [QuotaList] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [QuotaList] which provide lazy access to pages of the response.
    #
