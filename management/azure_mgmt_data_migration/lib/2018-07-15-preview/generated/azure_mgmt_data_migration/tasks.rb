...
module Azure::DataMigration::Mgmt::V2018_07_15_preview
  ...
  class Tasks
    ...
    # @param project_name [String] Name of the project
    # @param task_name [String] Name of the Task
    # @param parameters [CommandProperties] Command to execute
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [CommandProperties] operation results.
    #
    def command(group_name, service_name, project_name, task_name, parameters, custom_headers:nil)
      response = command_async(group_name, service_name, project_name, task_name, parameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def command_with_http_info(group_name, service_name, project_name, task_name, parameters, custom_headers:nil)
      command_async(group_name, service_name, project_name, task_name, parameters, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def command_async(group_name, service_name, project_name, task_name, parameters, custom_headers:nil)
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'group_name is nil' if group_name.nil?
      fail ArgumentError, 'service_name is nil' if service_name.nil?
      fail ArgumentError, 'project_name is nil' if project_name.nil?
      ...
      # Serialize Request
      request_mapper = Azure::DataMigration::Mgmt::V2018_07_15_preview::Models::CommandProperties.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil

      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.DataMigration/services/{serviceName}/projects/{projectName}/tasks/{taskName}/command'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DataMigration::Mgmt::V2018_07_15_preview::Models::CommandProperties.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
