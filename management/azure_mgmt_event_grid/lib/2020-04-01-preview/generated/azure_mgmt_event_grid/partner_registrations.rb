...
module Azure::EventGrid::Mgmt::V2020_04_01_preview
  ...
  class PartnerRegistrations
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::EventGrid::Mgmt::V2020_04_01_preview::Models::PartnerRegistration.mapper()
    ...
    def create_or_update_async(resource_group_name, partner_registration_name, partner_registration_info, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::EventGrid::Mgmt::V2020_04_01_preview::Models::PartnerRegistration.mapper()
    ...
    def update_async(resource_group_name, partner_registration_name, partner_registration_update_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::EventGrid::Mgmt::V2020_04_01_preview::Models::PartnerRegistrationUpdateParameters.mapper()
    ...
    def list_by_subscription_async(filter:nil, top:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::EventGrid::Mgmt::V2020_04_01_preview::Models::PartnerRegistrationsListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
