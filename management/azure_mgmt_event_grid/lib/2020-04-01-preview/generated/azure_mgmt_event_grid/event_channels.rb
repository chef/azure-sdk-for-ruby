...
module Azure::EventGrid::Mgmt::V2020_04_01_preview
  ...
  class EventChannels
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::EventGrid::Mgmt::V2020_04_01_preview::Models::EventChannel.mapper()
    ...
    def create_or_update_async(resource_group_name, partner_namespace_name, event_channel_name, event_channel_info, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::EventGrid::Mgmt::V2020_04_01_preview::Models::EventChannel.mapper()
    ...
    def list_by_partner_namespace_async(resource_group_name, partner_namespace_name, filter:nil, top:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::EventGrid::Mgmt::V2020_04_01_preview::Models::EventChannelsListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
