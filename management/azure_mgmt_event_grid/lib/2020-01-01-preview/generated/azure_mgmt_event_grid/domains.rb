...
module Azure::EventGrid::Mgmt::V2020_01_01_preview
  ...
  class Domains
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::EventGrid::Mgmt::V2020_01_01_preview::Models::Domain.mapper()
    ...
    def list_by_subscription_async(filter:nil, top:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::EventGrid::Mgmt::V2020_01_01_preview::Models::DomainsListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_shared_access_keys_async(resource_group_name, domain_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::EventGrid::Mgmt::V2020_01_01_preview::Models::DomainSharedAccessKeys.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def regenerate_key_async(resource_group_name, domain_name, regenerate_key_request, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::EventGrid::Mgmt::V2020_01_01_preview::Models::DomainRegenerateKeyRequest.mapper()
    ...
    def begin_create_or_update_async(resource_group_name, domain_name, domain_info, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::EventGrid::Mgmt::V2020_01_01_preview::Models::Domain.mapper()
    ...
    def begin_update_async(resource_group_name, domain_name, domain_update_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::EventGrid::Mgmt::V2020_01_01_preview::Models::DomainUpdateParameters.mapper()
