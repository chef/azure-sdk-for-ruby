...
module Azure::EventGrid::Mgmt::V2020_06_01
  ...
  class EventSubscriptions
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::EventGrid::Mgmt::V2020_06_01::Models::EventSubscription.mapper()
    ...
    def get_full_url_async(scope, event_subscription_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::EventGrid::Mgmt::V2020_06_01::Models::EventSubscriptionFullUrl.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_global_by_subscription_async(filter:nil, top:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::EventGrid::Mgmt::V2020_06_01::Models::EventSubscriptionsListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(scope, event_subscription_name, event_subscription_info, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::EventGrid::Mgmt::V2020_06_01::Models::EventSubscription.mapper()
    ...
    def begin_update_async(scope, event_subscription_name, event_subscription_update_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::EventGrid::Mgmt::V2020_06_01::Models::EventSubscriptionUpdateParameters.mapper()
