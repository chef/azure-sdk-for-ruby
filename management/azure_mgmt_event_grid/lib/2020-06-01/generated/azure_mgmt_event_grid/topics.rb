...
module Azure::EventGrid::Mgmt::V2020_06_01
  ...
  class Topics
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::EventGrid::Mgmt::V2020_06_01::Models::Topic.mapper()
    ...
    def list_by_subscription_async(filter:nil, top:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::EventGrid::Mgmt::V2020_06_01::Models::TopicsListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_shared_access_keys_async(resource_group_name, topic_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::EventGrid::Mgmt::V2020_06_01::Models::TopicSharedAccessKeys.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def regenerate_key_async(resource_group_name, topic_name, regenerate_key_request, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::EventGrid::Mgmt::V2020_06_01::Models::TopicRegenerateKeyRequest.mapper()
    ...
    def begin_create_or_update_async(resource_group_name, topic_name, topic_info, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::EventGrid::Mgmt::V2020_06_01::Models::Topic.mapper()
    ...
    def begin_update_async(resource_group_name, topic_name, topic_update_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::EventGrid::Mgmt::V2020_06_01::Models::TopicUpdateParameters.mapper()
