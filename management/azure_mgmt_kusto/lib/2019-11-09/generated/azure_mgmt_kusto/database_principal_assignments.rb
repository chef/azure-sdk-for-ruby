...
module Azure::Kusto::Mgmt::V2019_11_09
  ...
  class DatabasePrincipalAssignments
    ...
    def check_name_availability_async(resource_group_name, cluster_name, database_name, principal_assignment_name, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Kusto::Mgmt::V2019_11_09::Models::DatabasePrincipalAssignmentCheckNameRequest.mapper()
    ...
    def get_async(resource_group_name, cluster_name, database_name, principal_assignment_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Kusto::Mgmt::V2019_11_09::Models::DatabasePrincipalAssignment.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_async(resource_group_name, cluster_name, database_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Kusto::Mgmt::V2019_11_09::Models::DatabasePrincipalAssignmentListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, cluster_name, database_name, principal_assignment_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Kusto::Mgmt::V2019_11_09::Models::DatabasePrincipalAssignment.mapper()
