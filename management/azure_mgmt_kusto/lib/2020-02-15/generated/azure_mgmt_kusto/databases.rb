...
module Azure::Kusto::Mgmt::V2020_02_15
  ...
  class Databases
    ...
    def check_name_availability_async(resource_group_name, cluster_name, resource_name, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Kusto::Mgmt::V2020_02_15::Models::CheckNameRequest.mapper()
    ...
    def list_by_cluster_async(resource_group_name, cluster_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Kusto::Mgmt::V2020_02_15::Models::DatabaseListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_async(resource_group_name, cluster_name, database_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Kusto::Mgmt::V2020_02_15::Models::Database.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_principals_async(resource_group_name, cluster_name, database_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Kusto::Mgmt::V2020_02_15::Models::DatabasePrincipalListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def add_principals_async(resource_group_name, cluster_name, database_name, database_principals_to_add, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Kusto::Mgmt::V2020_02_15::Models::DatabasePrincipalListRequest.mapper()
    ...
    def begin_create_or_update_async(resource_group_name, cluster_name, database_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Kusto::Mgmt::V2020_02_15::Models::Database.mapper()
