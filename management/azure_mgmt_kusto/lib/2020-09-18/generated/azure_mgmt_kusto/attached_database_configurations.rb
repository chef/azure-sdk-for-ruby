...
module Azure::Kusto::Mgmt::V2020_09_18
  ...
  class AttachedDatabaseConfigurations
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Kusto::Mgmt::V2020_09_18::Models::AttachedDatabaseConfigurationListResult.mapper()
    ...
    def get_async(resource_group_name, cluster_name, attached_database_configuration_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Kusto::Mgmt::V2020_09_18::Models::AttachedDatabaseConfiguration.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, cluster_name, attached_database_configuration_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Kusto::Mgmt::V2020_09_18::Models::AttachedDatabaseConfiguration.mapper()
