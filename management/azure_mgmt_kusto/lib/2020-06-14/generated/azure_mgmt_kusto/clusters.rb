  ...
  class Clusters
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Kusto::Mgmt::V2020_06_14::Models::Cluster.mapper()
    ...
    def list_follower_databases_async(resource_group_name, cluster_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Kusto::Mgmt::V2020_06_14::Models::FollowerDatabaseListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def diagnose_virtual_network_async(resource_group_name, cluster_name, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Kusto::Mgmt::V2020_06_14::Models::DiagnoseVirtualNetworkResult.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Kusto::Mgmt::V2020_06_14::Models::ClusterListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_skus_async(custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Kusto::Mgmt::V2020_06_14::Models::SkuDescriptionList.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def check_name_availability_async(location, cluster_name, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Kusto::Mgmt::V2020_06_14::Models::ClusterCheckNameRequest.mapper()
    ...
    def list_skus_by_resource_async(resource_group_name, cluster_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Kusto::Mgmt::V2020_06_14::Models::ListResourceSkusResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_language_extensions_async(resource_group_name, cluster_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Kusto::Mgmt::V2020_06_14::Models::LanguageExtensionsList.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, cluster_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Kusto::Mgmt::V2020_06_14::Models::Cluster.mapper()
    ...
    def begin_update_async(resource_group_name, cluster_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Kusto::Mgmt::V2020_06_14::Models::ClusterUpdate.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_detach_follower_databases_async(resource_group_name, cluster_name, follower_database_to_remove, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Kusto::Mgmt::V2020_06_14::Models::FollowerDatabaseDefinition.mapper()
    ...
    def begin_add_language_extensions_async(resource_group_name, cluster_name, language_extensions_to_add, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Kusto::Mgmt::V2020_06_14::Models::LanguageExtensionsList.mapper()
