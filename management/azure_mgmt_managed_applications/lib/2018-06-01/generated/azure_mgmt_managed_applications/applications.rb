...
module Azure::ManagedApplications::Mgmt::V2018_06_01
  ...
  class Applications
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ManagedApplications::Mgmt::V2018_06_01::Models::Application.mapper()
    ...
    def update_async(resource_group_name, application_name, parameters:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ManagedApplications::Mgmt::V2018_06_01::Models::Application.mapper()
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ManagedApplications::Mgmt::V2018_06_01::Models::ApplicationListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
