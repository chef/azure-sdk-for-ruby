...
module Azure::DevTestLabs::Mgmt::V2016_05_15
  module Models
    ...
    class ResponseWithContinuationServiceRunner
      ...
      # @return [Array<ServiceRunner>] Results of the list operation.
      attr_accessor :value
      ...
      #
      # @return [ResponseWithContinuationServiceRunner] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for ResponseWithContinuationServiceRunner class as Ruby Hash.
