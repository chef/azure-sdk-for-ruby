...
module Azure::DevTestLabs::Mgmt::V2016_05_15
  module Models
    ...
    #
    class ResponseWithContinuationPolicy

      include MsRestAzure

      include MsRest2::JSONable
      # @return [Array<Policy>] Results of the list operation.
      attr_accessor :value
      ...
      #
      # @return [ResponseWithContinuationPolicy] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for ResponseWithContinuationPolicy class as Ruby Hash.
