...
module Azure::DevTestLabs::Mgmt::V2018_09_15
  ...
  class Formulas
    ...
    #
    # Creates and initializes a new instance of the Formulas class.
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::FormulaList.mapper()
    ...
    def get_async(resource_group_name, lab_name, name, expand:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::Formula.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # @param lab_name [String] The name of the lab.
    # @param name [String] The name of the formula.
    # @param formula [Formula] A formula for creating a VM, specifying an image
    ...
    # @param lab_name [String] The name of the lab.
    # @param name [String] The name of the formula.
    # @param formula [FormulaFragment] A formula for creating a VM, specifying an
    # image base and other parameters
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [Formula] operation results.
    #
    def update(resource_group_name, lab_name, name, formula, custom_headers:nil)
      response = update_async(resource_group_name, lab_name, name, formula, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def update_with_http_info(resource_group_name, lab_name, name, formula, custom_headers:nil)
      update_async(resource_group_name, lab_name, name, formula, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def update_async(resource_group_name, lab_name, name, formula, custom_headers:nil)
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'lab_name is nil' if lab_name.nil?
      fail ArgumentError, 'name is nil' if name.nil?
      ...
      # Serialize Request
      request_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::FormulaFragment.mapper()
    ...
    def begin_create_or_update_async(resource_group_name, lab_name, name, formula, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::Formula.mapper()
      request_content = @client.serialize(request_mapper,  formula)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    # will be added to the HTTP request.
    #
    # @return [FormulaList] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [FormulaList] which provide lazy access to pages of the response.
    #
