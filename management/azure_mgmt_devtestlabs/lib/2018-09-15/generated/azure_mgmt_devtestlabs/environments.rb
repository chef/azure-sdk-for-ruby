...
module Azure::DevTestLabs::Mgmt::V2018_09_15
  ...
  class Environments
    ...
    def list_async(resource_group_name, lab_name, user_name, expand:nil, filter:nil, top:nil, orderby:nil, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/users/{userName}/environments'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::DtlEnvironmentList.mapper()
    ...
    def get_async(resource_group_name, lab_name, user_name, name, expand:nil, custom_headers:nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/users/{userName}/environments/{name}'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::DtlEnvironment.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    #
    # Create or replace an existing environment. This operation can take a while to
    # complete.
    #
    # @param resource_group_name [String] The name of the resource group.
    # @param lab_name [String] The name of the lab.
    # @param user_name [String] The name of the user profile.
    # @param name [String] The name of the environment.
    # @param dtl_environment [DtlEnvironment] An environment, which is essentially
    ...
    # @param user_name [String] The name of the user profile.
    # @param name [String] The name of the environment.
    # @param dtl_environment [DtlEnvironmentFragment] An environment, which is
    # essentially an ARM template deployment.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [DtlEnvironment] operation results.
    #
    def update(resource_group_name, lab_name, user_name, name, dtl_environment, custom_headers:nil)
      response = update_async(resource_group_name, lab_name, user_name, name, dtl_environment, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def update_with_http_info(resource_group_name, lab_name, user_name, name, dtl_environment, custom_headers:nil)
      update_async(resource_group_name, lab_name, user_name, name, dtl_environment, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def update_async(resource_group_name, lab_name, user_name, name, dtl_environment, custom_headers:nil)
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'lab_name is nil' if lab_name.nil?
      fail ArgumentError, 'user_name is nil' if user_name.nil?
      fail ArgumentError, 'name is nil' if name.nil?
      fail ArgumentError, 'dtl_environment is nil' if dtl_environment.nil?
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      ...
      # Serialize Request
      request_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::DtlEnvironmentFragment.mapper()
    ...
    def begin_create_or_update_async(resource_group_name, lab_name, user_name, name, dtl_environment, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::DtlEnvironment.mapper()
      request_content = @client.serialize(request_mapper,  dtl_environment)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    # will be added to the HTTP request.
    #
    # @return [DtlEnvironmentList] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [DtlEnvironmentList] which provide lazy access to pages of the
    # response.
    #
