...
module Azure::DevTestLabs::Mgmt::V2018_09_15
  ...
  class VirtualNetworks
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::VirtualNetworkList.mapper()
    ...
    def get_async(resource_group_name, lab_name, name, expand:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::VirtualNetwork.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # @param lab_name [String] The name of the lab.
    # @param name [String] The name of the virtual network.
    # @param virtual_network [VirtualNetwork] A virtual network.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [VirtualNetwork] operation results.
    ...
    # @param lab_name [String] The name of the lab.
    # @param name [String] The name of the virtual network.
    # @param virtual_network [VirtualNetworkFragment] A virtual network.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [VirtualNetwork] operation results.
    ...
    def update_async(resource_group_name, lab_name, name, virtual_network, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::VirtualNetworkFragment.mapper()
    ...
    def begin_create_or_update_async(resource_group_name, lab_name, name, virtual_network, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::VirtualNetwork.mapper()
      request_content = @client.serialize(request_mapper,  virtual_network)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    # will be added to the HTTP request.
    #
    # @return [VirtualNetworkList] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [VirtualNetworkList] which provide lazy access to pages of the
    # response.
    #
