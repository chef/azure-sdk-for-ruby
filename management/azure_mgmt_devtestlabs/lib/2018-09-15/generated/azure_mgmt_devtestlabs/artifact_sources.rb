...
module Azure::DevTestLabs::Mgmt::V2018_09_15
  ...
  class ArtifactSources
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::ArtifactSourceList.mapper()
    ...
    def get_async(resource_group_name, lab_name, name, expand:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::ArtifactSource.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, lab_name, name, artifact_source, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::ArtifactSource.mapper()
    ...
    def update_async(resource_group_name, lab_name, name, artifact_source, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::ArtifactSourceFragment.mapper()
      request_content = @client.serialize(request_mapper,  artifact_source)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    # will be added to the HTTP request.
    #
    # @return [ArtifactSourceList] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [ArtifactSourceList] which provide lazy access to pages of the
    # response.
    #
