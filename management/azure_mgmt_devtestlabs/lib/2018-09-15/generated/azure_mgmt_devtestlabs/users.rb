...
module Azure::DevTestLabs::Mgmt::V2018_09_15
  ...
  class Users
    ...
    def list_async(resource_group_name, lab_name, expand:nil, filter:nil, top:nil, orderby:nil, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/users'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::UserList.mapper()
    ...
    # @param resource_group_name [String] The name of the resource group.
    # @param lab_name [String] The name of the lab.
    # @param name [String] The name of the user profile.
    # @param expand [String] Specify the $expand query. Example:
    # 'properties($select=identity)'
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    ...
    def get_async(resource_group_name, lab_name, name, expand:nil, custom_headers:nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/users/{name}'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::User.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # @param lab_name [String] The name of the lab.
    # @param name [String] The name of the user profile.
    # @param user [User] Profile of a lab user.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [User] operation results.
    ...
    def create_or_update_async(resource_group_name, lab_name, name, user, custom_headers:nil)
      # Send request
      promise = begin_create_or_update_async(resource_group_name, lab_name, name, user, custom_headers:custom_headers)
    ...
    # @param lab_name [String] The name of the lab.
    # @param name [String] The name of the user profile.
    # @param user [UserFragment] Profile of a lab user.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [User] operation results.
    ...
    def update_async(resource_group_name, lab_name, name, user, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::UserFragment.mapper()
    ...
    # @return [User] operation results.
    #
    def begin_create_or_update(resource_group_name, lab_name, name, user, custom_headers:nil)
      response = begin_create_or_update_async(resource_group_name, lab_name, name, user, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def begin_create_or_update_with_http_info(resource_group_name, lab_name, name, user, custom_headers:nil)
      begin_create_or_update_async(resource_group_name, lab_name, name, user, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def begin_create_or_update_async(resource_group_name, lab_name, name, user, custom_headers:nil)
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'lab_name is nil' if lab_name.nil?
      fail ArgumentError, 'name is nil' if name.nil?
      ...
      # Serialize Request
      request_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::User.mapper()
      request_content = @client.serialize(request_mapper,  user)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
