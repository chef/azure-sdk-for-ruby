...
module Azure::DevTestLabs::Mgmt::V2018_09_15
  ...
  class ArmTemplates
    ...
    #
    # Creates and initializes a new instance of the ArmTemplates class.
    ...
    def list_async(resource_group_name, lab_name, artifact_source_name, expand:nil, filter:nil, top:nil, orderby:nil, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/artifactsources/{artifactSourceName}/armtemplates'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::ArmTemplateList.mapper()
    ...
    def get_async(resource_group_name, lab_name, artifact_source_name, name, expand:nil, custom_headers:nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/artifactsources/{artifactSourceName}/armtemplates/{name}'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::ArmTemplate.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # will be added to the HTTP request.
    #
    # @return [ArmTemplateList] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [ArmTemplateList] which provide lazy access to pages of the response.
    #
