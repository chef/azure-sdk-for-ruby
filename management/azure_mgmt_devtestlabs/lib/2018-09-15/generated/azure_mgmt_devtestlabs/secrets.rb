...
module Azure::DevTestLabs::Mgmt::V2018_09_15
  ...
  class Secrets
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::SecretList.mapper()
    ...
    def get_async(resource_group_name, lab_name, user_name, name, expand:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::Secret.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, lab_name, user_name, name, secret, custom_headers:nil)
      # Send request
      promise = begin_create_or_update_async(resource_group_name, lab_name, user_name, name, secret, custom_headers:custom_headers)
    ...
    # @param user_name [String] The name of the user profile.
    # @param name [String] The name of the secret.
    # @param secret [SecretFragment] A secret.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [Secret] operation results.
    #
    def update(resource_group_name, lab_name, user_name, name, secret, custom_headers:nil)
      response = update_async(resource_group_name, lab_name, user_name, name, secret, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def update_with_http_info(resource_group_name, lab_name, user_name, name, secret, custom_headers:nil)
      update_async(resource_group_name, lab_name, user_name, name, secret, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def update_async(resource_group_name, lab_name, user_name, name, secret, custom_headers:nil)
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'lab_name is nil' if lab_name.nil?
      fail ArgumentError, 'user_name is nil' if user_name.nil?
      ...
      # Serialize Request
      request_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::SecretFragment.mapper()
    ...
    # @return [Secret] operation results.
    #
    def begin_create_or_update(resource_group_name, lab_name, user_name, name, secret, custom_headers:nil)
      response = begin_create_or_update_async(resource_group_name, lab_name, user_name, name, secret, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def begin_create_or_update_with_http_info(resource_group_name, lab_name, user_name, name, secret, custom_headers:nil)
      begin_create_or_update_async(resource_group_name, lab_name, user_name, name, secret, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def begin_create_or_update_async(resource_group_name, lab_name, user_name, name, secret, custom_headers:nil)
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'lab_name is nil' if lab_name.nil?
      fail ArgumentError, 'user_name is nil' if user_name.nil?
      ...
      # Serialize Request
      request_mapper = Azure::DevTestLabs::Mgmt::V2018_09_15::Models::Secret.mapper()
      request_content = @client.serialize(request_mapper,  secret)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    # will be added to the HTTP request.
    #
    # @return [SecretList] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [SecretList] which provide lazy access to pages of the response.
    #
