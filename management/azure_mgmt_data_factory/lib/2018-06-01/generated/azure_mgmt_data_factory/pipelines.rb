...
module Azure::DataFactory::Mgmt::V2018_06_01
  ...
  class Pipelines
    ...
    # @param factory_name [String] The factory name.
    # @param pipeline_name [String] The pipeline name.
    # @param if_none_match [String] ETag of the pipeline entity. Should only be
    ...
    # @param factory_name [String] The factory name.
    # @param pipeline_name [String] The pipeline name.
    # @param reference_pipeline_run_id [String] The pipeline run identifier. If run
    # ID is specified the parameters of the specified run will be used to create a
    # new run.
    # @param is_recovery [Boolean] Recovery mode flag. If recovery mode is set to
    # true, the specified referenced pipeline run and the new run will be grouped
