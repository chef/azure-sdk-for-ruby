...
module Azure::DataFactory::Mgmt::V2018_06_01
  ...
  class Datasets
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::DataFactory::Mgmt::V2018_06_01::Models::DatasetListResponse.mapper()
    ...
    def create_or_update_async(resource_group_name, factory_name, dataset_name, dataset, if_match:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::DataFactory::Mgmt::V2018_06_01::Models::DatasetResource.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DataFactory::Mgmt::V2018_06_01::Models::DatasetResource.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # @param factory_name [String] The factory name.
    # @param dataset_name [String] The dataset name.
    # @param if_none_match [String] ETag of the dataset entity. Should only be
    ...
    # @return [DatasetResource] operation results.
    #
    def get(resource_group_name, factory_name, dataset_name, if_none_match:nil, custom_headers:nil)
      response = get_async(resource_group_name, factory_name, dataset_name, if_none_match:if_none_match, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def get_with_http_info(resource_group_name, factory_name, dataset_name, if_none_match:nil, custom_headers:nil)
      get_async(resource_group_name, factory_name, dataset_name, if_none_match:if_none_match, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_async(resource_group_name, factory_name, dataset_name, if_none_match:nil, custom_headers:nil)
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MaxLength': '90'" if !resource_group_name.nil? && resource_group_name.length > 90
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MinLength': '1'" if !resource_group_name.nil? && resource_group_name.length < 1
