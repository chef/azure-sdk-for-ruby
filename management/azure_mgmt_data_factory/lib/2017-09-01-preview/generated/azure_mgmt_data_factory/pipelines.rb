...
module Azure::DataFactory::Mgmt::V2017_09_01_preview
  ...
  class Pipelines
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::DataFactory::Mgmt::V2017_09_01_preview::Models::PipelineListResponse.mapper()
    ...
    # @param resource_group_name [String] The resource group name.
    # @param factory_name [String] The factory name.
    # @param pipeline_name [String] The pipeline name.
    # @param pipeline [PipelineResource] Pipeline resource definition.
    # @param if_match [String] ETag of the pipeline entity.  Should only be
    # specified for update, for which it should match existing entity or can be *
    # for unconditional update.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [PipelineResource] operation results.
    #
    ...
    def create_or_update_async(resource_group_name, factory_name, pipeline_name, pipeline, if_match:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::DataFactory::Mgmt::V2017_09_01_preview::Models::PipelineResource.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DataFactory::Mgmt::V2017_09_01_preview::Models::PipelineResource.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # @return [PipelineResource] operation results.
    #
    def get(resource_group_name, factory_name, pipeline_name, custom_headers:nil)
      response = get_async(resource_group_name, factory_name, pipeline_name, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def get_with_http_info(resource_group_name, factory_name, pipeline_name, custom_headers:nil)
      get_async(resource_group_name, factory_name, pipeline_name, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_async(resource_group_name, factory_name, pipeline_name, custom_headers:nil)
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MaxLength': '90'" if !resource_group_name.nil? && resource_group_name.length > 90
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MinLength': '1'" if !resource_group_name.nil? && resource_group_name.length < 1
    ...
    #
    def create_run(resource_group_name, factory_name, pipeline_name, parameters:nil, custom_headers:nil)
      response = create_run_async(resource_group_name, factory_name, pipeline_name, parameters:parameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def create_run_with_http_info(resource_group_name, factory_name, pipeline_name, parameters:nil, custom_headers:nil)
      create_run_async(resource_group_name, factory_name, pipeline_name, parameters:parameters, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def create_run_async(resource_group_name, factory_name, pipeline_name, parameters:nil, custom_headers:nil)
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MaxLength': '90'" if !resource_group_name.nil? && resource_group_name.length > 90
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MinLength': '1'" if !resource_group_name.nil? && resource_group_name.length < 1
      ...
      promise = promise.then do |result|
        ...
        if status_code == 202
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DataFactory::Mgmt::V2017_09_01_preview::Models::CreateRunResponse.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # will be added to the HTTP request.
    #
    # @return [PipelineListResponse] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [PipelineListResponse] which provide lazy access to pages of the
    # response.
    #
