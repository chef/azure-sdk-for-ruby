...
module Azure::DataFactory::Mgmt::V2017_09_01_preview
  ...
  class IntegrationRuntimes
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::DataFactory::Mgmt::V2017_09_01_preview::Models::IntegrationRuntimeListResponse.mapper()
    ...
    def create_or_update_async(resource_group_name, factory_name, integration_runtime_name, integration_runtime, if_match:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::DataFactory::Mgmt::V2017_09_01_preview::Models::IntegrationRuntimeResource.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DataFactory::Mgmt::V2017_09_01_preview::Models::IntegrationRuntimeResource.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # @return [IntegrationRuntimeResource] operation results.
    #
    def get(resource_group_name, factory_name, integration_runtime_name, custom_headers:nil)
      response = get_async(resource_group_name, factory_name, integration_runtime_name, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def get_with_http_info(resource_group_name, factory_name, integration_runtime_name, custom_headers:nil)
      get_async(resource_group_name, factory_name, integration_runtime_name, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_async(resource_group_name, factory_name, integration_runtime_name, custom_headers:nil)
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MaxLength': '90'" if !resource_group_name.nil? && resource_group_name.length > 90
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MinLength': '1'" if !resource_group_name.nil? && resource_group_name.length < 1
    ...
    def update_async(resource_group_name, factory_name, integration_runtime_name, update_integration_runtime_request, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::DataFactory::Mgmt::V2017_09_01_preview::Models::UpdateIntegrationRuntimeRequest.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DataFactory::Mgmt::V2017_09_01_preview::Models::IntegrationRuntimeStatusResponse.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_connection_info_async(resource_group_name, factory_name, integration_runtime_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DataFactory::Mgmt::V2017_09_01_preview::Models::IntegrationRuntimeConnectionInfo.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def regenerate_auth_key_async(resource_group_name, factory_name, integration_runtime_name, regenerate_key_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::DataFactory::Mgmt::V2017_09_01_preview::Models::IntegrationRuntimeRegenerateKeyParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DataFactory::Mgmt::V2017_09_01_preview::Models::IntegrationRuntimeAuthKeys.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # @param factory_name [String] The factory name.
    # @param integration_runtime_name [String] The integration runtime name.
    # @param remove_node_parameters [IntegrationRuntimeRemoveNodeRequest] The name
    # of the node to be removed from an integration runtime.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    #
    def remove_node(resource_group_name, factory_name, integration_runtime_name, remove_node_parameters, custom_headers:nil)
      response = remove_node_async(resource_group_name, factory_name, integration_runtime_name, remove_node_parameters, custom_headers:custom_headers).value!
      nil
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def remove_node_with_http_info(resource_group_name, factory_name, integration_runtime_name, remove_node_parameters, custom_headers:nil)
      remove_node_async(resource_group_name, factory_name, integration_runtime_name, remove_node_parameters, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def remove_node_async(resource_group_name, factory_name, integration_runtime_name, remove_node_parameters, custom_headers:nil)
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MaxLength': '90'" if !resource_group_name.nil? && resource_group_name.length > 90
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MinLength': '1'" if !resource_group_name.nil? && resource_group_name.length < 1
      ...
      fail ArgumentError, "'integration_runtime_name' should satisfy the constraint - 'Pattern': '^[A-Za-z0-9]+(?:-[A-Za-z0-9]+)*$'" if !integration_runtime_name.nil? && integration_runtime_name.match(Regexp.new('^^[A-Za-z0-9]+(?:-[A-Za-z0-9]+)*$$')).nil?
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      fail ArgumentError, 'remove_node_parameters is nil' if remove_node_parameters.nil?
      ...
      # Serialize Request
      request_mapper = Azure::DataFactory::Mgmt::V2017_09_01_preview::Models::IntegrationRuntimeRemoveNodeRequest.mapper()
      request_content = @client.serialize(request_mapper,  remove_node_parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil

      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/integrationRuntimes/{integrationRuntimeName}/removeNode'
    ...
    def get_monitoring_data_async(resource_group_name, factory_name, integration_runtime_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DataFactory::Mgmt::V2017_09_01_preview::Models::IntegrationRuntimeMonitoringData.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
