...
module Azure::Logic::Mgmt::V2018_07_01_preview
  ...
  #
  class IntegrationAccountSessions
    include MsRestAzure

    #
    # Creates and initializes a new instance of the IntegrationAccountSessions class.
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Logic::Mgmt::V2018_07_01_preview::Models::IntegrationAccountSessionListResult.mapper()
    ...
    def get_async(resource_group_name, integration_account_name, session_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Logic::Mgmt::V2018_07_01_preview::Models::IntegrationAccountSession.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, integration_account_name, session_name, session, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Logic::Mgmt::V2018_07_01_preview::Models::IntegrationAccountSession.mapper()
