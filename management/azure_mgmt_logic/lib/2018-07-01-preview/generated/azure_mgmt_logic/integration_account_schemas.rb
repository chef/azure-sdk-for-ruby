...
module Azure::Logic::Mgmt::V2018_07_01_preview
  ...
  class IntegrationAccountSchemas
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Logic::Mgmt::V2018_07_01_preview::Models::IntegrationAccountSchemaListResult.mapper()
    ...
    def get_async(resource_group_name, integration_account_name, schema_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Logic::Mgmt::V2018_07_01_preview::Models::IntegrationAccountSchema.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, integration_account_name, schema_name, schema, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Logic::Mgmt::V2018_07_01_preview::Models::IntegrationAccountSchema.mapper()
