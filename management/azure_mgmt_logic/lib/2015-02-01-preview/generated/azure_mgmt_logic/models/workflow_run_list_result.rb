...
module Azure::Logic::Mgmt::V2015_02_01_preview
  module Models
    ...
    class WorkflowRunListResult
      ...
      # @return [Array<WorkflowRun>] Gets or sets a list of workflow runs.
      attr_accessor :value
      ...
      #
      # @return [WorkflowRunListResult] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for WorkflowRunListResult class as Ruby Hash.
