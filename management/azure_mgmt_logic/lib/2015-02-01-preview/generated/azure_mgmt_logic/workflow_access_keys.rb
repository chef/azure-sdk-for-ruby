...
module Azure::Logic::Mgmt::V2015_02_01_preview
  ...
  class WorkflowAccessKeys
    ...
    def list_async(resource_group_name, workflow_name, top:nil, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/workflows/{workflowName}/accessKeys'
    ...
    def get_async(resource_group_name, workflow_name, access_key_name, custom_headers:nil)
      ...
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'workflow_name is nil' if workflow_name.nil?
      fail ArgumentError, 'access_key_name is nil' if access_key_name.nil?
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      ...
      options = {
          middlewares: [[MsRest2::RetryPolicyMiddleware, times: 3, retry: 0.02], [:cookie_jar]],
          path_params: {'subscriptionId' => @client.subscription_id,'resourceGroupName' => resource_group_name,'workflowName' => workflow_name,'accessKeyName' => access_key_name},
    ...
    def create_or_update_async(resource_group_name, workflow_name, access_key_name, workflow_accesskey, custom_headers:nil)
      ...
      fail ArgumentError, 'access_key_name is nil' if access_key_name.nil?
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      fail ArgumentError, 'workflow_accesskey is nil' if workflow_accesskey.nil?
    ...
    def list_secret_keys_async(resource_group_name, workflow_name, access_key_name, custom_headers:nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/workflows/{workflowName}/accessKeys/{accessKeyName}/list'
