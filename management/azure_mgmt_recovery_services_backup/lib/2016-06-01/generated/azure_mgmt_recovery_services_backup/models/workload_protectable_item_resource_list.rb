...
module Azure::RecoveryServicesBackup::Mgmt::V2016_06_01
  module Models
    ...
    class WorkloadProtectableItemResourceList < ResourceList
      ...
      #
      # @return [WorkloadProtectableItemResourceList] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for WorkloadProtectableItemResourceList class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'WorkloadProtectableItemResourceList',
          type: {
            name: 'Composite',
            class_name: 'WorkloadProtectableItemResourceList',
            model_properties: {
              next_link: {
                client_side_validation: true,
                required: false,
