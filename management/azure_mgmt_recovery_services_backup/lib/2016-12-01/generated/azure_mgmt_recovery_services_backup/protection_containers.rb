...
module Azure::RecoveryServicesBackup::Mgmt::V2016_12_01
  ...
  class ProtectionContainers
    ...
    #
    #
    def inquire(vault_name, resource_group_name, fabric_name, container_name, filter:nil, custom_headers:nil)
      response = inquire_async(vault_name, resource_group_name, fabric_name, container_name, filter:filter, custom_headers:custom_headers).value!
      nil
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def inquire_with_http_info(vault_name, resource_group_name, fabric_name, container_name, filter:nil, custom_headers:nil)
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def inquire_async(vault_name, resource_group_name, fabric_name, container_name, filter:nil, custom_headers:nil)
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      fail ArgumentError, 'vault_name is nil' if vault_name.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
