...
module Azure::RecoveryServicesBackup::Mgmt::V2016_12_01
  ...
  class ProtectableContainers
    ...
    def list(vault_name, resource_group_name, fabric_name, filter:nil, custom_headers:nil)
      first_page = list_as_lazy(vault_name, resource_group_name, fabric_name, filter:filter, custom_headers:custom_headers)
    ...
    def list_with_http_info(vault_name, resource_group_name, fabric_name, filter:nil, custom_headers:nil)
      list_async(vault_name, resource_group_name, fabric_name, filter:filter, custom_headers:custom_headers).value!
    end
    ...
    def list_as_lazy(vault_name, resource_group_name, fabric_name, filter:nil, custom_headers:nil)
      response = list_async(vault_name, resource_group_name, fabric_name, filter:filter, custom_headers:custom_headers).value!
      unless response.nil?
        page = response.body
