...
module Azure::RecoveryServicesBackup::Mgmt::V2017_07_01
  ...
  class FeatureSupport
    ...
    def validate_async(azure_region, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::RecoveryServicesBackup::Mgmt::V2017_07_01::Models::FeatureSupportRequest.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil

      path_template = 'Subscriptions/{subscriptionId}/providers/Microsoft.RecoveryServices/locations/{azureRegion}/backupValidateFeatures'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::RecoveryServicesBackup::Mgmt::V2017_07_01::Models::AzureVMResourceFeatureSupportResponse.mapper()
