...
module Azure::RecoveryServicesBackup::Mgmt::V2019_06_15
  ...
  class BackupResourceVaultConfigs
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::RecoveryServicesBackup::Mgmt::V2019_06_15::Models::BackupResourceVaultConfigResource.mapper()
    ...
    def update_async(vault_name, resource_group_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::RecoveryServicesBackup::Mgmt::V2019_06_15::Models::BackupResourceVaultConfigResource.mapper()
