...
module Azure::AlertsManagement::Mgmt::V2018_05_05_preview
  ...
  #
  class AlertsManagementClient < MsRestAzure::AzureServiceClient
    include MsRestAzure
    ...
    # @return [ApiVersion] client API version. Possible values include:
    # '2017-11-15-privatepreview', '2018-05-05-preview'
    attr_reader :api_version1

    # @return [MonitorService] filter by monitor service which is the source of
    ...
    attr_accessor :monitor_service1
    ...
    # @return [SmartGroups] smart_groups
    attr_reader :smart_groups
    ...
    def initialize(credentials = nil, base_url = nil, options = nil)
      ...
      @smart_groups = SmartGroups.new(self)
      @api_version1 = '2018-05-05-preview'
    ...
    #
    def add_telemetry
        sdk_information = 'azure_mgmt_alerts_management'
