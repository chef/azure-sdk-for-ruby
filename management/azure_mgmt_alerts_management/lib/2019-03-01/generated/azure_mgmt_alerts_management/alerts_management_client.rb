...
module Azure::AlertsManagement::Mgmt::V2019_03_01
  ...
  class AlertsManagementClient < MsRestAzure::AzureServiceClient
    ...
    # @return [String] scope here is resourceId for which alert is created.
    attr_accessor :scope
    ...
    # @return [SmartDetectorAlertRules] smart_detector_alert_rules
    attr_reader :smart_detector_alert_rules
    ...
    def initialize(credentials = nil, base_url = nil, options = nil)
      ...
      @smart_detector_alert_rules = SmartDetectorAlertRules.new(self)
