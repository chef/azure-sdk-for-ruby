...
module Azure::SQL::Mgmt::V2014_04_01
  ...
  class Queries
    ...
    def list_by_database_async(resource_group_name, server_name, database_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/topQueries'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::SQL::Mgmt::V2014_04_01::Models::TopQueriesListResult.mapper()
