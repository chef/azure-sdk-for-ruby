...
module Azure::SQL::Mgmt::V2014_04_01
  ...
  # databases.
  #
  class DatabaseConnectionPolicies
    include MsRestAzure

    #
    # Creates and initializes a new instance of the DatabaseConnectionPolicies class.
    ...
    #
    # Gets a database's connection policy, which is used with table auditing. Table
    ...
    def get_async(resource_group_name, server_name, database_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/connectionPolicies/{connectionPolicyName}'

      request_url = @base_url || @client.base_url

      options = {
          middlewares: [[MsRest2::RetryPolicyMiddleware, times: 3, retry: 0.02], [:cookie_jar]],
          path_params: {'resourceGroupName' => resource_group_name,'serverName' => server_name,'databaseName' => database_name,'connectionPolicyName' => connection_policy_name,'subscriptionId' => @client.subscription_id},
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::SQL::Mgmt::V2014_04_01::Models::DatabaseConnectionPolicy.mapper()
    ...
    # @param server_name [String] The name of the server.
    # @param database_name [String] The name of the database for which the
    # connection policy will be defined.
    # @param parameters [DatabaseConnectionPolicy] The database connection policy.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [DatabaseConnectionPolicy] operation results.
