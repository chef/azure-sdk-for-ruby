...
module Azure::SQL::Mgmt::V2014_04_01
  ...
  # databases.
  #
  class TransparentDataEncryptionConfigurations
    include MsRestAzure

    #
    # Creates and initializes a new instance of the TransparentDataEncryptionConfigurations class.
    ...
    #
    # Gets a list of a database's transparent data encryption configurations. There
    # is only ever one element, named 'current', so
    ...
    #
    # @return [TransparentDataEncryptionListResult] operation results.
    #
    ...
    def list_by_database_async(resource_group_name, server_name, database_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/transparentDataEncryption'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::SQL::Mgmt::V2014_04_01::Models::TransparentDataEncryptionListResult.mapper()
