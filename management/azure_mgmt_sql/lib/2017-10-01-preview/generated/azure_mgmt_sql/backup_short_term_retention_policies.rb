...
module Azure::SQL::Mgmt::V2017_10_01_preview
  ...
  class BackupShortTermRetentionPolicies
    ...
    #
    # Creates and initializes a new instance of the BackupShortTermRetentionPolicies class.
    ...
    #
    # @return [BackupShortTermRetentionPolicy] operation results.
    #
    ...
    def get_async(resource_group_name, server_name, database_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/backupShortTermRetentionPolicies/{policyName}'

      request_url = @base_url || @client.base_url

      options = {
          middlewares: [[MsRest2::RetryPolicyMiddleware, times: 3, retry: 0.02], [:cookie_jar]],
          path_params: {'resourceGroupName' => resource_group_name,'serverName' => server_name,'databaseName' => database_name,'policyName' => policy_name,'subscriptionId' => @client.subscription_id},
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::SQL::Mgmt::V2017_10_01_preview::Models::BackupShortTermRetentionPolicy.mapper()
    ...
    # @param server_name [String] The name of the server.
    # @param database_name [String] The name of the database.
    # @param parameters [BackupShortTermRetentionPolicy] The short term retention
    # policy info.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [Array<BackupShortTermRetentionPolicy>] operation results.
    #
    ...
    def list_by_database_async(resource_group_name, server_name, database_name, custom_headers:nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/backupShortTermRetentionPolicies'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::SQL::Mgmt::V2017_10_01_preview::Models::BackupShortTermRetentionPolicyListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, server_name, database_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::SQL::Mgmt::V2017_10_01_preview::Models::BackupShortTermRetentionPolicy.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [BackupShortTermRetentionPolicyListResult] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [BackupShortTermRetentionPolicyListResult] which provide lazy access
