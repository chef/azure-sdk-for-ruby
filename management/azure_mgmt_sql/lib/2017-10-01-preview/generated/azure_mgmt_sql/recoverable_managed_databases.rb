...
module Azure::SQL::Mgmt::V2017_10_01_preview
  ...
  # databases.
  #
  class RecoverableManagedDatabases
    include MsRestAzure

    #
    # Creates and initializes a new instance of the RecoverableManagedDatabases class.
    ...
    #
    # @return [Array<RecoverableManagedDatabase>] operation results.
    #
    ...
    def list_by_instance_async(resource_group_name, managed_instance_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/recoverableDatabases'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::SQL::Mgmt::V2017_10_01_preview::Models::RecoverableManagedDatabaseListResult.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [RecoverableManagedDatabase] operation results.
    #
    def get(resource_group_name, managed_instance_name, recoverable_database_name, custom_headers:nil)
      response = get_async(resource_group_name, managed_instance_name, recoverable_database_name, custom_headers:custom_headers).value!
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def get_with_http_info(resource_group_name, managed_instance_name, recoverable_database_name, custom_headers:nil)
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_async(resource_group_name, managed_instance_name, recoverable_database_name, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'managed_instance_name is nil' if managed_instance_name.nil?
      fail ArgumentError, 'recoverable_database_name is nil' if recoverable_database_name.nil?
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/recoverableDatabases/{recoverableDatabaseName}'

      request_url = @base_url || @client.base_url

      options = {
          middlewares: [[MsRest2::RetryPolicyMiddleware, times: 3, retry: 0.02], [:cookie_jar]],
          path_params: {'resourceGroupName' => resource_group_name,'managedInstanceName' => managed_instance_name,'recoverableDatabaseName' => recoverable_database_name,'subscriptionId' => @client.subscription_id},
          query_params: {'api-version' => @client.api_version},
          headers: request_headers.merge(custom_headers || {}),
          base_url: request_url
      }
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::SQL::Mgmt::V2017_10_01_preview::Models::RecoverableManagedDatabase.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # will be added to the HTTP request.
    #
    # @return [RecoverableManagedDatabaseListResult] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [RecoverableManagedDatabaseListResult] which provide lazy access to
