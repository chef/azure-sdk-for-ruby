...
module Azure::SQL::Mgmt::V2015_05_01_preview
  ...
  class EncryptionProtectors
    ...
    #
    def revalidate(resource_group_name, server_name, custom_headers:nil)
      response = revalidate_async(resource_group_name, server_name, custom_headers:custom_headers).value!
      nil
    end
    ...
    # response.
    #
    def revalidate_async(resource_group_name, server_name, custom_headers:nil)
      # Send request
      promise = begin_revalidate_async(resource_group_name, server_name, custom_headers:custom_headers)
    ...
    #
    #
    def begin_revalidate(resource_group_name, server_name, custom_headers:nil)
      response = begin_revalidate_async(resource_group_name, server_name, custom_headers:custom_headers).value!
      nil
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def begin_revalidate_with_http_info(resource_group_name, server_name, custom_headers:nil)
      begin_revalidate_async(resource_group_name, server_name, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def begin_revalidate_async(resource_group_name, server_name, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'server_name is nil' if server_name.nil?
      encryption_protector_name = 'current'
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/encryptionProtector/{encryptionProtectorName}/revalidate'
