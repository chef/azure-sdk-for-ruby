...
module Azure::SQL::Mgmt::V2015_05_01_preview
  ...
  class DatabaseAutomaticTuningOperations
    ...
    #
    # Creates and initializes a new instance of the DatabaseAutomaticTuningOperations class.
    ...
    #
    # @return [DatabaseAutomaticTuning] operation results.
    #
    ...
    def get_async(resource_group_name, server_name, database_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/automaticTuning/current'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::SQL::Mgmt::V2015_05_01_preview::Models::DatabaseAutomaticTuning.mapper()
    ...
    def update_async(resource_group_name, server_name, database_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::SQL::Mgmt::V2015_05_01_preview::Models::DatabaseAutomaticTuning.mapper()
