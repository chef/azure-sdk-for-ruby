...
module Azure::SQL::Mgmt::V2015_05_01_preview
  module Models
    ...
    #
    class SyncAgentLinkedDatabaseListResult

      include MsRestAzure

      include MsRest2::JSONable
      # @return [Array<SyncAgentLinkedDatabase>] Array of results.
      attr_accessor :value
      ...
      #
      # @return [SyncAgentLinkedDatabaseListResult] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for SyncAgentLinkedDatabaseListResult class as Ruby Hash.
