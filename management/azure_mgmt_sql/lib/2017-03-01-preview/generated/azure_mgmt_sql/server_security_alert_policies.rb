...
module Azure::SQL::Mgmt::V2017_03_01_preview
  ...
  class ServerSecurityAlertPolicies
    ...
    def get_async(resource_group_name, server_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/securityAlertPolicies/{securityAlertPolicyName}'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::SQL::Mgmt::V2017_03_01_preview::Models::ServerSecurityAlertPolicy.mapper()
    ...
    def list_by_server_async(resource_group_name, server_name, custom_headers:nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/securityAlertPolicies'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::SQL::Mgmt::V2017_03_01_preview::Models::LogicalServerSecurityAlertPolicyListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, server_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::SQL::Mgmt::V2017_03_01_preview::Models::ServerSecurityAlertPolicy.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [LogicalServerSecurityAlertPolicyListResult] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [LogicalServerSecurityAlertPolicyListResult] which provide lazy
