...
module Azure::SQL::Mgmt::V2017_03_01_preview
  ...
  # databases.
  #
  class ManagedDatabaseSecurityAlertPolicies
    include MsRestAzure
    ...
    # @param database_name [String] The name of the managed database for which the
    # security alert policy is defined.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [ManagedDatabaseSecurityAlertPolicy] operation results.
    #
    ...
    def get_async(resource_group_name, managed_instance_name, database_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/securityAlertPolicies/{securityAlertPolicyName}'

      request_url = @base_url || @client.base_url

      options = {
          middlewares: [[MsRest2::RetryPolicyMiddleware, times: 3, retry: 0.02], [:cookie_jar]],
          path_params: {'resourceGroupName' => resource_group_name,'managedInstanceName' => managed_instance_name,'databaseName' => database_name,'securityAlertPolicyName' => security_alert_policy_name,'subscriptionId' => @client.subscription_id},
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::SQL::Mgmt::V2017_03_01_preview::Models::ManagedDatabaseSecurityAlertPolicy.mapper()
    ...
    # @param database_name [String] The name of the managed database for which the
    # security alert policy is defined.
    # @param parameters [ManagedDatabaseSecurityAlertPolicy] The database security
    # alert policy.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    ...
    def create_or_update_async(resource_group_name, managed_instance_name, database_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::SQL::Mgmt::V2017_03_01_preview::Models::ManagedDatabaseSecurityAlertPolicy.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [Array<ManagedDatabaseSecurityAlertPolicy>] operation results.
    #
    ...
    def list_by_database_async(resource_group_name, managed_instance_name, database_name, custom_headers:nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/securityAlertPolicies'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::SQL::Mgmt::V2017_03_01_preview::Models::ManagedDatabaseSecurityAlertPolicyListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # will be added to the HTTP request.
    #
    # @return [ManagedDatabaseSecurityAlertPolicyListResult] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [ManagedDatabaseSecurityAlertPolicyListResult] which provide lazy
