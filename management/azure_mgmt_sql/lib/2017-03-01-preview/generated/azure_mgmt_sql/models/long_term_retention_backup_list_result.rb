...
module Azure::SQL::Mgmt::V2017_03_01_preview
  module Models
    ...
    class LongTermRetentionBackupListResult
      ...
      # @return [Array<LongTermRetentionBackup>] Array of results.
      attr_accessor :value
      ...
      #
      # @return [LongTermRetentionBackupListResult] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for LongTermRetentionBackupListResult class as Ruby Hash.
