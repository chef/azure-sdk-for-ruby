...
module Azure::SQL::Mgmt::V2017_03_01_preview
  ...
  class ExtendedDatabaseBlobAuditingPolicies
    ...
    #
    # Creates and initializes a new instance of the ExtendedDatabaseBlobAuditingPolicies class.
    ...
    #
    # @return [ExtendedDatabaseBlobAuditingPolicy] operation results.
    #
    ...
    def get_async(resource_group_name, server_name, database_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/extendedAuditingSettings/{blobAuditingPolicyName}'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::SQL::Mgmt::V2017_03_01_preview::Models::ExtendedDatabaseBlobAuditingPolicy.mapper()
    ...
    # @param server_name [String] The name of the server.
    # @param database_name [String] The name of the database.
    # @param parameters [ExtendedDatabaseBlobAuditingPolicy] The extended database
    ...
    def create_or_update_async(resource_group_name, server_name, database_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::SQL::Mgmt::V2017_03_01_preview::Models::ExtendedDatabaseBlobAuditingPolicy.mapper()
