...
module Azure::SQL::Mgmt::V2017_03_01_preview
  ...
  class ServerAutomaticTuningOperations
    ...
    #
    # Creates and initializes a new instance of the ServerAutomaticTuningOperations class.
    ...
    def get_async(resource_group_name, server_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/automaticTuning/current'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::SQL::Mgmt::V2017_03_01_preview::Models::ServerAutomaticTuning.mapper()
    ...
    # Manager API or the portal.
    # @param server_name [String] The name of the server.
    # @param parameters [ServerAutomaticTuning] The requested automatic tuning
    # resource state.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
