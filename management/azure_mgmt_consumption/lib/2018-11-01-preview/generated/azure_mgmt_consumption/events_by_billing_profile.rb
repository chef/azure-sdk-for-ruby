...
module Azure::Consumption::Mgmt::V2018_11_01_preview
  ...
  #
  class EventsByBillingProfile
    include MsRestAzure

    #
    # Creates and initializes a new instance of the EventsByBillingProfile class.
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Consumption::Mgmt::V2018_11_01_preview::Models::Events.mapper()
