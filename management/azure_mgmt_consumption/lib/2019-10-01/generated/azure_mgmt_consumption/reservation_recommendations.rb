...
module Azure::Consumption::Mgmt::V2019_10_01
  ...
  class ReservationRecommendations
    ...
    #
    # @param scope [String] The scope associated with reservation recommendations
    ...
    def list_async(scope, filter:nil, custom_headers:nil)
      ...
      path_template = '{scope}/providers/Microsoft.Consumption/reservationRecommendations'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Consumption::Mgmt::V2019_10_01::Models::ReservationRecommendationsListResult.mapper()
