...
module Azure::Consumption::Mgmt::V2019_10_01
  ...
  class ConsumptionManagementClient < MsRestAzure::AzureServiceClient
    ...
    # The current version is 2019-10-01.
    ...
    # @return [ReservationTransactions] reservation_transactions
    attr_reader :reservation_transactions
    ...
    # @return [EventsOperations] events_operations
    attr_reader :events_operations

    # @return [LotsOperations] lots_operations
    attr_reader :lots_operations
    ...
    def initialize(credentials = nil, base_url = nil, options = nil)
      ...
      @events_operations = EventsOperations.new(self)
      @lots_operations = LotsOperations.new(self)
