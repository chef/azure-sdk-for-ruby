...
module Azure::Consumption::Mgmt::V2019_10_01
  ...
  class EventsOperations
    ...
    #
    # Lists the events by billingAccountId and billingProfileId for given start and
    # end date.
    #
    ...
    #
    # @return [Array<EventSummary>] operation results.
    #
    def list(billing_account_id, billing_profile_id, start_date, end_date, custom_headers:nil)
      first_page = list_as_lazy(billing_account_id, billing_profile_id, start_date, end_date, custom_headers:custom_headers)
    ...
    #
    def list_with_http_info(billing_account_id, billing_profile_id, start_date, end_date, custom_headers:nil)
      list_async(billing_account_id, billing_profile_id, start_date, end_date, custom_headers:custom_headers).value!
    end
    ...
    #
    def list_async(billing_account_id, billing_profile_id, start_date, end_date, custom_headers:nil)
    ...
    #
    def list_as_lazy(billing_account_id, billing_profile_id, start_date, end_date, custom_headers:nil)
      response = list_async(billing_account_id, billing_profile_id, start_date, end_date, custom_headers:custom_headers).value!
      unless response.nil?
        page = response.body
