...
module Azure::Consumption::Mgmt::V2019_04_01_preview
  ...
  class Budgets
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Consumption::Mgmt::V2019_04_01_preview::Models::BudgetsListResult.mapper()
    ...
    def get_async(scope, budget_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Consumption::Mgmt::V2019_04_01_preview::Models::Budget.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(scope, budget_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Consumption::Mgmt::V2019_04_01_preview::Models::Budget.mapper()
