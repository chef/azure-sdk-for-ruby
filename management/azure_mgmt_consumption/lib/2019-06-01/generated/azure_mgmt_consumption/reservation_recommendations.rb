...
module Azure::Consumption::Mgmt::V2019_06_01
  ...
  class ReservationRecommendations
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Consumption::Mgmt::V2019_06_01::Models::ReservationRecommendationsListResult.mapper()
    ...
    #
    # List of recommendations for purchasing reserved instances on billing account
    # scope
    #
    ...
    def list_by_billing_account_id_async(billing_account_id, filter:nil, custom_headers:nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/providers/microsoft.consumption/ReservationRecommendations'
