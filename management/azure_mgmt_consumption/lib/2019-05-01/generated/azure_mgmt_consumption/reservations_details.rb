...
module Azure::Consumption::Mgmt::V2019_05_01
  ...
  class ReservationsDetails
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Consumption::Mgmt::V2019_05_01::Models::ReservationDetailsListResult.mapper()
    ...
    # @return [Array<ReservationDetail>] operation results.
    #
    def list_by_billing_account_id(billing_account_id, filter, custom_headers:nil)
      first_page = list_by_billing_account_id_as_lazy(billing_account_id, filter, custom_headers:custom_headers)
      first_page.get_all_items
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def list_by_billing_account_id_with_http_info(billing_account_id, filter, custom_headers:nil)
      list_by_billing_account_id_async(billing_account_id, filter, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def list_by_billing_account_id_async(billing_account_id, filter, custom_headers:nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/providers/Microsoft.Consumption/reservationDetails'
    ...
    # the response.
    #
    def list_by_billing_account_id_as_lazy(billing_account_id, filter, custom_headers:nil)
      response = list_by_billing_account_id_async(billing_account_id, filter, custom_headers:custom_headers).value!
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
