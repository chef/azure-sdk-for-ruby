...
module Azure::Storage2::Mgmt::V2021_01_01
  ...
  class QueueServices
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Storage2::Mgmt::V2021_01_01::Models::ListQueueServices.mapper()
    ...
    def set_service_properties_async(resource_group_name, account_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Storage2::Mgmt::V2021_01_01::Models::QueueServiceProperties.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Storage2::Mgmt::V2021_01_01::Models::QueueServiceProperties.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
