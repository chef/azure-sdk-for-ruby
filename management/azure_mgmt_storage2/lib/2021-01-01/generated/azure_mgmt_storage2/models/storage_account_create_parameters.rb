...
module Azure::Storage2::Mgmt::V2021_01_01
  module Models
    ...
    class StorageAccountCreateParameters
      ...
      # @return [ExtendedLocation] Optional. Set the extended location of the
      ...
      # @return [Boolean] Indicates whether the storage account permits
      # requests to be authorized with the account access key via Shared Key.
      # If false, then all requests, including shared access signatures, must
      # be authorized with Azure Active Directory (Azure AD). The default value
      # is null, which is equivalent to true.
      attr_accessor :allow_shared_key_access

      # @return [Boolean] NFS 3.0 protocol support enabled if set to true.
      attr_accessor :enable_nfs_v3
