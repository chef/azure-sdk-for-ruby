...
module Azure::Storage2::Mgmt::V2021_01_01
  module Models
    ...
    class BlobServiceProperties < Resource
      ...
      # @return [DeleteRetentionPolicy] The blob service properties for blob
      # soft delete.
      ...
      # @return [LastAccessTimeTrackingPolicy] The blob service property to
      # configure last access time based tracking policy.
      attr_accessor :last_access_time_tracking_policy
