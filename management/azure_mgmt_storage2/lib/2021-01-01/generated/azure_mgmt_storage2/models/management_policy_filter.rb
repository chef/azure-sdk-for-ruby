...
module Azure::Storage2::Mgmt::V2021_01_01
  module Models
    ...
    class ManagementPolicyFilter
      ...
      # @return [Array<String>] An array of predefined enum values. Currently
      # blockBlob supports all tiering and delete actions. Only delete actions
      # are supported for appendBlob.
