...
module Azure::Storage2::Mgmt::V2021_01_01
  ...
  class FileShares
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Storage2::Mgmt::V2021_01_01::Models::FileShareItems.mapper()
    ...
    def create_async(resource_group_name, account_name, share_name, file_share, expand:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Storage2::Mgmt::V2021_01_01::Models::FileShare.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 201
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Storage2::Mgmt::V2021_01_01::Models::FileShare.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def restore_async(resource_group_name, account_name, share_name, deleted_share, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Storage2::Mgmt::V2021_01_01::Models::DeletedShare.mapper()
