...
module Azure::Storage2::Mgmt::V2018_11_01
  ...
  class BlobServices
    ...
    def set_service_properties_async(resource_group_name, account_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Storage2::Mgmt::V2018_11_01::Models::BlobServiceProperties.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Storage2::Mgmt::V2018_11_01::Models::BlobServiceProperties.mapper()
