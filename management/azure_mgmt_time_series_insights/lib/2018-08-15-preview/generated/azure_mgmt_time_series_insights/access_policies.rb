...
module Azure::TimeSeriesInsights::Mgmt::V2018_08_15_preview
  ...
  class AccessPolicies
    ...
    def create_or_update_async(resource_group_name, environment_name, access_policy_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::TimeSeriesInsights::Mgmt::V2018_08_15_preview::Models::AccessPolicyCreateOrUpdateParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::TimeSeriesInsights::Mgmt::V2018_08_15_preview::Models::AccessPolicyResource.mapper()
    ...
    def update_async(resource_group_name, environment_name, access_policy_name, access_policy_update_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::TimeSeriesInsights::Mgmt::V2018_08_15_preview::Models::AccessPolicyUpdateParameters.mapper()
    ...
    def list_by_environment_async(resource_group_name, environment_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::TimeSeriesInsights::Mgmt::V2018_08_15_preview::Models::AccessPolicyListResponse.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
