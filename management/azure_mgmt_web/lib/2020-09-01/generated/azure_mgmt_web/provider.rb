...
module Azure::Web::Mgmt::V2020_09_01
  ...
  class Provider
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Web::Mgmt::V2020_09_01::Models::ApplicationStackCollection.mapper()
    ...
    #
    # Description for Gets all available operations for the Microsoft.Web resource
    ...
    def list_operations_async(custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Web::Mgmt::V2020_09_01::Models::CsmOperationCollection.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # will be added to the HTTP request.
    #
    # @return [ApplicationStackCollection] which provide lazy access to pages of
    # the response.
    #
