...
module Azure::Web::Mgmt::V2020_09_01
  ...
  class AppServiceEnvironments
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Web::Mgmt::V2020_09_01::Models::AppServiceEnvironmentCollection.mapper()
    ...
    def get_async(resource_group_name, name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Web::Mgmt::V2020_09_01::Models::AppServiceEnvironmentResource.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def update_async(resource_group_name, name, hosting_environment_envelope, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Web::Mgmt::V2020_09_01::Models::AppServiceEnvironmentPatchResource.mapper()
    ...
    def list_capacities_async(resource_group_name, name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Web::Mgmt::V2020_09_01::Models::StampCapacityCollection.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    #
    def get_vip_info(resource_group_name, name, custom_headers:nil)
      response = get_vip_info_async(resource_group_name, name, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def get_vip_info_with_http_info(resource_group_name, name, custom_headers:nil)
      get_vip_info_async(resource_group_name, name, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_vip_info_async(resource_group_name, name, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MaxLength': '90'" if !resource_group_name.nil? && resource_group_name.length > 90
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MinLength': '1'" if !resource_group_name.nil? && resource_group_name.length < 1
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'Pattern': '^[-\w\._\(\)]+[^\.]$'" if !resource_group_name.nil? && resource_group_name.match(Regexp.new('^^[-\w\._\(\)]+[^\.]$$')).nil?
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Web::Mgmt::V2020_09_01::Models::AddressResponse.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    #
    def change_vnet(resource_group_name, name, vnet_info, custom_headers:nil)
      first_page = change_vnet_as_lazy(resource_group_name, name, vnet_info, custom_headers:custom_headers)
      first_page.get_all_items
    end
    ...
    def get_diagnostics_item_async(resource_group_name, name, diagnostics_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Web::Mgmt::V2020_09_01::Models::HostingEnvironmentDiagnostics.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # will be added to the HTTP request.
    #
    # @return [Array<InboundEnvironmentEndpoint>] operation results.
    #
    def get_inbound_network_dependencies_endpoints(resource_group_name, name, custom_headers:nil)
      first_page = get_inbound_network_dependencies_endpoints_as_lazy(resource_group_name, name, custom_headers:custom_headers)
      first_page.get_all_items
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def get_inbound_network_dependencies_endpoints_with_http_info(resource_group_name, name, custom_headers:nil)
      get_inbound_network_dependencies_endpoints_async(resource_group_name, name, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_inbound_network_dependencies_endpoints_async(resource_group_name, name, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MaxLength': '90'" if !resource_group_name.nil? && resource_group_name.length > 90
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MinLength': '1'" if !resource_group_name.nil? && resource_group_name.length < 1
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'Pattern': '^[-\w\._\(\)]+[^\.]$'" if !resource_group_name.nil? && resource_group_name.match(Regexp.new('^^[-\w\._\(\)]+[^\.]$$')).nil?
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/hostingEnvironments/{name}/inboundNetworkDependenciesEndpoints'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Web::Mgmt::V2020_09_01::Models::InboundEnvironmentEndpointCollection.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_multi_role_pools_async(resource_group_name, name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Web::Mgmt::V2020_09_01::Models::WorkerPoolCollection.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_multi_role_pool_async(resource_group_name, name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Web::Mgmt::V2020_09_01::Models::WorkerPoolResource.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def update_multi_role_pool_async(resource_group_name, name, multi_role_pool_envelope, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Web::Mgmt::V2020_09_01::Models::WorkerPoolResource.mapper()
    ...
    def list_multi_role_pool_instance_metric_definitions_async(resource_group_name, name, instance, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Web::Mgmt::V2020_09_01::Models::ResourceMetricDefinitionCollection.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_multi_role_pool_skus_async(resource_group_name, name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Web::Mgmt::V2020_09_01::Models::SkuInfoCollection.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_multi_role_usages_async(resource_group_name, name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Web::Mgmt::V2020_09_01::Models::UsageCollection.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # Environment.
    #
    # Description for Get the network endpoints of all outbound dependencies of an
    # App Service Environment.
    #
    # @param resource_group_name [String] Name of the resource group to which the
    # resource belongs.
    ...
    # will be added to the HTTP request.
    #
    # @return [Array<OutboundEnvironmentEndpoint>] operation results.
    #
    def get_outbound_network_dependencies_endpoints(resource_group_name, name, custom_headers:nil)
      first_page = get_outbound_network_dependencies_endpoints_as_lazy(resource_group_name, name, custom_headers:custom_headers)
      first_page.get_all_items
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def get_outbound_network_dependencies_endpoints_with_http_info(resource_group_name, name, custom_headers:nil)
      get_outbound_network_dependencies_endpoints_async(resource_group_name, name, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_outbound_network_dependencies_endpoints_async(resource_group_name, name, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MaxLength': '90'" if !resource_group_name.nil? && resource_group_name.length > 90
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MinLength': '1'" if !resource_group_name.nil? && resource_group_name.length < 1
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'Pattern': '^[-\w\._\(\)]+[^\.]$'" if !resource_group_name.nil? && resource_group_name.match(Regexp.new('^^[-\w\._\(\)]+[^\.]$$')).nil?
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/hostingEnvironments/{name}/outboundNetworkDependenciesEndpoints'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Web::Mgmt::V2020_09_01::Models::OutboundEnvironmentEndpointCollection.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    #
    def suspend(resource_group_name, name, custom_headers:nil)
      first_page = suspend_as_lazy(resource_group_name, name, custom_headers:custom_headers)
      first_page.get_all_items
    end
    ...
    def begin_create_or_update_async(resource_group_name, name, hosting_environment_envelope, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Web::Mgmt::V2020_09_01::Models::AppServiceEnvironmentResource.mapper()
      request_content = @client.serialize(request_mapper,  hosting_environment_envelope)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_change_vnet_async(resource_group_name, name, vnet_info, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Web::Mgmt::V2020_09_01::Models::VirtualNetworkProfile.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [InboundEnvironmentEndpointCollection] operation results.
    #
    def get_inbound_network_dependencies_endpoints_next(next_page_link, custom_headers:nil)
      response = get_inbound_network_dependencies_endpoints_next_async(next_page_link, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def get_inbound_network_dependencies_endpoints_next_with_http_info(next_page_link, custom_headers:nil)
      get_inbound_network_dependencies_endpoints_next_async(next_page_link, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_inbound_network_dependencies_endpoints_next_async(next_page_link, custom_headers:nil)
      fail ArgumentError, 'next_page_link is nil' if next_page_link.nil?
    ...
    # will be added to the HTTP request.
    #
    # @return [OutboundEnvironmentEndpointCollection] operation results.
    #
    def get_outbound_network_dependencies_endpoints_next(next_page_link, custom_headers:nil)
      response = get_outbound_network_dependencies_endpoints_next_async(next_page_link, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def get_outbound_network_dependencies_endpoints_next_with_http_info(next_page_link, custom_headers:nil)
      get_outbound_network_dependencies_endpoints_next_async(next_page_link, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_outbound_network_dependencies_endpoints_next_async(next_page_link, custom_headers:nil)
      fail ArgumentError, 'next_page_link is nil' if next_page_link.nil?
    ...
    # will be added to the HTTP request.
    #
    # @return [InboundEnvironmentEndpointCollection] which provide lazy access to
    # pages of the response.
    #
    def get_inbound_network_dependencies_endpoints_as_lazy(resource_group_name, name, custom_headers:nil)
      response = get_inbound_network_dependencies_endpoints_async(resource_group_name, name, custom_headers:custom_headers).value!
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
          get_inbound_network_dependencies_endpoints_next_async(next_page_link, custom_headers:custom_headers)
        end
        page
      end
    end
    ...
    # will be added to the HTTP request.
    #
    # @return [OutboundEnvironmentEndpointCollection] which provide lazy access to
    # pages of the response.
    #
    def get_outbound_network_dependencies_endpoints_as_lazy(resource_group_name, name, custom_headers:nil)
      response = get_outbound_network_dependencies_endpoints_async(resource_group_name, name, custom_headers:custom_headers).value!
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
          get_outbound_network_dependencies_endpoints_next_async(next_page_link, custom_headers:custom_headers)
        end
        page
      end
    end
