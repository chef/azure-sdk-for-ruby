...
module Azure::Web::Mgmt::V2020_09_01
  module Models
    ...
    #
    class DetectorResponseCollection

      include MsRestAzure

      include MsRest2::JSONable
      # @return [Array<DetectorResponse>] Collection of resources.
      attr_accessor :value
      ...
      #
      # @return [DetectorResponseCollection] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for DetectorResponseCollection class as Ruby Hash.
