...
module Azure::Web::Mgmt::V2016_08_01
  module Models
    ...
    #
    class WebJobCollection

      include MsRestAzure

      include MsRest2::JSONable
      # @return [Array<WebJob>] Collection of resources.
      attr_accessor :value
      ...
      #
      # @return [WebJobCollection] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for WebJobCollection class as Ruby Hash.
