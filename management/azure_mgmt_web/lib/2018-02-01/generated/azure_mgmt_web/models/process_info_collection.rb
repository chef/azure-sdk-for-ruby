...
module Azure::Web::Mgmt::V2018_02_01
  module Models
    ...
    class ProcessInfoCollection
      ...
      #
      # @return [ProcessInfoCollection] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for ProcessInfoCollection class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ProcessInfoCollection',
          type: {
            name: 'Composite',
            class_name: 'ProcessInfoCollection',
            model_properties: {
              value: {
                client_side_validation: true,
                required: true,
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'ProcessInfoElementType',
                      type: {
                        name: 'Composite',
