...
module Azure::Web::Mgmt::V2018_02_01
  ...
  class Certificates
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Web::Mgmt::V2018_02_01::Models::CertificateCollection.mapper()
    ...
    def get_async(resource_group_name, name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Web::Mgmt::V2018_02_01::Models::Certificate.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, name, certificate_envelope, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Web::Mgmt::V2018_02_01::Models::Certificate.mapper()
    ...
    def update_async(resource_group_name, name, certificate_envelope, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Web::Mgmt::V2018_02_01::Models::CertificatePatchResource.mapper()
      request_content = @client.serialize(request_mapper,  certificate_envelope)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
