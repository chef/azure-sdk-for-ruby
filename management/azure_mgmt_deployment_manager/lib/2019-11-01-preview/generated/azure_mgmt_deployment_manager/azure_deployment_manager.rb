...
module Azure::DeploymentManager::Mgmt::V2019_11_01_preview
  ...
  #
  class AzureDeploymentManager < MsRestAzure::AzureServiceClient
    include MsRestAzure
    ...
    # @return [ServiceTopologies] service_topologies
    attr_reader :service_topologies

    # @return [Services] services
    attr_reader :services

    # @return [ServiceUnits] service_units
    attr_reader :service_units
    ...
    #
    # Creates initializes a new instance of the AzureDeploymentManager class.
    ...
    def initialize(credentials = nil, base_url = nil, options = nil)
      ...
      @service_topologies = ServiceTopologies.new(self)
      @services = Services.new(self)
      @service_units = ServiceUnits.new(self)
      @steps = Steps.new(self)
      @rollouts = Rollouts.new(self)
