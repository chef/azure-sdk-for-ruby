...
module Azure::Compute::Mgmt::V2018_10_01
  ...
  class LogAnalytics
    ...
    def export_request_rate_by_interval_async(parameters, location, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Compute::Mgmt::V2018_10_01::Models::LogAnalyticsOperationResult.mapper()
    ...
    def begin_export_request_rate_by_interval_async(parameters, location, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute::Mgmt::V2018_10_01::Models::RequestRateByIntervalInput.mapper()
    ...
    def begin_export_throttled_requests_async(parameters, location, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute::Mgmt::V2018_10_01::Models::ThrottledRequestsInput.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
