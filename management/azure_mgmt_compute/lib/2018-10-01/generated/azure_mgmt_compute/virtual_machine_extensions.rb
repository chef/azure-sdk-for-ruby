...
module Azure::Compute::Mgmt::V2018_10_01
  ...
  class VirtualMachineExtensions
    ...
    def create_or_update_async(resource_group_name, vm_name, vm_extension_name, extension_parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Compute::Mgmt::V2018_10_01::Models::VirtualMachineExtension.mapper()
    ...
    def list_async(resource_group_name, vm_name, expand:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute::Mgmt::V2018_10_01::Models::VirtualMachineExtensionsListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, vm_name, vm_extension_name, extension_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute::Mgmt::V2018_10_01::Models::VirtualMachineExtension.mapper()
    ...
    def begin_update_async(resource_group_name, vm_name, vm_extension_name, extension_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute::Mgmt::V2018_10_01::Models::VirtualMachineExtensionUpdate.mapper()
      request_content = @client.serialize(request_mapper,  extension_parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
