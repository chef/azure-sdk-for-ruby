...
module Azure::Compute::Mgmt::V2018_10_01
  ...
  class AvailabilitySets
    ...
    def create_or_update_async(resource_group_name, availability_set_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute::Mgmt::V2018_10_01::Models::AvailabilitySet.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Compute::Mgmt::V2018_10_01::Models::AvailabilitySet.mapper()
    ...
    def update_async(resource_group_name, availability_set_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute::Mgmt::V2018_10_01::Models::AvailabilitySetUpdate.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def list_by_subscription_async(custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute::Mgmt::V2018_10_01::Models::AvailabilitySetListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
