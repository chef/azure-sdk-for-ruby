...
module Azure::Portal::Mgmt::V2015_08_01_preview
  ...
  class Dashboards
    ...
    def create_or_update_async(resource_group_name, dashboard_name, dashboard, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Portal::Mgmt::V2015_08_01_preview::Models::Dashboard.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 201
          begin
            ...
            result_mapper = Azure::Portal::Mgmt::V2015_08_01_preview::Models::Dashboard.mapper()
    ...
    def update_async(resource_group_name, dashboard_name, dashboard, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Portal::Mgmt::V2015_08_01_preview::Models::PatchableDashboard.mapper()
      request_content = @client.serialize(request_mapper,  dashboard)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Portal::Mgmt::V2015_08_01_preview::Models::DashboardListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
