...
module Azure::StreamAnalytics::Mgmt::V2016_03_01
  module Models
    ...
    class FunctionListResult
      ...
      # @return [Array<Function>] A list of functions under a streaming job.
      ...
      #
      # @return [FunctionListResult] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for FunctionListResult class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'FunctionListResult',
          type: {
            name: 'Composite',
            class_name: 'FunctionListResult',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
