...
module Azure::DataBoxEdge::Mgmt::V2019_08_01
  ...
  class Triggers
    ...
    # @param filter [String] Specify $filter='CustomContextTag eq <tag>' to filter
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::DataBoxEdge::Mgmt::V2019_08_01::Models::TriggerList.mapper()
    ...
    def get_async(device_name, name, resource_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DataBoxEdge::Mgmt::V2019_08_01::Models::Trigger.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(device_name, name, trigger, resource_group_name, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::DataBoxEdge::Mgmt::V2019_08_01::Models::Trigger.mapper()
