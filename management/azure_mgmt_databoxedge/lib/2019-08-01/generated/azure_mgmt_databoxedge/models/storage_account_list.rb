...
module Azure::DataBoxEdge::Mgmt::V2019_08_01
  module Models
    #
    # Collection of all the Storage Accounts on the Data Box Edge/Gateway
    # device.
    #
    class StorageAccountList
      ...
      #
      # @return [StorageAccountList] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for StorageAccountList class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'StorageAccountList',
          type: {
            name: 'Composite',
            class_name: 'StorageAccountList',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
