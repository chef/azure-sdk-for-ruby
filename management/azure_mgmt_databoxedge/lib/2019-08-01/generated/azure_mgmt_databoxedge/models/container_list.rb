...
module Azure::DataBoxEdge::Mgmt::V2019_08_01
  module Models
    ...
    class ContainerList
      ...
      # @return [Array<Container>] The list of containers.
      attr_accessor :value
      ...
      #
      # @return [ContainerList] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for ContainerList class as Ruby Hash.
