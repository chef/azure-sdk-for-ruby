...
module Azure::NetApp::Mgmt::V2020_11_01
  ...
  class Volumes
    ...
    #
    # @return [Array<Volume>] operation results.
    #
    def list(resource_group_name, account_name, pool_name, custom_headers:nil)
      first_page = list_as_lazy(resource_group_name, account_name, pool_name, custom_headers:custom_headers)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::NetApp::Mgmt::V2020_11_01::Models::VolumeList.mapper()
    ...
    def get_async(resource_group_name, account_name, pool_name, volume_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::NetApp::Mgmt::V2020_11_01::Models::Volume.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def replication_status_method_async(resource_group_name, account_name, pool_name, volume_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::NetApp::Mgmt::V2020_11_01::Models::ReplicationStatus.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(body, resource_group_name, account_name, pool_name, volume_name, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::NetApp::Mgmt::V2020_11_01::Models::Volume.mapper()
    ...
    def begin_update_async(body, resource_group_name, account_name, pool_name, volume_name, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::NetApp::Mgmt::V2020_11_01::Models::VolumePatch.mapper()
      request_content = @client.serialize(request_mapper,  body)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_revert_async(resource_group_name, account_name, pool_name, volume_name, body, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::NetApp::Mgmt::V2020_11_01::Models::VolumeRevert.mapper()
      request_content = @client.serialize(request_mapper,  body)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_break_replication_async(resource_group_name, account_name, pool_name, volume_name, body:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::NetApp::Mgmt::V2020_11_01::Models::BreakReplicationRequest.mapper()
      request_content = @client.serialize(request_mapper,  body)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_authorize_replication_async(resource_group_name, account_name, pool_name, volume_name, body, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::NetApp::Mgmt::V2020_11_01::Models::AuthorizeRequest.mapper()
      request_content = @client.serialize(request_mapper,  body)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_pool_change_async(resource_group_name, account_name, pool_name, volume_name, body, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::NetApp::Mgmt::V2020_11_01::Models::PoolChangeRequest.mapper()
      request_content = @client.serialize(request_mapper,  body)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    # will be added to the HTTP request.
    #
    # @return [VolumeList] which provide lazy access to pages of the response.
    #
    def list_as_lazy(resource_group_name, account_name, pool_name, custom_headers:nil)
