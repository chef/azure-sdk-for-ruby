...
module Azure::NetApp::Mgmt::V2020_06_01
  ...
  class NetAppResource
    ...
    def check_name_availability_async(location, name, type, resource_group, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::NetApp::Mgmt::V2020_06_01::Models::ResourceNameAvailabilityRequest.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::NetApp::Mgmt::V2020_06_01::Models::CheckAvailabilityResponse.mapper()
    ...
    def check_quota_availability_async(location, name, type, resource_group, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::NetApp::Mgmt::V2020_06_01::Models::QuotaAvailabilityRequest.mapper()
      request_content = @client.serialize(request_mapper,  body)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
