...
module Azure::NetApp::Mgmt::V2019_08_01
  ...
  class Pools
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::NetApp::Mgmt::V2019_08_01::Models::CapacityPoolList.mapper()
    ...
    def get_async(resource_group_name, account_name, pool_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::NetApp::Mgmt::V2019_08_01::Models::CapacityPool.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def update_async(body, resource_group_name, account_name, pool_name, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::NetApp::Mgmt::V2019_08_01::Models::CapacityPoolPatch.mapper()
    ...
    def begin_create_or_update_async(body, resource_group_name, account_name, pool_name, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::NetApp::Mgmt::V2019_08_01::Models::CapacityPool.mapper()
      request_content = @client.serialize(request_mapper,  body)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
