...
module Azure::NetApp::Mgmt::V2019_11_01
  ...
  class Accounts
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::NetApp::Mgmt::V2019_11_01::Models::NetAppAccountList.mapper()
    ...
    def get_async(resource_group_name, account_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::NetApp::Mgmt::V2019_11_01::Models::NetAppAccount.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def update_async(body, resource_group_name, account_name, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::NetApp::Mgmt::V2019_11_01::Models::NetAppAccountPatch.mapper()
    ...
    def begin_create_or_update_async(body, resource_group_name, account_name, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::NetApp::Mgmt::V2019_11_01::Models::NetAppAccount.mapper()
      request_content = @client.serialize(request_mapper,  body)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
