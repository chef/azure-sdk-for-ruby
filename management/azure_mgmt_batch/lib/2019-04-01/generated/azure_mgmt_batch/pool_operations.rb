...
module Azure::Batch::Mgmt::V2019_04_01
  ...
  class PoolOperations
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Batch::Mgmt::V2019_04_01::Models::ListPoolsResult.mapper()
    ...
    def create_async(resource_group_name, account_name, pool_name, parameters, if_match:nil, if_none_match:nil, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Batch::Mgmt::V2019_04_01::Models::Pool.mapper()
    ...
    def update_async(resource_group_name, account_name, pool_name, parameters, if_match:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::Mgmt::V2019_04_01::Models::Pool.mapper()
