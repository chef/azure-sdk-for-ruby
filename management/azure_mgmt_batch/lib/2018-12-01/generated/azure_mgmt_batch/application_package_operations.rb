...
module Azure::Batch::Mgmt::V2018_12_01
  ...
  class ApplicationPackageOperations
    ...
    def activate_async(resource_group_name, account_name, application_name, version_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::Mgmt::V2018_12_01::Models::ActivateApplicationPackageParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Batch::Mgmt::V2018_12_01::Models::ApplicationPackage.mapper()
    ...
    def create_async(resource_group_name, account_name, application_name, version_name, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Batch::Mgmt::V2018_12_01::Models::ApplicationPackage.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def list_async(resource_group_name, account_name, application_name, maxresults:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Batch::Mgmt::V2018_12_01::Models::ListApplicationPackagesResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
