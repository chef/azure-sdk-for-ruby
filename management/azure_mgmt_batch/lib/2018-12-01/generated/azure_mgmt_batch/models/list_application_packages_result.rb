...
module Azure::Batch::Mgmt::V2018_12_01
  module Models
    ...
    class ListApplicationPackagesResult
      ...
      #
      # @return [ListApplicationPackagesResult] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for ListApplicationPackagesResult class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ListApplicationPackagesResult',
          type: {
            name: 'Composite',
            class_name: 'ListApplicationPackagesResult',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
