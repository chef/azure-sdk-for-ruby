...
module Azure::PowerBiDedicated::Mgmt::V2017_10_01
  ...
  #
  class PowerBIDedicatedManagementClient < MsRestAzure::AzureServiceClient
    include MsRestAzure
    ...
    #
    # Creates initializes a new instance of the PowerBIDedicatedManagementClient class.
    ...
    def initialize(credentials = nil, base_url = nil, options = nil)
      ...
      @capacities = Capacities.new(self)
    ...
    #
    def add_telemetry
        sdk_information = 'azure_mgmt_powerbi_dedicated'
