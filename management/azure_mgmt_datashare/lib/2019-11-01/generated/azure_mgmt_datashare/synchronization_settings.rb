...
module Azure::DataShare::Mgmt::V2019_11_01
  ...
  class SynchronizationSettings
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::DataShare::Mgmt::V2019_11_01::Models::SynchronizationSetting.mapper()
    ...
    def create_async(resource_group_name, account_name, share_name, synchronization_setting_name, synchronization_setting, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::DataShare::Mgmt::V2019_11_01::Models::SynchronizationSetting.mapper()
    ...
    def list_by_share_async(resource_group_name, account_name, share_name, skip_token:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DataShare::Mgmt::V2019_11_01::Models::SynchronizationSettingList.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
