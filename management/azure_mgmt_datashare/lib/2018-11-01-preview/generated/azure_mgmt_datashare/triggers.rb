...
module Azure::DataShare::Mgmt::V2018_11_01_preview
  ...
  class Triggers
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::DataShare::Mgmt::V2018_11_01_preview::Models::Trigger.mapper()
    ...
    def list_by_share_subscription_async(resource_group_name, account_name, share_subscription_name, skip_token:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::DataShare::Mgmt::V2018_11_01_preview::Models::TriggerList.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_async(resource_group_name, account_name, share_subscription_name, trigger_name, trigger, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::DataShare::Mgmt::V2018_11_01_preview::Models::Trigger.mapper()
