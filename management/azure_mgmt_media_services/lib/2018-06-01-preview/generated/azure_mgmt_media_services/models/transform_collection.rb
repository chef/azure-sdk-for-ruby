...
module Azure::MediaServices::Mgmt::V2018_06_01_preview
  module Models
    ...
    class TransformCollection
      ...
      # @return [Array<Transform>] A collection of Transform items.
      attr_accessor :value
      ...
      #
      # @return [TransformCollection] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for TransformCollection class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'TransformCollection',
          type: {
            name: 'Composite',
            class_name: 'TransformCollection',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
