...
module Azure::MediaServices::Mgmt::V2018_03_30_preview
  ...
  class StreamingEndpoints
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::MediaServices::Mgmt::V2018_03_30_preview::Models::StreamingEndpointListResult.mapper()
    ...
    def get_async(resource_group_name, account_name, streaming_endpoint_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::MediaServices::Mgmt::V2018_03_30_preview::Models::StreamingEndpoint.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_async(resource_group_name, account_name, streaming_endpoint_name, parameters, auto_start:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::MediaServices::Mgmt::V2018_03_30_preview::Models::StreamingEndpoint.mapper()
    ...
    def begin_scale_async(resource_group_name, account_name, streaming_endpoint_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::MediaServices::Mgmt::V2018_03_30_preview::Models::StreamingEntityScaleUnit.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
