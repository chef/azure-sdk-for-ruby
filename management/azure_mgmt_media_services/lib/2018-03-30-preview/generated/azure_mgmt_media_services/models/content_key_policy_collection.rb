...
module Azure::MediaServices::Mgmt::V2018_03_30_preview
  module Models
    ...
    class ContentKeyPolicyCollection
      ...
      #
      # @return [ContentKeyPolicyCollection] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for ContentKeyPolicyCollection class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ContentKeyPolicyCollection',
          type: {
            name: 'Composite',
            class_name: 'ContentKeyPolicyCollection',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'ContentKeyPolicyElementType',
                      type: {
                        name: 'Composite',
