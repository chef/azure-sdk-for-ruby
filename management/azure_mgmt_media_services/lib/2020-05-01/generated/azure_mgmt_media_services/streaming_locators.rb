...
module Azure::MediaServices::Mgmt::V2020_05_01
  ...
  class StreamingLocators
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::MediaServices::Mgmt::V2020_05_01::Models::StreamingLocatorCollection.mapper()
    ...
    def get_async(resource_group_name, account_name, streaming_locator_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::MediaServices::Mgmt::V2020_05_01::Models::StreamingLocator.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_async(resource_group_name, account_name, streaming_locator_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::MediaServices::Mgmt::V2020_05_01::Models::StreamingLocator.mapper()
    ...
    def list_content_keys_async(resource_group_name, account_name, streaming_locator_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::MediaServices::Mgmt::V2020_05_01::Models::ListContentKeysResponse.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_paths_async(resource_group_name, account_name, streaming_locator_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::MediaServices::Mgmt::V2020_05_01::Models::ListPathsResponse.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
