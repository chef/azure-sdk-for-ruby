...
module Azure::MediaServices::Mgmt::V2020_05_01
  ...
  class AssetFilters
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::MediaServices::Mgmt::V2020_05_01::Models::AssetFilterCollection.mapper()
    ...
    def get_async(resource_group_name, account_name, asset_name, filter_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::MediaServices::Mgmt::V2020_05_01::Models::AssetFilter.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update(resource_group_name, account_name, asset_name, filter_name, parameters, custom_headers:nil)
      response = create_or_update_async(resource_group_name, account_name, asset_name, filter_name, parameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_with_http_info(resource_group_name, account_name, asset_name, filter_name, parameters, custom_headers:nil)
      create_or_update_async(resource_group_name, account_name, asset_name, filter_name, parameters, custom_headers:custom_headers).value!
    end
    ...
    def create_or_update_async(resource_group_name, account_name, asset_name, filter_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::MediaServices::Mgmt::V2020_05_01::Models::AssetFilter.mapper()
