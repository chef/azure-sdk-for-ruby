...
module Azure::MediaServices::Mgmt::V2020_05_01
  module Models
    ...
    class AssetFilterCollection
      ...
      # @return [Array<AssetFilter>] A collection of AssetFilter items.
      attr_accessor :value
      ...
      #
      # @return [AssetFilterCollection] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for AssetFilterCollection class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'AssetFilterCollection',
          type: {
            name: 'Composite',
            class_name: 'AssetFilterCollection',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'AssetFilterElementType',
                      type: {
                        name: 'Composite',
