...
module Azure::Synapse::Mgmt::V2019_06_01_preview
  ...
  #
  class ExtendedSqlPoolBlobAuditingPolicies
    include MsRestAzure

    #
    # Creates and initializes a new instance of the ExtendedSqlPoolBlobAuditingPolicies class.
    ...
    #
    # @return [ExtendedSqlPoolBlobAuditingPolicy] operation results.
    #
    ...
    def get_async(resource_group_name, workspace_name, sql_pool_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/sqlPools/{sqlPoolName}/extendedAuditingSettings/{blobAuditingPolicyName}'

      request_url = @base_url || @client.base_url

      options = {
          middlewares: [[MsRest2::RetryPolicyMiddleware, times: 3, retry: 0.02], [:cookie_jar]],
          path_params: {'subscriptionId' => @client.subscription_id,'resourceGroupName' => resource_group_name,'workspaceName' => workspace_name,'sqlPoolName' => sql_pool_name,'blobAuditingPolicyName' => blob_auditing_policy_name},
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Synapse::Mgmt::V2019_06_01_preview::Models::ExtendedSqlPoolBlobAuditingPolicy.mapper()
    ...
    # @param workspace_name [String] The name of the workspace
    # @param sql_pool_name [String] SQL pool name
    # @param parameters [ExtendedSqlPoolBlobAuditingPolicy] The extended Sql pool
    ...
    def create_or_update_async(resource_group_name, workspace_name, sql_pool_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Synapse::Mgmt::V2019_06_01_preview::Models::ExtendedSqlPoolBlobAuditingPolicy.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [Array<ExtendedSqlPoolBlobAuditingPolicy>] operation results.
    #
    def list_by_sql_pool(resource_group_name, workspace_name, sql_pool_name, custom_headers:nil)
      first_page = list_by_sql_pool_as_lazy(resource_group_name, workspace_name, sql_pool_name, custom_headers:custom_headers)
    ...
    def list_by_sql_pool_async(resource_group_name, workspace_name, sql_pool_name, custom_headers:nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/sqlPools/{sqlPoolName}/extendedAuditingSettings'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Synapse::Mgmt::V2019_06_01_preview::Models::ExtendedSqlPoolBlobAuditingPolicyListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # will be added to the HTTP request.
    #
    # @return [ExtendedSqlPoolBlobAuditingPolicyListResult] operation results.
    #
    def list_by_sql_pool_next(next_page_link, custom_headers:nil)
      response = list_by_sql_pool_next_async(next_page_link, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def list_by_sql_pool_next_with_http_info(next_page_link, custom_headers:nil)
      list_by_sql_pool_next_async(next_page_link, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def list_by_sql_pool_next_async(next_page_link, custom_headers:nil)
    ...
    # will be added to the HTTP request.
    #
    # @return [ExtendedSqlPoolBlobAuditingPolicyListResult] which provide lazy
    # access to pages of the response.
    #
    def list_by_sql_pool_as_lazy(resource_group_name, workspace_name, sql_pool_name, custom_headers:nil)
      ...
      unless response.nil?
        ...
        page.next_method = Proc.new do |next_page_link|
          list_by_sql_pool_next_async(next_page_link, custom_headers:custom_headers)
        end
        page
      end
    end
