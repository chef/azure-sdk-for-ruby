...
module Azure::Synapse::Mgmt::V2019_06_01_preview
  ...
  #
  class WorkspaceManagedSqlServerUsages
    include MsRestAzure

    #
    # Creates and initializes a new instance of the WorkspaceManagedSqlServerUsages class.
    ...
    #
    # @return [Array<ServerUsage>] operation results.
    #
    ...
    def list_async(resource_group_name, workspace_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/sqlUsages'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Synapse::Mgmt::V2019_06_01_preview::Models::ServerUsageListResult.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [ServerUsageListResult] which provide lazy access to pages of the
    # response.
    #
