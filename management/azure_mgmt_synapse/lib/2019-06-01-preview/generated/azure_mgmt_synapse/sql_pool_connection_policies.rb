...
module Azure::Synapse::Mgmt::V2019_06_01_preview
  ...
  #
  class SqlPoolConnectionPolicies
    include MsRestAzure
    ...
    #
    # @return [SqlPoolConnectionPolicy] operation results.
    #
    ...
    def get_async(resource_group_name, workspace_name, sql_pool_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/sqlPools/{sqlPoolName}/connectionPolicies/{connectionPolicyName}'

      request_url = @base_url || @client.base_url

      options = {
          middlewares: [[MsRest2::RetryPolicyMiddleware, times: 3, retry: 0.02], [:cookie_jar]],
          path_params: {'subscriptionId' => @client.subscription_id,'resourceGroupName' => resource_group_name,'workspaceName' => workspace_name,'sqlPoolName' => sql_pool_name,'connectionPolicyName' => connection_policy_name},
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Synapse::Mgmt::V2019_06_01_preview::Models::SqlPoolConnectionPolicy.mapper()
