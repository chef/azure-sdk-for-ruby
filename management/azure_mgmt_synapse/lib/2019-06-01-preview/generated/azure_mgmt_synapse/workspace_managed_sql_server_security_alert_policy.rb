...
module Azure::Synapse::Mgmt::V2019_06_01_preview
  ...
  #
  class WorkspaceManagedSqlServerSecurityAlertPolicy
    include MsRestAzure

    #
    # Creates and initializes a new instance of the WorkspaceManagedSqlServerSecurityAlertPolicy class.
    ...
    def get_async(resource_group_name, workspace_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/securityAlertPolicies/{securityAlertPolicyName}'

      request_url = @base_url || @client.base_url

      options = {
          middlewares: [[MsRest2::RetryPolicyMiddleware, times: 3, retry: 0.02], [:cookie_jar]],
          path_params: {'subscriptionId' => @client.subscription_id,'resourceGroupName' => resource_group_name,'workspaceName' => workspace_name,'securityAlertPolicyName' => security_alert_policy_name},
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Synapse::Mgmt::V2019_06_01_preview::Models::ServerSecurityAlertPolicy.mapper()
    ...
    # is case insensitive.
    # @param workspace_name [String] The name of the workspace
    # @param parameters [ServerSecurityAlertPolicy] The workspace managed sql
    ...
    # will be added to the HTTP request.
    #
    # @return [Array<ServerSecurityAlertPolicy>] operation results.
    #
    ...
    def list_async(resource_group_name, workspace_name, custom_headers:nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/securityAlertPolicies'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Synapse::Mgmt::V2019_06_01_preview::Models::ServerSecurityAlertPolicyListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, workspace_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Synapse::Mgmt::V2019_06_01_preview::Models::ServerSecurityAlertPolicy.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [ServerSecurityAlertPolicyListResult] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [ServerSecurityAlertPolicyListResult] which provide lazy access to
