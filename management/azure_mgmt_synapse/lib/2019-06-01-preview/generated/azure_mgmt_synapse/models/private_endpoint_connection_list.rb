...
module Azure::Synapse::Mgmt::V2019_06_01_preview
  module Models
    ...
    class PrivateEndpointConnectionList
      ...
      #
      # @return [PrivateEndpointConnectionList] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for PrivateEndpointConnectionList class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'PrivateEndpointConnectionList',
          type: {
            name: 'Composite',
            class_name: 'PrivateEndpointConnectionList',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
