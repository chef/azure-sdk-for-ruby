...
module Azure::Synapse::Mgmt::V2019_06_01_preview
  ...
  #
  class SqlPoolReplicationLinks
    include MsRestAzure

    #
    # Creates and initializes a new instance of the SqlPoolReplicationLinks class.
    ...
    #
    # @return [Array<ReplicationLink>] operation results.
    #
    ...
    def list_async(resource_group_name, workspace_name, sql_pool_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/sqlPools/{sqlPoolName}/replicationLinks'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Synapse::Mgmt::V2019_06_01_preview::Models::ReplicationLinkListResult.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [ReplicationLinkListResult] which provide lazy access to pages of the
    # response.
    #
