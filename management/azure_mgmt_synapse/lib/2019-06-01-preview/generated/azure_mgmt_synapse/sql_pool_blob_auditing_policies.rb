...
module Azure::Synapse::Mgmt::V2019_06_01_preview
  ...
  #
  class SqlPoolBlobAuditingPolicies
    include MsRestAzure

    #
    # Creates and initializes a new instance of the SqlPoolBlobAuditingPolicies class.
    ...
    #
    # @return [SqlPoolBlobAuditingPolicy] operation results.
    #
    ...
    def get_async(resource_group_name, workspace_name, sql_pool_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/sqlPools/{sqlPoolName}/auditingSettings/{blobAuditingPolicyName}'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Synapse::Mgmt::V2019_06_01_preview::Models::SqlPoolBlobAuditingPolicy.mapper()
    ...
    # @param workspace_name [String] The name of the workspace
    # @param sql_pool_name [String] SQL pool name
    # @param parameters [SqlPoolBlobAuditingPolicy] The database blob auditing
    # policy.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    ...
    def create_or_update_async(resource_group_name, workspace_name, sql_pool_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Synapse::Mgmt::V2019_06_01_preview::Models::SqlPoolBlobAuditingPolicy.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [Array<SqlPoolBlobAuditingPolicy>] operation results.
    #
    ...
    def list_by_sql_pool_async(resource_group_name, workspace_name, sql_pool_name, custom_headers:nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/sqlPools/{sqlPoolName}/auditingSettings'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Synapse::Mgmt::V2019_06_01_preview::Models::SqlPoolBlobAuditingPolicyListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # will be added to the HTTP request.
    #
    # @return [SqlPoolBlobAuditingPolicyListResult] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [SqlPoolBlobAuditingPolicyListResult] which provide lazy access to
