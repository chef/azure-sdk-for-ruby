...
module Azure::Synapse::Mgmt::V2019_06_01_preview
  ...
  class SqlPoolOperations
    ...
    #
    # Creates and initializes a new instance of the SqlPoolOperations class.
    ...
    #
    # @return [Array<SqlPoolOperation>] operation results.
    #
    ...
    def list_async(resource_group_name, workspace_name, sql_pool_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/sqlPools/{sqlPoolName}/operations'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Synapse::Mgmt::V2019_06_01_preview::Models::SqlPoolBlobAuditingPolicySqlPoolOperationListResult.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [SqlPoolBlobAuditingPolicySqlPoolOperationListResult] operation
    # results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [SqlPoolBlobAuditingPolicySqlPoolOperationListResult] which provide
