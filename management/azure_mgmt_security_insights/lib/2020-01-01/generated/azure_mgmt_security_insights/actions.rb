...
module Azure::SecurityInsights::Mgmt::V2020_01_01
  ...
  class Actions
    ...
    #
    # @return [Array<ActionResponse>] operation results.
    #
    def list_by_alert_rule(resource_group_name, workspace_name, rule_id, custom_headers:nil)
      first_page = list_by_alert_rule_as_lazy(resource_group_name, workspace_name, rule_id, custom_headers:custom_headers)
    ...
    #
    def list_by_alert_rule_with_http_info(resource_group_name, workspace_name, rule_id, custom_headers:nil)
      list_by_alert_rule_async(resource_group_name, workspace_name, rule_id, custom_headers:custom_headers).value!
    end
    ...
    #
    def list_by_alert_rule_async(resource_group_name, workspace_name, rule_id, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/alertRules/{ruleId}/actions'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::SecurityInsights::Mgmt::V2020_01_01::Models::ActionsList.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [ActionsList] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [ActionsList] which provide lazy access to pages of the response.
    #
    def list_by_alert_rule_as_lazy(resource_group_name, workspace_name, rule_id, custom_headers:nil)
      response = list_by_alert_rule_async(resource_group_name, workspace_name, rule_id, custom_headers:custom_headers).value!
      unless response.nil?
        page = response.body
