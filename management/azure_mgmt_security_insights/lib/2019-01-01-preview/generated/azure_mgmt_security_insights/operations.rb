...
module Azure::SecurityInsights::Mgmt::V2019_01_01_preview
  ...
  class Operations
    ...
    def list_async(custom_headers:nil)
      ...
      path_template = 'providers/Microsoft.SecurityInsights/operations'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::SecurityInsights::Mgmt::V2019_01_01_preview::Models::OperationsList.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [OperationsList] which provide lazy access to pages of the response.
    #
