...
module Azure::SecurityInsights::Mgmt::V2019_01_01_preview
  ...
  # provider
  #
  class ThreatIntelligenceIndicatorUpsert
    include MsRestAzure

    #
    # Creates and initializes a new instance of the ThreatIntelligenceIndicatorUpsert class.
    ...
    #
    def create(resource_group_name, operational_insights_resource_provider, workspace_name, name, threat_intelligence_indicator_object_to_upsert, custom_headers:nil)
      response = create_async(resource_group_name, operational_insights_resource_provider, workspace_name, name, threat_intelligence_indicator_object_to_upsert, custom_headers:custom_headers).value!
    ...
    #
    def create_with_http_info(resource_group_name, operational_insights_resource_provider, workspace_name, name, threat_intelligence_indicator_object_to_upsert, custom_headers:nil)
      create_async(resource_group_name, operational_insights_resource_provider, workspace_name, name, threat_intelligence_indicator_object_to_upsert, custom_headers:custom_headers).value!
    end
    ...
    #
    def create_async(resource_group_name, operational_insights_resource_provider, workspace_name, name, threat_intelligence_indicator_object_to_upsert, custom_headers:nil)
      ...
      request_content = @client.serialize(request_mapper,  threat_intelligence_indicator_object_to_upsert)
