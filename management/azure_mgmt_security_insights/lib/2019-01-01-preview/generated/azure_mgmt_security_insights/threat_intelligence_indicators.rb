...
module Azure::SecurityInsights::Mgmt::V2019_01_01_preview
  ...
  # provider
  #
  class ThreatIntelligenceIndicators
    include MsRestAzure
    ...
    #
    def list(resource_group_name, operational_insights_resource_provider, workspace_name, filter:nil, top:nil, skip_token:nil, orderby:nil, custom_headers:nil)
      first_page = list_as_lazy(resource_group_name, operational_insights_resource_provider, workspace_name, filter:filter, top:top, skip_token:skip_token, orderby:orderby, custom_headers:custom_headers)
    ...
    #
    def list_with_http_info(resource_group_name, operational_insights_resource_provider, workspace_name, filter:nil, top:nil, skip_token:nil, orderby:nil, custom_headers:nil)
      list_async(resource_group_name, operational_insights_resource_provider, workspace_name, filter:filter, top:top, skip_token:skip_token, orderby:orderby, custom_headers:custom_headers).value!
    end
    ...
    #
    def list_async(resource_group_name, operational_insights_resource_provider, workspace_name, filter:nil, top:nil, skip_token:nil, orderby:nil, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{operationalInsightsResourceProvider}/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/threatIntelligence/main/indicators'
      ...
      options = {
          ...
          query_params: {'api-version' => @client.api_version,'$filter' => filter,'$top' => top,'$skipToken' => skip_token,'$orderby' => orderby},
    ...
    # of the response.
    #
    def list_as_lazy(resource_group_name, operational_insights_resource_provider, workspace_name, filter:nil, top:nil, skip_token:nil, orderby:nil, custom_headers:nil)
      response = list_async(resource_group_name, operational_insights_resource_provider, workspace_name, filter:filter, top:top, skip_token:skip_token, orderby:orderby, custom_headers:custom_headers).value!
      unless response.nil?
        page = response.body
