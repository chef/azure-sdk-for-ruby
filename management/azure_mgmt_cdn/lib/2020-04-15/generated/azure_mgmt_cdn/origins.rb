...
module Azure::CDN::Mgmt::V2020_04_15
  ...
  class Origins
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::CDN::Mgmt::V2020_04_15::Models::OriginListResult.mapper()
    ...
    def get_async(resource_group_name, profile_name, endpoint_name, origin_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CDN::Mgmt::V2020_04_15::Models::Origin.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # endpoint.
    # @param origin [Origin] Origin properties
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [Origin] operation results.
    #
    def create(resource_group_name, profile_name, endpoint_name, origin_name, origin, custom_headers:nil)
      response = create_async(resource_group_name, profile_name, endpoint_name, origin_name, origin, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # response.
    #
    def create_async(resource_group_name, profile_name, endpoint_name, origin_name, origin, custom_headers:nil)
      # Send request
      promise = begin_create_async(resource_group_name, profile_name, endpoint_name, origin_name, origin, custom_headers:custom_headers)
    ...
    # will be added to the HTTP request.
    #
    def delete(resource_group_name, profile_name, endpoint_name, origin_name, custom_headers:nil)
      response = delete_async(resource_group_name, profile_name, endpoint_name, origin_name, custom_headers:custom_headers).value!
      nil
    end
    ...
    # response.
    #
    def delete_async(resource_group_name, profile_name, endpoint_name, origin_name, custom_headers:nil)
      # Send request
      promise = begin_delete_async(resource_group_name, profile_name, endpoint_name, origin_name, custom_headers:custom_headers)
    ...
    # @return [Origin] operation results.
    #
    def begin_create(resource_group_name, profile_name, endpoint_name, origin_name, origin, custom_headers:nil)
      response = begin_create_async(resource_group_name, profile_name, endpoint_name, origin_name, origin, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def begin_create_with_http_info(resource_group_name, profile_name, endpoint_name, origin_name, origin, custom_headers:nil)
      begin_create_async(resource_group_name, profile_name, endpoint_name, origin_name, origin, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def begin_create_async(resource_group_name, profile_name, endpoint_name, origin_name, origin, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MaxLength': '90'" if !resource_group_name.nil? && resource_group_name.length > 90
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MinLength': '1'" if !resource_group_name.nil? && resource_group_name.length < 1
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'Pattern': '^[-\w\._\(\)]+$'" if !resource_group_name.nil? && resource_group_name.match(Regexp.new('^^[-\w\._\(\)]+$$')).nil?
      ...
      # Serialize Request
      request_mapper = Azure::CDN::Mgmt::V2020_04_15::Models::Origin.mapper()
    ...
    def begin_update_async(resource_group_name, profile_name, endpoint_name, origin_name, origin_update_properties, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::CDN::Mgmt::V2020_04_15::Models::OriginUpdateParameters.mapper()
    ...
    #
    #
    def begin_delete(resource_group_name, profile_name, endpoint_name, origin_name, custom_headers:nil)
      response = begin_delete_async(resource_group_name, profile_name, endpoint_name, origin_name, custom_headers:custom_headers).value!
      nil
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def begin_delete_with_http_info(resource_group_name, profile_name, endpoint_name, origin_name, custom_headers:nil)
      begin_delete_async(resource_group_name, profile_name, endpoint_name, origin_name, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def begin_delete_async(resource_group_name, profile_name, endpoint_name, origin_name, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MaxLength': '90'" if !resource_group_name.nil? && resource_group_name.length > 90
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MinLength': '1'" if !resource_group_name.nil? && resource_group_name.length < 1
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'Pattern': '^[-\w\._\(\)]+$'" if !resource_group_name.nil? && resource_group_name.match(Regexp.new('^^[-\w\._\(\)]+$$')).nil?
