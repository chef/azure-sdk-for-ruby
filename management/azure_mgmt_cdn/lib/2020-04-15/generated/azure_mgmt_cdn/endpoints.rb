...
module Azure::CDN::Mgmt::V2020_04_15
  ...
  class Endpoints
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::CDN::Mgmt::V2020_04_15::Models::EndpointListResult.mapper()
    ...
    def get_async(resource_group_name, profile_name, endpoint_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CDN::Mgmt::V2020_04_15::Models::Endpoint.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # specified subscription, resource group and profile. Only tags can be updated
    # after creating an endpoint. To update origins, use the Update Origin
    # operation. To update origin groups, use the Update Origin group operation. To
    ...
    def validate_custom_domain_async(resource_group_name, profile_name, endpoint_name, custom_domain_properties, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::CDN::Mgmt::V2020_04_15::Models::ValidateCustomDomainInput.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CDN::Mgmt::V2020_04_15::Models::ValidateCustomDomainOutput.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_resource_usage_async(resource_group_name, profile_name, endpoint_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CDN::Mgmt::V2020_04_15::Models::ResourceUsageListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_async(resource_group_name, profile_name, endpoint_name, endpoint, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::CDN::Mgmt::V2020_04_15::Models::Endpoint.mapper()
    ...
    def begin_update_async(resource_group_name, profile_name, endpoint_name, endpoint_update_properties, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::CDN::Mgmt::V2020_04_15::Models::EndpointUpdateParameters.mapper()
    ...
    def begin_purge_content_async(resource_group_name, profile_name, endpoint_name, content_file_paths, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::CDN::Mgmt::V2020_04_15::Models::PurgeParameters.mapper()
    ...
    def begin_load_content_async(resource_group_name, profile_name, endpoint_name, content_file_paths, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::CDN::Mgmt::V2020_04_15::Models::LoadParameters.mapper()
      request_content = @client.serialize(request_mapper,  content_file_paths)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
