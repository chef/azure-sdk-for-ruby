...
module Azure::CDN::Mgmt::V2020_09_01
  ...
  class Profiles
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::CDN::Mgmt::V2020_09_01::Models::ProfileListResult.mapper()
    ...
    def get_async(resource_group_name, profile_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CDN::Mgmt::V2020_09_01::Models::Profile.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def generate_sso_uri_async(resource_group_name, profile_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CDN::Mgmt::V2020_09_01::Models::SsoUri.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_supported_optimization_types_async(resource_group_name, profile_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CDN::Mgmt::V2020_09_01::Models::SupportedOptimizationTypesListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_async(resource_group_name, profile_name, profile, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::CDN::Mgmt::V2020_09_01::Models::Profile.mapper()
    ...
    def begin_update_async(resource_group_name, profile_name, profile_update_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::CDN::Mgmt::V2020_09_01::Models::ProfileUpdateParameters.mapper()
