...
module Azure::CDN::Mgmt::V2020_09_01
  module Models
    #
    # Result of the request to list routes. It contains a list of route objects
    ...
    class RouteListResult
      ...
      # @return [Array<Route>] List of AzureFrontDoor routes within a profile.
      attr_accessor :value

      # @return [String] URL to get the next set of route objects if there are
      # any.
