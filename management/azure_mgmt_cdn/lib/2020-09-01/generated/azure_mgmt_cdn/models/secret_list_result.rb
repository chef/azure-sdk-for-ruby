...
module Azure::CDN::Mgmt::V2020_09_01
  module Models
    #
    # Result of the request to list secrets. It contains a list of Secret
    ...
    class SecretListResult
      ...
      # @return [Array<Secret>] List of AzureFrontDoor secrets within a
      # profile.
      attr_accessor :value

      # @return [String] URL to get the next set of Secret objects if there are
      # any.
