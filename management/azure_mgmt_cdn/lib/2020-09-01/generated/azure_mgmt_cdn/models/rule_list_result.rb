...
module Azure::CDN::Mgmt::V2020_09_01
  module Models
    #
    # Result of the request to list rules. It contains a list of rule objects
    ...
    class RuleListResult
      ...
      # @return [Array<Rule>] List of AzureFrontDoor rules within a rule set.
      attr_accessor :value

      # @return [String] URL to get the next set of rule objects if there are
      # any.
