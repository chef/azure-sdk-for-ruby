...
module Azure::CDN::Mgmt::V2020_09_01
  ...
  class CdnManagementClient < MsRestAzure::AzureServiceClient
    ...
    # @return [AFDProfiles] afdprofiles
    attr_reader :afdprofiles

    # @return [AFDCustomDomains] afdcustom_domains
    attr_reader :afdcustom_domains

    # @return [AFDEndpoints] afdendpoints
    attr_reader :afdendpoints

    # @return [AFDOriginGroups] afdorigin_groups
    attr_reader :afdorigin_groups

    # @return [AFDOrigins] afdorigins
    attr_reader :afdorigins
    ...
    # @return [SecurityPolicies] security_policies
    attr_reader :security_policies
    ...
    def initialize(credentials = nil, base_url = nil, options = nil)
      ...
      @afdprofiles = AFDProfiles.new(self)
      @afdcustom_domains = AFDCustomDomains.new(self)
      @afdendpoints = AFDEndpoints.new(self)
      @afdorigin_groups = AFDOriginGroups.new(self)
      @afdorigins = AFDOrigins.new(self)
      @routes = Routes.new(self)
      @rule_sets = RuleSets.new(self)
      @rules = Rules.new(self)
      @security_policies = SecurityPolicies.new(self)
    ...
    def check_name_availability_async(check_name_availability_input, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::CDN::Mgmt::V2020_09_01::Models::CheckNameAvailabilityInput.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::CDN::Mgmt::V2020_09_01::Models::CheckNameAvailabilityOutput.mapper()
    ...
    def validate_probe_async(validate_probe_input, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::CDN::Mgmt::V2020_09_01::Models::ValidateProbeInput.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::CDN::Mgmt::V2020_09_01::Models::ValidateProbeOutput.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
