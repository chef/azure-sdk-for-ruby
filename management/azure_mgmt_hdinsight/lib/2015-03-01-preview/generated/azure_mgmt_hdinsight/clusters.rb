...
module Azure::Hdinsight::Mgmt::V2015_03_01_preview
  ...
  class Clusters
    ...
    def create_async(resource_group_name, cluster_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Hdinsight::Mgmt::V2015_03_01_preview::Models::Cluster.mapper()
    ...
    def update_async(resource_group_name, cluster_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Hdinsight::Mgmt::V2015_03_01_preview::Models::ClusterPatchParameters.mapper()
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Hdinsight::Mgmt::V2015_03_01_preview::Models::ClusterListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_async(resource_group_name, cluster_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Hdinsight::Mgmt::V2015_03_01_preview::Models::ClusterCreateParametersExtended.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_resize_async(resource_group_name, cluster_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Hdinsight::Mgmt::V2015_03_01_preview::Models::ClusterResizeParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_rotate_disk_encryption_key_async(resource_group_name, cluster_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Hdinsight::Mgmt::V2015_03_01_preview::Models::ClusterDiskEncryptionParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_execute_script_actions_async(resource_group_name, cluster_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Hdinsight::Mgmt::V2015_03_01_preview::Models::ExecuteScriptActionParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
