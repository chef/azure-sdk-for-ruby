...
module Azure::EdgeGateway::Mgmt::V2019_03_01
  ...
  class Roles
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::EdgeGateway::Mgmt::V2019_03_01::Models::RoleList.mapper()
    ...
    def get_async(device_name, name, resource_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::EdgeGateway::Mgmt::V2019_03_01::Models::Role.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(device_name, name, role, resource_group_name, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::EdgeGateway::Mgmt::V2019_03_01::Models::Role.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [RoleList] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [RoleList] which provide lazy access to pages of the response.
    #
