...
module Azure::EdgeGateway::Mgmt::V2019_03_01
  ...
  class OperationsStatus
    ...
    #
    # Creates and initializes a new instance of the OperationsStatus class.
    ...
    def get_async(device_name, name, resource_group_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/operationsStatus/{name}'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::EdgeGateway::Mgmt::V2019_03_01::Models::Job.mapper()
