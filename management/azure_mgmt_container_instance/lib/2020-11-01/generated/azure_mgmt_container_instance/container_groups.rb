...
module Azure::ContainerInstance::Mgmt::V2020_11_01
  ...
  class ContainerGroups
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ContainerInstance::Mgmt::V2020_11_01::Models::ContainerGroupListResult.mapper()
    ...
    def get_async(resource_group_name, container_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ContainerInstance::Mgmt::V2020_11_01::Models::ContainerGroup.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def update_async(resource_group_name, container_group_name, resource, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ContainerInstance::Mgmt::V2020_11_01::Models::Resource.mapper()
    ...
    def begin_create_or_update_async(resource_group_name, container_group_name, container_group, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ContainerInstance::Mgmt::V2020_11_01::Models::ContainerGroup.mapper()
