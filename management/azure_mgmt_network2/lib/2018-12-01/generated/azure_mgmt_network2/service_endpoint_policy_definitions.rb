...
module Azure::Network2::Mgmt::V2018_12_01
  ...
  class ServiceEndpointPolicyDefinitions
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2018_12_01::Models::ServiceEndpointPolicyDefinition.mapper()
    ...
    def list_by_resource_group_async(resource_group_name, service_endpoint_policy_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network2::Mgmt::V2018_12_01::Models::ServiceEndpointPolicyDefinitionListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, service_endpoint_policy_name, service_endpoint_policy_definition_name, service_endpoint_policy_definitions, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2018_12_01::Models::ServiceEndpointPolicyDefinition.mapper()
