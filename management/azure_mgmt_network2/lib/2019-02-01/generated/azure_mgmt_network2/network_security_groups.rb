...
module Azure::Network2::Mgmt::V2019_02_01
  ...
  class NetworkSecurityGroups
    ...
    def delete(resource_group_name, network_security_group_name, custom_headers:nil)
      response = delete_async(resource_group_name, network_security_group_name, custom_headers:custom_headers).value!
      nil
    end
    ...
    def delete_async(resource_group_name, network_security_group_name, custom_headers:nil)
      # Send request
      promise = begin_delete_async(resource_group_name, network_security_group_name, custom_headers:custom_headers)
    ...
    def get(resource_group_name, network_security_group_name, expand:nil, custom_headers:nil)
      response = get_async(resource_group_name, network_security_group_name, expand:expand, custom_headers:custom_headers).value!
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2019_02_01::Models::NetworkSecurityGroup.mapper()
    ...
    def create_or_update(resource_group_name, network_security_group_name, parameters, custom_headers:nil)
      response = create_or_update_async(resource_group_name, network_security_group_name, parameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_async(resource_group_name, network_security_group_name, parameters, custom_headers:nil)
      # Send request
      promise = begin_create_or_update_async(resource_group_name, network_security_group_name, parameters, custom_headers:custom_headers)
    ...
    # @return [NetworkSecurityGroup] operation results.
    #
    def update_tags(resource_group_name, network_security_group_name, parameters, custom_headers:nil)
      response = update_tags_async(resource_group_name, network_security_group_name, parameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # response.
    #
    def update_tags_async(resource_group_name, network_security_group_name, parameters, custom_headers:nil)
      # Send request
      promise = begin_update_tags_async(resource_group_name, network_security_group_name, parameters, custom_headers:custom_headers)
    ...
    def list_all_async(custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network2::Mgmt::V2019_02_01::Models::NetworkSecurityGroupListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_delete(resource_group_name, network_security_group_name, custom_headers:nil)
      response = begin_delete_async(resource_group_name, network_security_group_name, custom_headers:custom_headers).value!
      nil
    end
    ...
    def begin_delete_with_http_info(resource_group_name, network_security_group_name, custom_headers:nil)
      begin_delete_async(resource_group_name, network_security_group_name, custom_headers:custom_headers).value!
    end
    ...
    def begin_create_or_update(resource_group_name, network_security_group_name, parameters, custom_headers:nil)
      response = begin_create_or_update_async(resource_group_name, network_security_group_name, parameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_create_or_update_async(resource_group_name, network_security_group_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2019_02_01::Models::NetworkSecurityGroup.mapper()
    ...
    # @return [NetworkSecurityGroup] operation results.
    #
    def begin_update_tags(resource_group_name, network_security_group_name, parameters, custom_headers:nil)
      response = begin_update_tags_async(resource_group_name, network_security_group_name, parameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def begin_update_tags_async(resource_group_name, network_security_group_name, parameters, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'network_security_group_name is nil' if network_security_group_name.nil?
      fail ArgumentError, 'parameters is nil' if parameters.nil?
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
