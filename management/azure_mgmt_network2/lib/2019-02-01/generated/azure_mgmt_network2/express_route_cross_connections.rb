  ...
  class ExpressRouteCrossConnections
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2019_02_01::Models::ExpressRouteCrossConnectionListResult.mapper()
    ...
    def get_async(resource_group_name, cross_connection_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network2::Mgmt::V2019_02_01::Models::ExpressRouteCrossConnection.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_routes_table_summary_async(resource_group_name, cross_connection_name, peering_name, device_path, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network2::Mgmt::V2019_02_01::Models::ExpressRouteCrossConnectionsRoutesTableSummaryListResult.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def begin_create_or_update_async(resource_group_name, cross_connection_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2019_02_01::Models::ExpressRouteCrossConnection.mapper()
