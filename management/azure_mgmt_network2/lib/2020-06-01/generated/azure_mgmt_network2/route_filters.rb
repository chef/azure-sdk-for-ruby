...
module Azure::Network2::Mgmt::V2020_06_01
  ...
  class RouteFilters
    ...
    def delete_async(resource_group_name, route_filter_name, custom_headers:nil)
      # Send request
      promise = begin_delete_async(resource_group_name, route_filter_name, custom_headers:custom_headers)
    ...
    def get(resource_group_name, route_filter_name, expand:nil, custom_headers:nil)
      response = get_async(resource_group_name, route_filter_name, expand:expand, custom_headers:custom_headers).value!
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2020_06_01::Models::RouteFilter.mapper()
    ...
    def create_or_update_async(resource_group_name, route_filter_name, route_filter_parameters, custom_headers:nil)
      # Send request
      promise = begin_create_or_update_async(resource_group_name, route_filter_name, route_filter_parameters, custom_headers:custom_headers)
    ...
    # @param resource_group_name [String] The name of the resource group.
    # @param route_filter_name [String] The name of the route filter.
    # @param parameters [TagsObject] Parameters supplied to update route filter
    # tags.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [RouteFilter] operation results.
    #
    def update_tags(resource_group_name, route_filter_name, parameters, custom_headers:nil)
      response = update_tags_async(resource_group_name, route_filter_name, parameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure2::AzureOperationResponse] HTTP response information.
    #
    def update_tags_with_http_info(resource_group_name, route_filter_name, parameters, custom_headers:nil)
      update_tags_async(resource_group_name, route_filter_name, parameters, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def update_tags_async(resource_group_name, route_filter_name, parameters, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'route_filter_name is nil' if route_filter_name.nil?
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network2::Mgmt::V2020_06_01::Models::RouteFilterListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_delete(resource_group_name, route_filter_name, custom_headers:nil)
      response = begin_delete_async(resource_group_name, route_filter_name, custom_headers:custom_headers).value!
      nil
    end
    ...
    def begin_delete_with_http_info(resource_group_name, route_filter_name, custom_headers:nil)
      begin_delete_async(resource_group_name, route_filter_name, custom_headers:custom_headers).value!
    end
    ...
    def begin_create_or_update_with_http_info(resource_group_name, route_filter_name, route_filter_parameters, custom_headers:nil)
      begin_create_or_update_async(resource_group_name, route_filter_name, route_filter_parameters, custom_headers:custom_headers).value!
    end
    ...
    def begin_create_or_update_async(resource_group_name, route_filter_name, route_filter_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_06_01::Models::RouteFilter.mapper()
