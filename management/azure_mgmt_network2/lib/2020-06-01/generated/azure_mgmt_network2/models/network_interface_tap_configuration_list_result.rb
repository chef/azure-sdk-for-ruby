...
module Azure::Network2::Mgmt::V2020_06_01
  module Models
    ...
    class NetworkInterfaceTapConfigurationListResult
      ...
      # @return [Array<NetworkInterfaceTapConfiguration>] A list of tap
      # configurations.
      attr_accessor :value
      ...
      #
      # @return [NetworkInterfaceTapConfigurationListResult] with next page
      # content.
      #
      def get_next_page
      ...
      #
      # Mapper for NetworkInterfaceTapConfigurationListResult class as Ruby
      # Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'NetworkInterfaceTapConfigurationListResult',
          type: {
            name: 'Composite',
            class_name: 'NetworkInterfaceTapConfigurationListResult',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
