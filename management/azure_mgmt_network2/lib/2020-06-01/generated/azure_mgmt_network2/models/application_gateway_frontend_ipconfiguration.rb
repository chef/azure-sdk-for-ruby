...
module Azure::Network2::Mgmt::V2020_06_01
  module Models
    ...
    class ApplicationGatewayFrontendIPConfiguration < SubResource
      ...
      # @return [SubResource] Reference to the PublicIP resource.
      attr_accessor :public_ipaddress

      # @return [SubResource] Reference to the application gateway private link
      # configuration.
      attr_accessor :private_link_configuration
          ...
          type: {
            ...
            model_properties: {
              ...
              private_link_configuration: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.privateLinkConfiguration',
                type: {
                  name: 'Composite',
                  class_name: 'SubResource'
                }
