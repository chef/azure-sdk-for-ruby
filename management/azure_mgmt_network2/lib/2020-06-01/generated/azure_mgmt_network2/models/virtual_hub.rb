...
module Azure::Network2::Mgmt::V2020_06_01
  module Models
    ...
    class VirtualHub < Resource
      ...
      # @return [Boolean] Flag to control route propogation for VirtualRouter
      # hub.
      attr_accessor :enable_virtual_router_route_propogation
          ...
          type: {
            ...
            model_properties: {
              ...
              enable_virtual_router_route_propogation: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.enableVirtualRouterRoutePropogation',
                type: {
                  name: 'Boolean'
                }
              },
