...
module Azure::Network2::Mgmt::V2020_06_01
  module Models
    ...
    class VirtualNetworkPeering < SubResource
      ...
      # @return [SubResource] The reference to the remote virtual network. The
      ...
      # @return [AddressSpace] The reference to the remote virtual network
      # address space.
      attr_accessor :remote_address_space

      # @return [VirtualNetworkBgpCommunities] The reference to the remote
      # virtual network's Bgp Communities.
      attr_accessor :remote_bgp_communities
          ...
          type: {
            ...
            model_properties: {
              ...
              remote_bgp_communities: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.remoteBgpCommunities',
                type: {
                  name: 'Composite',
