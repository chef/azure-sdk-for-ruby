...
module Azure::Network2::Mgmt::V2020_06_01
  module Models
    ...
    class ApplicationGatewayHttpListener < SubResource
      ...
      # @return [SubResource] SSL profile resource of the application gateway.
      attr_accessor :ssl_profile
      ...
      # @return [Array<String>] List of Host names for HTTP Listener that
          ...
          type: {
            ...
            model_properties: {
              ...
              ssl_profile: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.sslProfile',
                type: {
                  name: 'Composite',
                  class_name: 'SubResource'
                }
