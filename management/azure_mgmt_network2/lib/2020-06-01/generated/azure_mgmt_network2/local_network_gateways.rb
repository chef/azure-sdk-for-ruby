...
module Azure::Network2::Mgmt::V2020_06_01
  ...
  class LocalNetworkGateways
    ...
    def create_or_update_async(resource_group_name, local_network_gateway_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network2::Mgmt::V2020_06_01::Models::LocalNetworkGateway.mapper()
    ...
    # @return [MsRestAzure2::AzureOperationResponse] HTTP response information.
    #
    def update_tags_with_http_info(resource_group_name, local_network_gateway_name, parameters, custom_headers:nil)
      update_tags_async(resource_group_name, local_network_gateway_name, parameters, custom_headers:custom_headers).value!
    end
    ...
    def list_async(resource_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network2::Mgmt::V2020_06_01::Models::LocalNetworkGatewayListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, local_network_gateway_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_06_01::Models::LocalNetworkGateway.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
