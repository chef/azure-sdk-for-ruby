      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2020_06_01::Models::ListVirtualHubBgpConnectionResults.mapper()
    ...
    def list_learned_routes_async(resource_group_name, hub_name, connection_name, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network2::Mgmt::V2020_06_01::Models::PeerRouteList.mapper()
