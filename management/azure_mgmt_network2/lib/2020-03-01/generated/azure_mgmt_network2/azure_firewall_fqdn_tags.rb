...
module Azure::Network2::Mgmt::V2020_03_01
  ...
  class AzureFirewallFqdnTags
    ...
    #
    # Creates and initializes a new instance of the AzureFirewallFqdnTags class.
    ...
    #
    # @return [Array<AzureFirewallFqdnTag>] operation results.
    #
    ...
    def list_all_async(custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/providers/Microsoft.Network/azureFirewallFqdnTags'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2020_03_01::Models::AzureFirewallFqdnTagListResult.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [AzureFirewallFqdnTagListResult] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [AzureFirewallFqdnTagListResult] which provide lazy access to pages
    # of the response.
    #
