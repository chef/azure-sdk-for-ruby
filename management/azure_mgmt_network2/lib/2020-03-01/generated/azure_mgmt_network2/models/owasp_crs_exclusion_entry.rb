...
module Azure::Network2::Mgmt::V2020_03_01
  module Models
    ...
    class OwaspCrsExclusionEntry
      ...
      # @return [OwaspCrsExclusionEntryMatchVariable] The variable to be
      # excluded. Possible values include: 'RequestHeaderNames',
      # 'RequestCookieNames', 'RequestArgNames'
      attr_accessor :match_variable

      # @return [OwaspCrsExclusionEntrySelectorMatchOperator] When
      # matchVariable is a collection, operate on the selector to specify which
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'OwaspCrsExclusionEntry',
          type: {
            name: 'Composite',
