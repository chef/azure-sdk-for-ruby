...
module Azure::Network2::Mgmt::V2018_06_01
  ...
  class ExpressRouteCircuitConnections
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2018_06_01::Models::ExpressRouteCircuitConnection.mapper()
    ...
    def begin_create_or_update_async(resource_group_name, circuit_name, peering_name, connection_name, express_route_circuit_connection_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2018_06_01::Models::ExpressRouteCircuitConnection.mapper()
