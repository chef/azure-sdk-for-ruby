...
module Azure::Network2::Mgmt::V2018_06_01
  ...
  class PublicIPAddresses
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2018_06_01::Models::PublicIPAddress.mapper()
    ...
    def update_tags_async(resource_group_name, public_ip_address_name, parameters, custom_headers:nil)
      # Send request
      promise = begin_update_tags_async(resource_group_name, public_ip_address_name, parameters, custom_headers:custom_headers)
    ...
    def list_all_async(custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network2::Mgmt::V2018_06_01::Models::PublicIPAddressListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, public_ip_address_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2018_06_01::Models::PublicIPAddress.mapper()
    ...
    # @return [PublicIPAddress] operation results.
    #
    def begin_update_tags(resource_group_name, public_ip_address_name, parameters, custom_headers:nil)
    ...
    # @return [MsRestAzure2::AzureOperationResponse] HTTP response information.
    #
    def begin_update_tags_with_http_info(resource_group_name, public_ip_address_name, parameters, custom_headers:nil)
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def begin_update_tags_async(resource_group_name, public_ip_address_name, parameters, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'public_ip_address_name is nil' if public_ip_address_name.nil?
      fail ArgumentError, 'parameters is nil' if parameters.nil?
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
