...
module Azure::Network2::Mgmt::V2019_12_01
  module Models
    ...
    class WebApplicationFirewallPolicyListResult
      ...
      # @return [Array<WebApplicationFirewallPolicy>] List of
      # WebApplicationFirewallPolicies within a resource group.
      attr_accessor :value

      # @return [String] URL to get the next set of
      ...
      #
      # @return [WebApplicationFirewallPolicyListResult] with next page
      # content.
      #
      def get_next_page
      ...
      #
      # Mapper for WebApplicationFirewallPolicyListResult class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'WebApplicationFirewallPolicyListResult',
          type: {
            name: 'Composite',
            class_name: 'WebApplicationFirewallPolicyListResult',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'WebApplicationFirewallPolicyElementType',
                      type: {
                        name: 'Composite',
