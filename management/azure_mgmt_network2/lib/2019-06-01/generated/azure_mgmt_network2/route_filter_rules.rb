...
module Azure::Network2::Mgmt::V2019_06_01
  ...
  class RouteFilterRules
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2019_06_01::Models::RouteFilterRule.mapper()
    ...
    def list_by_route_filter_async(resource_group_name, route_filter_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network2::Mgmt::V2019_06_01::Models::RouteFilterRuleListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, route_filter_name, rule_name, route_filter_rule_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2019_06_01::Models::RouteFilterRule.mapper()
    ...
    def begin_update_async(resource_group_name, route_filter_name, rule_name, route_filter_rule_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2019_06_01::Models::PatchRouteFilterRule.mapper()
      request_content = @client.serialize(request_mapper,  route_filter_rule_parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
