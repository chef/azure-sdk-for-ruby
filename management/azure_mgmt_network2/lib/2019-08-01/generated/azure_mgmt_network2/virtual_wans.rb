...
module Azure::Network2::Mgmt::V2019_08_01
  ...
  class VirtualWans
    ...
    #
    # Creates and initializes a new instance of the VirtualWans class.
    ...
    def get(resource_group_name, virtual_wanname, custom_headers:nil)
      response = get_async(resource_group_name, virtual_wanname, custom_headers:custom_headers).value!
    ...
    def get_with_http_info(resource_group_name, virtual_wanname, custom_headers:nil)
      get_async(resource_group_name, virtual_wanname, custom_headers:custom_headers).value!
    end
    ...
    def get_async(resource_group_name, virtual_wanname, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{VirtualWANName}'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2019_08_01::Models::VirtualWAN.mapper()
    ...
    def create_or_update_async(resource_group_name, virtual_wanname, wanparameters, custom_headers:nil)
      # Send request
      promise = begin_create_or_update_async(resource_group_name, virtual_wanname, wanparameters, custom_headers:custom_headers)
    ...
    def update_tags_async(resource_group_name, virtual_wanname, wanparameters, custom_headers:nil)
      # Send request
      promise = begin_update_tags_async(resource_group_name, virtual_wanname, wanparameters, custom_headers:custom_headers)
    ...
    def delete_async(resource_group_name, virtual_wanname, custom_headers:nil)
      # Send request
      promise = begin_delete_async(resource_group_name, virtual_wanname, custom_headers:custom_headers)
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers:nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network2::Mgmt::V2019_08_01::Models::ListVirtualWANsResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_async(custom_headers:nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/providers/Microsoft.Network/virtualWans'
    ...
    def begin_create_or_update(resource_group_name, virtual_wanname, wanparameters, custom_headers:nil)
      response = begin_create_or_update_async(resource_group_name, virtual_wanname, wanparameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_create_or_update_with_http_info(resource_group_name, virtual_wanname, wanparameters, custom_headers:nil)
      begin_create_or_update_async(resource_group_name, virtual_wanname, wanparameters, custom_headers:custom_headers).value!
    end
    ...
    def begin_create_or_update_async(resource_group_name, virtual_wanname, wanparameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2019_08_01::Models::VirtualWAN.mapper()
      request_content = @client.serialize(request_mapper,  wanparameters)
    ...
    def begin_update_tags(resource_group_name, virtual_wanname, wanparameters, custom_headers:nil)
      response = begin_update_tags_async(resource_group_name, virtual_wanname, wanparameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def begin_update_tags_with_http_info(resource_group_name, virtual_wanname, wanparameters, custom_headers:nil)
      begin_update_tags_async(resource_group_name, virtual_wanname, wanparameters, custom_headers:custom_headers).value!
    end
    ...
    def begin_delete_with_http_info(resource_group_name, virtual_wanname, custom_headers:nil)
      begin_delete_async(resource_group_name, virtual_wanname, custom_headers:custom_headers).value!
    end
    ...
    # will be added to the HTTP request.
    #
    # @return [ListVirtualWANsResult] operation results.
    #
