...
module Azure::Network2::Mgmt::V2019_07_01
  module Models
    ...
    class P2SVpnServerConfigRadiusServerRootCertificate < SubResource
      ...
      # @return [ProvisioningState] The provisioning state of the radius server
      ...
      #
      # Mapper for P2SVpnServerConfigRadiusServerRootCertificate class as Ruby
      # Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'P2SVpnServerConfigRadiusServerRootCertificate',
          type: {
            name: 'Composite',
