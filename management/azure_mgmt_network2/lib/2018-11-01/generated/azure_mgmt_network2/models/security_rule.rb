...
module Azure::Network2::Mgmt::V2018_11_01
  module Models
    ...
    class SecurityRule < SubResource
      ...
      # between 0 and 65535. Asterisks '*' can also be used to match all ports.
      attr_accessor :destination_port_range

      # @return [String] The CIDR or source IP range. Asterisks '*' can also be
      ...
      # range. Asterisks '*' can also be used to match all source IPs. Default
