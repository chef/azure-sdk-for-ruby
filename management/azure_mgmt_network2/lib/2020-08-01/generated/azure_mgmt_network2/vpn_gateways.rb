...
module Azure::Network2::Mgmt::V2020_08_01
  ...
  class VpnGateways
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2020_08_01::Models::VpnGateway.mapper()
    ...
    def update_tags_async(resource_group_name, gateway_name, vpn_gateway_parameters, custom_headers:nil)
      # Send request
      promise = begin_update_tags_async(resource_group_name, gateway_name, vpn_gateway_parameters, custom_headers:custom_headers)
    ...
    # VpnGateway.
    # @param gateway_name [String] The name of the gateway.
    # @param parameters [VpnGatewayPacketCaptureStartParameters] Vpn gateway packet
    # capture parameters supplied to start packet capture on vpn gateway.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [String] operation results.
    #
    def start_packet_capture(resource_group_name, gateway_name, parameters:nil, custom_headers:nil)
      response = start_packet_capture_async(resource_group_name, gateway_name, parameters:parameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # response.
    #
    def start_packet_capture_async(resource_group_name, gateway_name, parameters:nil, custom_headers:nil)
      # Send request
      promise = begin_start_packet_capture_async(resource_group_name, gateway_name, parameters:parameters, custom_headers:custom_headers)
    ...
    # VpnGateway.
    # @param gateway_name [String] The name of the gateway.
    # @param parameters [VpnGatewayPacketCaptureStopParameters] Vpn gateway packet
    # capture parameters supplied to stop packet capture on vpn gateway.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [String] operation results.
    #
    def stop_packet_capture(resource_group_name, gateway_name, parameters:nil, custom_headers:nil)
      response = stop_packet_capture_async(resource_group_name, gateway_name, parameters:parameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # response.
    #
    def stop_packet_capture_async(resource_group_name, gateway_name, parameters:nil, custom_headers:nil)
      # Send request
      promise = begin_stop_packet_capture_async(resource_group_name, gateway_name, parameters:parameters, custom_headers:custom_headers)
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network2::Mgmt::V2020_08_01::Models::ListVpnGatewaysResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, gateway_name, vpn_gateway_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_08_01::Models::VpnGateway.mapper()
    ...
    def begin_update_tags(resource_group_name, gateway_name, vpn_gateway_parameters, custom_headers:nil)
      response = begin_update_tags_async(resource_group_name, gateway_name, vpn_gateway_parameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [String] operation results.
    #
    def begin_start_packet_capture(resource_group_name, gateway_name, parameters:nil, custom_headers:nil)
      response = begin_start_packet_capture_async(resource_group_name, gateway_name, parameters:parameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure2::AzureOperationResponse] HTTP response information.
    #
    def begin_start_packet_capture_with_http_info(resource_group_name, gateway_name, parameters:nil, custom_headers:nil)
      begin_start_packet_capture_async(resource_group_name, gateway_name, parameters:parameters, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def begin_start_packet_capture_async(resource_group_name, gateway_name, parameters:nil, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'gateway_name is nil' if gateway_name.nil?
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_08_01::Models::VpnGatewayPacketCaptureStartParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil

      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/startpacketcapture'
    ...
    # @return [String] operation results.
    #
    def begin_stop_packet_capture(resource_group_name, gateway_name, parameters:nil, custom_headers:nil)
      response = begin_stop_packet_capture_async(resource_group_name, gateway_name, parameters:parameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure2::AzureOperationResponse] HTTP response information.
    #
    def begin_stop_packet_capture_with_http_info(resource_group_name, gateway_name, parameters:nil, custom_headers:nil)
      begin_stop_packet_capture_async(resource_group_name, gateway_name, parameters:parameters, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def begin_stop_packet_capture_async(resource_group_name, gateway_name, parameters:nil, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'gateway_name is nil' if gateway_name.nil?
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_08_01::Models::VpnGatewayPacketCaptureStopParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil

      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/stoppacketcapture'
