...
module Azure::Network2::Mgmt::V2020_08_01
  ...
  class ExpressRouteGateways
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2020_08_01::Models::ExpressRouteGatewayList.mapper()
    ...
    def create_or_update_async(resource_group_name, express_route_gateway_name, put_express_route_gateway_parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network2::Mgmt::V2020_08_01::Models::ExpressRouteGateway.mapper()
    ...
    # ExpressRouteGateway.
    # @param express_route_gateway_name [String] The name of the gateway.
    # @param express_route_gateway_parameters [TagsObject] Parameters supplied to
    # update a virtual wan express route gateway tags.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [ExpressRouteGateway] operation results.
    #
    def update_tags(resource_group_name, express_route_gateway_name, express_route_gateway_parameters, custom_headers:nil)
      response = update_tags_async(resource_group_name, express_route_gateway_name, express_route_gateway_parameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # response.
    #
    def update_tags_async(resource_group_name, express_route_gateway_name, express_route_gateway_parameters, custom_headers:nil)
      # Send request
      promise = begin_update_tags_async(resource_group_name, express_route_gateway_name, express_route_gateway_parameters, custom_headers:custom_headers)
    ...
    def begin_create_or_update_async(resource_group_name, express_route_gateway_name, put_express_route_gateway_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_08_01::Models::ExpressRouteGateway.mapper()
    ...
    # @return [ExpressRouteGateway] operation results.
    #
    def begin_update_tags(resource_group_name, express_route_gateway_name, express_route_gateway_parameters, custom_headers:nil)
      response = begin_update_tags_async(resource_group_name, express_route_gateway_name, express_route_gateway_parameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure2::AzureOperationResponse] HTTP response information.
    #
    def begin_update_tags_with_http_info(resource_group_name, express_route_gateway_name, express_route_gateway_parameters, custom_headers:nil)
      begin_update_tags_async(resource_group_name, express_route_gateway_name, express_route_gateway_parameters, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def begin_update_tags_async(resource_group_name, express_route_gateway_name, express_route_gateway_parameters, custom_headers:nil)
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'express_route_gateway_name is nil' if express_route_gateway_name.nil?
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      fail ArgumentError, 'express_route_gateway_parameters is nil' if express_route_gateway_parameters.nil?
      ...
      request_content = @client.serialize(request_mapper,  express_route_gateway_parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
      ...
      options = {
          middlewares: [[MsRest2::RetryPolicyMiddleware, times: 3, retry: 0.02], [:cookie_jar]],
          path_params: {'subscriptionId' => @client.subscription_id,'resourceGroupName' => resource_group_name,'expressRouteGatewayName' => express_route_gateway_name},
          query_params: {'api-version' => @client.api_version},
          body: request_content,
          headers: request_headers.merge(custom_headers || {}),
          base_url: request_url
