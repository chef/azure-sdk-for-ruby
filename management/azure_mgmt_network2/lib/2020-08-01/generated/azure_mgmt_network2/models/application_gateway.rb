...
module Azure::Network2::Mgmt::V2020_08_01
  module Models
    ...
    class ApplicationGateway < Resource
      ...
      # @return [Array<ApplicationGatewayTrustedClientCertificate>] Trusted
      # client certificates of the application gateway resource. For default
      ...
      # @return [Array<ApplicationGatewaySslProfile>] SSL profiles of the
      # application gateway resource. For default limits, see [Application
      # Gateway
      # limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
      attr_accessor :ssl_profiles
      ...
      # @return [Array<ApplicationGatewayPrivateLinkConfiguration>] PrivateLink
      # configurations on application gateway.
      attr_accessor :private_link_configurations

      # @return [Array<ApplicationGatewayPrivateEndpointConnection>] Private
      # Endpoint connections on application gateway.
      attr_accessor :private_endpoint_connections

      # @return [String] The resource GUID property of the application gateway
      # resource.
      ...
      # @return [Boolean] If true, associates a firewall policy with an
      # application gateway regardless whether the policy differs from the WAF
      # Config.
      attr_accessor :force_firewall_policy_association
          ...
          type: {
            ...
            model_properties: {
              ...
              trusted_client_certificates: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'ApplicationGatewayTrustedClientCertificateElementType',
                      type: {
                        name: 'Composite',
                        class_name: 'ApplicationGatewayTrustedClientCertificate'
                      }
                  }
                }
              },
              ...
              ssl_profiles: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.sslProfiles',
                type: {
                  name: 'Sequence',
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'ApplicationGatewaySslProfileElementType',
                      type: {
                        name: 'Composite',
              ...
              private_link_configurations: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.privateLinkConfigurations',
                type: {
                  name: 'Sequence',
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'ApplicationGatewayPrivateLinkConfigurationElementType',
                      type: {
                        name: 'Composite',
              ...
              private_endpoint_connections: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'ApplicationGatewayPrivateEndpointConnectionElementType',
                      type: {
                        name: 'Composite',
              ...
              force_firewall_policy_association: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.forceFirewallPolicyAssociation',
                type: {
                  name: 'Boolean'
                }
              },
