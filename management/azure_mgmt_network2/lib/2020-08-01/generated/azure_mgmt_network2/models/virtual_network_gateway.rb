...
module Azure::Network2::Mgmt::V2020_08_01
  module Models
    ...
    class VirtualNetworkGateway < Resource
      ...
      # gateway. Possible values include: 'Vpn', 'ExpressRoute', 'LocalGateway'
      ...
      # @return [Boolean] Whether private IP needs to be enabled on this
      # gateway for connections or not.
      attr_accessor :enable_private_ip_address

      # @return [Boolean] ActiveActive flag.
      attr_accessor :active_active

      # @return [SubResource] The reference to the LocalNetworkGateway resource
      ...
      # @return [VirtualNetworkGatewaySku] The reference to the
      # VirtualNetworkGatewaySku resource which represents the SKU selected for
      # Virtual network gateway.
      attr_accessor :sku

      # @return [VpnClientConfiguration] The reference to the
      ...
      # @return [String] MAS FIJI customer vnet resource id.
      # VirtualNetworkGateway of type local gateway is associated with the
      # customer vnet.
      attr_accessor :virtual_network_extended_location_resource_id

      # @return [ExtendedLocation] The extended location of type local virtual
      # network gateway.
          ...
          type: {
            ...
            model_properties: {
              ...
              enable_private_ip_address: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.enablePrivateIpAddress',
                type: {
                  name: 'Boolean'
                }
              },
              ...
              virtual_network_extended_location_resource_id: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.virtualNetworkExtendedLocationResourceId',
                type: {
                  name: 'String'
                }
              },
              extended_location: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.extendedLocation',
                type: {
                  name: 'Composite',
