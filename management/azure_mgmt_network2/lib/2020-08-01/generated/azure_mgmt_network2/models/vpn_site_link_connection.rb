...
module Azure::Network2::Mgmt::V2020_08_01
  module Models
    ...
    class VpnSiteLinkConnection < SubResource
      ...
      # @return [VpnLinkConnectionMode] Vpn link connection mode. Possible
      # values include: 'Default', 'ResponderOnly', 'InitiatorOnly'
      attr_accessor :vpn_link_connection_mode
      ...
      # @return [Array<SubResource>] List of ingress NatRules.
      attr_accessor :ingress_nat_rules

      # @return [Array<SubResource>] List of egress NatRules.
      attr_accessor :egress_nat_rules
          ...
          type: {
            ...
            model_properties: {
              ...
              vpn_link_connection_mode: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.vpnLinkConnectionMode',
                type: {
                  name: 'String'
                }
              },
              ...
              ingress_nat_rules: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.ingressNatRules',
                type: {
                  name: 'Sequence',
                  element: {
                      client_side_validation: true,
              ...
              egress_nat_rules: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.egressNatRules',
                type: {
                  name: 'Sequence',
                  element: {
                      client_side_validation: true,
