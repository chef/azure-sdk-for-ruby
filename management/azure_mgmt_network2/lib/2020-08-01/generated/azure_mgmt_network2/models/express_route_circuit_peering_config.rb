...
module Azure::Network2::Mgmt::V2020_08_01
  module Models
    ...
    class ExpressRouteCircuitPeeringConfig
      ...
      # @return [Array<String>] The reference to AdvertisedPublicPrefixes.
      ...
      # @return [ExpressRouteCircuitPeeringAdvertisedPublicPrefixState] The
      # advertised public prefix state of the Peering resource. Possible values
      # include: 'NotConfigured', 'Configuring', 'Configured',
      # 'ValidationNeeded'
