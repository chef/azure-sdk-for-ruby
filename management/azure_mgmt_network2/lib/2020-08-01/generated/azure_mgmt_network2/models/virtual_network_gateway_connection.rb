...
module Azure::Network2::Mgmt::V2020_08_01
  module Models
    ...
    class VirtualNetworkGatewayConnection < Resource
      ...
      # @return [Integer] The dead peer detection timeout of this connection in
      # seconds.
      attr_accessor :dpd_timeout_seconds

      # @return [VirtualNetworkGatewayConnectionMode] The connection mode for
      # this connection. Possible values include: 'Default', 'ResponderOnly',
      # 'InitiatorOnly'
      ...
      # @return [Boolean] Use private local Azure IP for the connection.
      ...
      # @return [Array<TrafficSelectorPolicy>] The Traffic Selector Policies to
      # be considered by this connection.
      attr_accessor :traffic_selector_policies
      ...
      # network gateway connection resource. Possible values include:
          ...
          type: {
            ...
            model_properties: {
              ...
              dpd_timeout_seconds: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.dpdTimeoutSeconds',
                type: {
                  name: 'Number'
                }
              },
              connection_mode: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.connectionMode',
                type: {
                  name: 'String'
                }
              },
              ...
              traffic_selector_policies: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.trafficSelectorPolicies',
                type: {
                  name: 'Sequence',
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'TrafficSelectorPolicyElementType',
                      type: {
                        name: 'Composite',
