...
module Azure::Network2::Mgmt::V2020_08_01
  module Models
    ...
    class VirtualNetwork < Resource
      ...
      # @return [ExtendedLocation] The extended location of the virtual
      # network.
      ...
      # network resource. Possible values include: 'Succeeded', 'Updating',
      # 'Deleting', 'Failed'
      ...
      # @return [VirtualNetworkBgpCommunities] Bgp Communities sent over
      # ExpressRoute with each route corresponding to a prefix in this VNET.
