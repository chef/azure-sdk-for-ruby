...
module Azure::Network2::Mgmt::V2020_08_01
  module Models
    ...
    class ExpressRouteCircuitPeering < SubResource
      ...
      # @return [ExpressRouteCircuitStats] The peering stats of express route
      # circuit.
      attr_accessor :stats
      ...
      # @return [SubResource] The reference to the RouteFilter resource.
      ...
      attr_accessor :express_route_connection

      # @return [Array<ExpressRouteCircuitConnection>] The list of circuit
