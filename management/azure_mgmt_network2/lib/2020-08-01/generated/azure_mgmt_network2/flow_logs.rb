...
module Azure::Network2::Mgmt::V2020_08_01
  ...
  class FlowLogs
    ...
    # @param flow_log_name [String] The name of the flow log.
    # @param parameters [FlowLog] Parameters that define the create or update flow
    # log resource.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [FlowLog] operation results.
    #
    ...
    def create_or_update_async(resource_group_name, network_watcher_name, flow_log_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network2::Mgmt::V2020_08_01::Models::FlowLog.mapper()
    ...
    # @param network_watcher_name [String] The name of the network watcher.
    # @param flow_log_name [String] The name of the flow log.
    # @param parameters [TagsObject] Parameters supplied to update flow log tags.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [FlowLog] operation results.
    ...
    # @param resource_group_name [String] The name of the resource group.
    # @param network_watcher_name [String] The name of the network watcher.
    # @param flow_log_name [String] The name of the flow log resource.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [FlowLog] operation results.
    ...
    # will be added to the HTTP request.
    #
    # @return [Array<FlowLog>] operation results.
    #
    ...
    def list_async(resource_group_name, network_watcher_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network2::Mgmt::V2020_08_01::Models::FlowLogListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, network_watcher_name, flow_log_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_08_01::Models::FlowLog.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    # will be added to the HTTP request.
    #
    # @return [FlowLogListResult] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [FlowLogListResult] which provide lazy access to pages of the
    # response.
    #
