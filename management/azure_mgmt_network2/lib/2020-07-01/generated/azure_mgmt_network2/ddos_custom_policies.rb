...
module Azure::Network2::Mgmt::V2020_07_01
  ...
  class DdosCustomPolicies
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2020_07_01::Models::DdosCustomPolicy.mapper()
    ...
    # @param resource_group_name [String] The name of the resource group.
    # @param ddos_custom_policy_name [String] The name of the DDoS custom policy.
    # @param parameters [TagsObject] Parameters supplied to update DDoS custom
    ...
    # @return [MsRestAzure2::AzureOperationResponse] HTTP response information.
    #
    def update_tags_with_http_info(resource_group_name, ddos_custom_policy_name, parameters, custom_headers:nil)
      update_tags_async(resource_group_name, ddos_custom_policy_name, parameters, custom_headers:custom_headers).value!
    end
    ...
    def begin_create_or_update_async(resource_group_name, ddos_custom_policy_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_07_01::Models::DdosCustomPolicy.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
