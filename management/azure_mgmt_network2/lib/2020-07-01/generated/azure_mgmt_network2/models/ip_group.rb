...
module Azure::Network2::Mgmt::V2020_07_01
  module Models
    ...
    class IpGroup < Resource
      ...
      # @return [Array<SubResource>] List of references to Firewall resources
      # that this IpGroups is associated with.
      attr_accessor :firewalls

      # @return [Array<SubResource>] List of references to Firewall Policies
      # resources that this IpGroups is associated with.
          ...
          type: {
            ...
            model_properties: {
              ...
              firewall_policies: {
                ...
                required: false,
                read_only: true,
                serialized_name: 'properties.firewallPolicies',
                type: {
                  name: 'Sequence',
                  element: {
                      client_side_validation: true,
