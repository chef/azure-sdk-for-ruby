...
module Azure::Network2::Mgmt::V2020_07_01
  ...
  class NetworkInterfaces
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2020_07_01::Models::NetworkInterface.mapper()
    ...
    # @return [NetworkInterface] operation results.
    #
    def update_tags(resource_group_name, network_interface_name, parameters, custom_headers:nil)
      response = update_tags_async(resource_group_name, network_interface_name, parameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure2::AzureOperationResponse] HTTP response information.
    #
    def update_tags_with_http_info(resource_group_name, network_interface_name, parameters, custom_headers:nil)
      update_tags_async(resource_group_name, network_interface_name, parameters, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def update_tags_async(resource_group_name, network_interface_name, parameters, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'network_interface_name is nil' if network_interface_name.nil?
    ...
    def list_all_async(custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network2::Mgmt::V2020_07_01::Models::NetworkInterfaceListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_effective_route_table_async(resource_group_name, network_interface_name, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network2::Mgmt::V2020_07_01::Models::EffectiveRouteListResult.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def list_effective_network_security_groups_async(resource_group_name, network_interface_name, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network2::Mgmt::V2020_07_01::Models::EffectiveNetworkSecurityGroupListResult.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    # @return [Array<NetworkInterface>] operation results.
    #
    def list_cloud_service_role_instance_network_interfaces(resource_group_name, cloud_service_name, role_instance_name, custom_headers:nil)
      first_page = list_cloud_service_role_instance_network_interfaces_as_lazy(resource_group_name, cloud_service_name, role_instance_name, custom_headers:custom_headers)
      first_page.get_all_items
    end
    ...
    # @return [MsRestAzure2::AzureOperationResponse] HTTP response information.
    #
    def list_cloud_service_role_instance_network_interfaces_with_http_info(resource_group_name, cloud_service_name, role_instance_name, custom_headers:nil)
      list_cloud_service_role_instance_network_interfaces_async(resource_group_name, cloud_service_name, role_instance_name, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def list_cloud_service_role_instance_network_interfaces_async(resource_group_name, cloud_service_name, role_instance_name, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/cloudServices/{cloudServiceName}/roleInstances/{roleInstanceName}/networkInterfaces'

      request_url = @base_url || @client.base_url

      options = {
          middlewares: [[MsRest2::RetryPolicyMiddleware, times: 3, retry: 0.02], [:cookie_jar]],
          path_params: {'resourceGroupName' => resource_group_name,'cloudServiceName' => cloud_service_name,'roleInstanceName' => role_instance_name,'subscriptionId' => @client.subscription_id},
          query_params: {'api-version' => @client.api_version},
          headers: request_headers.merge(custom_headers || {}),
          base_url: request_url
      }
    ...
    # @return [Array<NetworkInterface>] operation results.
    #
    def list_cloud_service_network_interfaces(resource_group_name, cloud_service_name, custom_headers:nil)
      first_page = list_cloud_service_network_interfaces_as_lazy(resource_group_name, cloud_service_name, custom_headers:custom_headers)
      first_page.get_all_items
    end
    ...
    # @return [MsRestAzure2::AzureOperationResponse] HTTP response information.
    #
    def list_cloud_service_network_interfaces_with_http_info(resource_group_name, cloud_service_name, custom_headers:nil)
      list_cloud_service_network_interfaces_async(resource_group_name, cloud_service_name, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def list_cloud_service_network_interfaces_async(resource_group_name, cloud_service_name, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'cloud_service_name is nil' if cloud_service_name.nil?
      @client.api_version = '2017-03-30'
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/cloudServices/{cloudServiceName}/networkInterfaces'
    ...
    # @return [NetworkInterface] operation results.
    #
    def get_cloud_service_network_interface(resource_group_name, cloud_service_name, role_instance_name, network_interface_name, expand:nil, custom_headers:nil)
      response = get_cloud_service_network_interface_async(resource_group_name, cloud_service_name, role_instance_name, network_interface_name, expand:expand, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure2::AzureOperationResponse] HTTP response information.
    #
    def get_cloud_service_network_interface_with_http_info(resource_group_name, cloud_service_name, role_instance_name, network_interface_name, expand:nil, custom_headers:nil)
      get_cloud_service_network_interface_async(resource_group_name, cloud_service_name, role_instance_name, network_interface_name, expand:expand, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_cloud_service_network_interface_async(resource_group_name, cloud_service_name, role_instance_name, network_interface_name, expand:nil, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'cloud_service_name is nil' if cloud_service_name.nil?
      fail ArgumentError, 'role_instance_name is nil' if role_instance_name.nil?
      fail ArgumentError, 'network_interface_name is nil' if network_interface_name.nil?
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/cloudServices/{cloudServiceName}/roleInstances/{roleInstanceName}/networkInterfaces/{networkInterfaceName}'

      request_url = @base_url || @client.base_url

      options = {
          middlewares: [[MsRest2::RetryPolicyMiddleware, times: 3, retry: 0.02], [:cookie_jar]],
          path_params: {'resourceGroupName' => resource_group_name,'cloudServiceName' => cloud_service_name,'roleInstanceName' => role_instance_name,'networkInterfaceName' => network_interface_name,'subscriptionId' => @client.subscription_id},
          query_params: {'api-version' => @client.api_version,'$expand' => expand},
          headers: request_headers.merge(custom_headers || {}),
          base_url: request_url
      }
    ...
    def begin_create_or_update_async(resource_group_name, network_interface_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_07_01::Models::NetworkInterface.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    # @return [NetworkInterfaceListResult] operation results.
    #
    def list_cloud_service_role_instance_network_interfaces_next(next_page_link, custom_headers:nil)
      response = list_cloud_service_role_instance_network_interfaces_next_async(next_page_link, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure2::AzureOperationResponse] HTTP response information.
    #
    def list_cloud_service_role_instance_network_interfaces_next_with_http_info(next_page_link, custom_headers:nil)
      list_cloud_service_role_instance_network_interfaces_next_async(next_page_link, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def list_cloud_service_role_instance_network_interfaces_next_async(next_page_link, custom_headers:nil)
      fail ArgumentError, 'next_page_link is nil' if next_page_link.nil?
    ...
    # @return [NetworkInterfaceListResult] operation results.
    #
    def list_cloud_service_network_interfaces_next(next_page_link, custom_headers:nil)
      response = list_cloud_service_network_interfaces_next_async(next_page_link, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure2::AzureOperationResponse] HTTP response information.
    #
    def list_cloud_service_network_interfaces_next_with_http_info(next_page_link, custom_headers:nil)
      list_cloud_service_network_interfaces_next_async(next_page_link, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def list_cloud_service_network_interfaces_next_async(next_page_link, custom_headers:nil)
      fail ArgumentError, 'next_page_link is nil' if next_page_link.nil?
    ...
    # the response.
    #
    def list_cloud_service_role_instance_network_interfaces_as_lazy(resource_group_name, cloud_service_name, role_instance_name, custom_headers:nil)
      response = list_cloud_service_role_instance_network_interfaces_async(resource_group_name, cloud_service_name, role_instance_name, custom_headers:custom_headers).value!
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
          list_cloud_service_role_instance_network_interfaces_next_async(next_page_link, custom_headers:custom_headers)
        end
        page
      end
    end
    ...
    # the response.
    #
    def list_cloud_service_network_interfaces_as_lazy(resource_group_name, cloud_service_name, custom_headers:nil)
      response = list_cloud_service_network_interfaces_async(resource_group_name, cloud_service_name, custom_headers:custom_headers).value!
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
          list_cloud_service_network_interfaces_next_async(next_page_link, custom_headers:custom_headers)
        end
        page
      end
    end
