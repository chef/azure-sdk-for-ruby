...
module Azure::Network2::Mgmt::V2015_05_01_preview
  ...
  class RouteTables
    ...
    #
    # The Get RouteTables operation retrieves information about the specified route
    # table.
    #
    # @param resource_group_name [String] The name of the resource group.
    # @param route_table_name [String] The name of the route table.
    ...
    #
    def get(resource_group_name, route_table_name, custom_headers:nil)
      response = get_async(resource_group_name, route_table_name, custom_headers:custom_headers).value!
    ...
    #
    def get_with_http_info(resource_group_name, route_table_name, custom_headers:nil)
      get_async(resource_group_name, route_table_name, custom_headers:custom_headers).value!
    end
    ...
    #
    def get_async(resource_group_name, route_table_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2015_05_01_preview::Models::RouteTable.mapper()
    ...
    # @param resource_group_name [String] The name of the resource group.
    # @param route_table_name [String] The name of the route table.
    # @param parameters [RouteTable] Parameters supplied to the create/update Route
    # Table operation
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    ...
    def list_async(resource_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network2::Mgmt::V2015_05_01_preview::Models::RouteTableListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, route_table_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2015_05_01_preview::Models::RouteTable.mapper()
