...
module Azure::Network2::Mgmt::V2015_05_01_preview
  ...
  class PublicIpAddresses
    ...
    def get(resource_group_name, public_ip_address_name, custom_headers:nil)
      response = get_async(resource_group_name, public_ip_address_name, custom_headers:custom_headers).value!
    ...
    #
    def get_with_http_info(resource_group_name, public_ip_address_name, custom_headers:nil)
      get_async(resource_group_name, public_ip_address_name, custom_headers:custom_headers).value!
    end
    ...
    #
    def get_async(resource_group_name, public_ip_address_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2015_05_01_preview::Models::PublicIpAddress.mapper()
    ...
    def list_all_async(custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network2::Mgmt::V2015_05_01_preview::Models::PublicIpAddressListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, public_ip_address_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2015_05_01_preview::Models::PublicIpAddress.mapper()
