...
module Azure::Network2::Mgmt::V2020_05_01
  ...
  class NetworkWatchers
    ...
    def create_or_update_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::NetworkWatcher.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::NetworkWatcher.mapper()
    ...
    def list_async(resource_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::NetworkWatcherListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_topology_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::TopologyParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::Topology.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def verify_ipflow_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::VerificationIPFlowResult.mapper()
    ...
    def get_next_hop_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::NextHopResult.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def get_vmsecurity_rules_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::SecurityGroupViewResult.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def get_troubleshooting_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::TroubleshootingResult.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def set_flow_log_configuration_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::FlowLogInformation.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def check_connectivity_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::ConnectivityInformation.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def get_azure_reachability_report_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::AzureReachabilityReport.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def list_available_providers_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::AvailableProvidersList.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def get_network_configuration_diagnostic_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::NetworkConfigurationDiagnosticResponse.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def begin_verify_ipflow_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::VerificationIPFlowParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_get_next_hop_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::NextHopParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_get_vmsecurity_rules_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::SecurityGroupViewParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_get_troubleshooting_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::TroubleshootingParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_get_troubleshooting_result_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::QueryTroubleshootingParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_set_flow_log_configuration_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::FlowLogInformation.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_get_flow_log_status_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::FlowLogStatusParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_check_connectivity_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::ConnectivityParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_get_azure_reachability_report_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::AzureReachabilityReportParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_list_available_providers_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::AvailableProvidersListParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_get_network_configuration_diagnostic_async(resource_group_name, network_watcher_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_05_01::Models::NetworkConfigurationDiagnosticParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
