...
module Azure::Network2::Mgmt::V2020_04_01
  ...
  class DdosCustomPolicies
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2020_04_01::Models::DdosCustomPolicy.mapper()
    ...
    def begin_create_or_update_async(resource_group_name, ddos_custom_policy_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_04_01::Models::DdosCustomPolicy.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
