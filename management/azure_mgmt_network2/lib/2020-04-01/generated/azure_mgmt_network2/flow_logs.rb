...
module Azure::Network2::Mgmt::V2020_04_01
  ...
  class FlowLogs
    ...
    def create_or_update_async(resource_group_name, network_watcher_name, flow_log_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Network2::Mgmt::V2020_04_01::Models::FlowLog.mapper()
    ...
    def list_async(resource_group_name, network_watcher_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network2::Mgmt::V2020_04_01::Models::FlowLogListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, network_watcher_name, flow_log_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2020_04_01::Models::FlowLog.mapper()
