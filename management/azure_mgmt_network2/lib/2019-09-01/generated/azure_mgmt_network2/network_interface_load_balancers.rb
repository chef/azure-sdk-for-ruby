...
module Azure::Network2::Mgmt::V2019_09_01
  ...
  class NetworkInterfaceLoadBalancers
    ...
    #
    # Creates and initializes a new instance of the NetworkInterfaceLoadBalancers class.
    ...
    def list_async(resource_group_name, network_interface_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkInterfaces/{networkInterfaceName}/loadBalancers'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2019_09_01::Models::NetworkInterfaceLoadBalancerListResult.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [NetworkInterfaceLoadBalancerListResult] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [NetworkInterfaceLoadBalancerListResult] which provide lazy access to
