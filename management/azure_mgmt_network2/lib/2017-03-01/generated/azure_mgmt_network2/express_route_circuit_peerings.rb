...
module Azure::Network2::Mgmt::V2017_03_01
  ...
  class ExpressRouteCircuitPeerings
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Network2::Mgmt::V2017_03_01::Models::ExpressRouteCircuitPeering.mapper()
    ...
    def list_async(resource_group_name, circuit_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Network2::Mgmt::V2017_03_01::Models::ExpressRouteCircuitPeeringListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, circuit_name, peering_name, peering_parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Network2::Mgmt::V2017_03_01::Models::ExpressRouteCircuitPeering.mapper()
