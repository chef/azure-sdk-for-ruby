...
module Azure::MachineLearningServices::Mgmt::V2018_03_01_preview
  ...
  #
  class MachineLearningServicesClient < MsRestAzure::AzureServiceClient
    include MsRestAzure
    ...
    # @return [String] Azure subscription identifier.
    attr_accessor :subscription_id

    # @return [String] Version of Azure Machine Learning resource provider API.
    ...
    # @return [MachineLearningCompute] machine_learning_compute
    attr_reader :machine_learning_compute

    #
    # Creates initializes a new instance of the MachineLearningServicesClient class.
    ...
    def initialize(credentials = nil, base_url = nil, options = nil)
      ...
      @machine_learning_compute = MachineLearningCompute.new(self)
