...
module Azure::MachineLearningServices::Mgmt::V2018_11_19
  module Models
    ...
    class PaginatedComputeResourcesList
      ...
      #
      # @return [PaginatedComputeResourcesList] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for PaginatedComputeResourcesList class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'PaginatedComputeResourcesList',
          type: {
            name: 'Composite',
            class_name: 'PaginatedComputeResourcesList',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'ComputeResourceElementType',
                      type: {
                        name: 'Composite',
