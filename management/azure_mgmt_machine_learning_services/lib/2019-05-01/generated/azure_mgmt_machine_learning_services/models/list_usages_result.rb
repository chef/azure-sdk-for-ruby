...
module Azure::MachineLearningServices::Mgmt::V2019_05_01
  module Models
    ...
    class ListUsagesResult
      ...
      # @return [Array<Usage>] The list of AML resource usages.
      attr_accessor :value

      # @return [String] The URI to fetch the next page of AML resource usage
      # information. Call ListNext() with this to fetch the next page of AML
