...
module Azure::MachineLearningServices::Mgmt::V2019_05_01
  ...
  class Workspaces
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::MachineLearningServices::Mgmt::V2019_05_01::Models::Workspace.mapper()
    ...
    def create_or_update_async(resource_group_name, workspace_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::MachineLearningServices::Mgmt::V2019_05_01::Models::Workspace.mapper()
    ...
    def update_async(resource_group_name, workspace_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::MachineLearningServices::Mgmt::V2019_05_01::Models::WorkspaceUpdateParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def list_by_resource_group_async(resource_group_name, skiptoken:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::MachineLearningServices::Mgmt::V2019_05_01::Models::WorkspaceListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_keys_async(resource_group_name, workspace_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::MachineLearningServices::Mgmt::V2019_05_01::Models::ListWorkspaceKeysResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
