...
module Azure::StorageSync::Mgmt::V2019_06_01
  ...
  class RegisteredServers
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::StorageSync::Mgmt::V2019_06_01::Models::RegisteredServerArray.mapper()
    ...
    def get_async(resource_group_name, storage_sync_service_name, server_id, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::StorageSync::Mgmt::V2019_06_01::Models::RegisteredServer.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_async(resource_group_name, storage_sync_service_name, server_id, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::StorageSync::Mgmt::V2019_06_01::Models::RegisteredServerCreateParameters.mapper()
    ...
    def begin_trigger_rollover_async(resource_group_name, storage_sync_service_name, server_id, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::StorageSync::Mgmt::V2019_06_01::Models::TriggerRolloverRequest.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
