...
module Azure::StorageSync::Mgmt::V2018_04_02
  ...
  class StorageSyncServices
    ...
    def check_name_availability_async(location_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::StorageSync::Mgmt::V2018_04_02::Models::CheckNameAvailabilityParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::StorageSync::Mgmt::V2018_04_02::Models::CheckNameAvailabilityResult.mapper()
    ...
    def create_async(resource_group_name, storage_sync_service_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::StorageSync::Mgmt::V2018_04_02::Models::StorageSyncServiceCreateParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::StorageSync::Mgmt::V2018_04_02::Models::StorageSyncService.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def update_async(resource_group_name, storage_sync_service_name, parameters:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::StorageSync::Mgmt::V2018_04_02::Models::StorageSyncServiceUpdateParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::StorageSync::Mgmt::V2018_04_02::Models::StorageSyncServiceArray.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
