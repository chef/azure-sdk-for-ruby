...
module Azure::StorageSync::Mgmt::V2018_07_01
  ...
  class SyncGroups
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::StorageSync::Mgmt::V2018_07_01::Models::SyncGroupArray.mapper()
    ...
    def create_async(resource_group_name, storage_sync_service_name, sync_group_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::StorageSync::Mgmt::V2018_07_01::Models::SyncGroupCreateParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::StorageSync::Mgmt::V2018_07_01::Models::SyncGroup.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
