...
module Azure::ApiManagement::Mgmt::V2019_01_01
  module Models
    ...
    class ProductCollection
      ...
      # @return [Array<ProductContract>] Page values.
      attr_accessor :value
      ...
      #
      # @return [ProductCollection] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for ProductCollection class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ProductCollection',
          type: {
            name: 'Composite',
              ...
              value: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'ProductContractElementType',
                      type: {
                        name: 'Composite',
