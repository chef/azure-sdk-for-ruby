...
module Azure::ApiManagement::Mgmt::V2019_01_01
  ...
  class ApiTagDescription
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2019_01_01::Models::TagDescriptionCollection.mapper()
    ...
    #
    #
    def get_entity_tag(resource_group_name, service_name, api_id, tag_id, custom_headers:nil)
      response = get_entity_tag_async(resource_group_name, service_name, api_id, tag_id, custom_headers:custom_headers).value!
      nil
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def get_entity_tag_with_http_info(resource_group_name, service_name, api_id, tag_id, custom_headers:nil)
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_entity_tag_async(resource_group_name, service_name, api_id, tag_id, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'service_name is nil' if service_name.nil?
      fail ArgumentError, "'service_name' should satisfy the constraint - 'MaxLength': '50'" if !service_name.nil? && service_name.length > 50
      fail ArgumentError, "'service_name' should satisfy the constraint - 'MinLength': '1'" if !service_name.nil? && service_name.length < 1
    ...
    def get(resource_group_name, service_name, api_id, tag_id, custom_headers:nil)
      response = get_async(resource_group_name, service_name, api_id, tag_id, custom_headers:custom_headers).value!
    ...
    def get_with_http_info(resource_group_name, service_name, api_id, tag_id, custom_headers:nil)
      get_async(resource_group_name, service_name, api_id, tag_id, custom_headers:custom_headers).value!
    end
    ...
    def get_async(resource_group_name, service_name, api_id, tag_id, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2019_01_01::Models::TagDescriptionContract.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update(resource_group_name, service_name, api_id, tag_id, parameters, if_match:nil, custom_headers:nil)
      response = create_or_update_async(resource_group_name, service_name, api_id, tag_id, parameters, if_match:if_match, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_with_http_info(resource_group_name, service_name, api_id, tag_id, parameters, if_match:nil, custom_headers:nil)
      create_or_update_async(resource_group_name, service_name, api_id, tag_id, parameters, if_match:if_match, custom_headers:custom_headers).value!
    end
    ...
    def create_or_update_async(resource_group_name, service_name, api_id, tag_id, parameters, if_match:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2019_01_01::Models::TagDescriptionCreateParameters.mapper()
    ...
    def delete(resource_group_name, service_name, api_id, tag_id, if_match, custom_headers:nil)
      response = delete_async(resource_group_name, service_name, api_id, tag_id, if_match, custom_headers:custom_headers).value!
      nil
    end
    ...
    def delete_with_http_info(resource_group_name, service_name, api_id, tag_id, if_match, custom_headers:nil)
      delete_async(resource_group_name, service_name, api_id, tag_id, if_match, custom_headers:custom_headers).value!
    end
