...
module Azure::ApiManagement::Mgmt::V2018_06_01_preview
  module Models
    ...
    class TagResourceCollection
      ...
      #
      # @return [TagResourceCollection] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for TagResourceCollection class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'TagResourceCollection',
          type: {
            name: 'Composite',
            class_name: 'TagResourceCollection',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'TagResourceContractElementType',
                      type: {
                        name: 'Composite',
