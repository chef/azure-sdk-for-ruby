...
module Azure::ApiManagement::Mgmt::V2018_06_01_preview
  ...
  #
  class PolicySnippets
    include MsRestAzure

    #
    # Creates and initializes a new instance of the PolicySnippets class.
    ...
    #
    # @return [PolicySnippetsCollection] operation results.
    #
    ...
    def list_by_service_async(resource_group_name, service_name, scope:nil, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/policySnippets'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2018_06_01_preview::Models::PolicySnippetsCollection.mapper()
