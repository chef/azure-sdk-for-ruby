...
module Azure::ApiManagement::Mgmt::V2018_06_01_preview
  ...
  class QuotaByCounterKeys
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2018_06_01_preview::Models::QuotaCounterCollection.mapper()
    ...
    def update_async(resource_group_name, service_name, quota_counter_key, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2018_06_01_preview::Models::QuotaCounterValueContractProperties.mapper()
