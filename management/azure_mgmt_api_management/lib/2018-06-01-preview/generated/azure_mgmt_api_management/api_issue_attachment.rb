...
module Azure::ApiManagement::Mgmt::V2018_06_01_preview
  ...
  class ApiIssueAttachment
    ...
    def list_by_service(resource_group_name, service_name, api_id, issue_id, filter:nil, top:nil, skip:nil, custom_headers:nil)
      first_page = list_by_service_as_lazy(resource_group_name, service_name, api_id, issue_id, filter:filter, top:top, skip:skip, custom_headers:custom_headers)
    ...
    def list_by_service_with_http_info(resource_group_name, service_name, api_id, issue_id, filter:nil, top:nil, skip:nil, custom_headers:nil)
      list_by_service_async(resource_group_name, service_name, api_id, issue_id, filter:filter, top:top, skip:skip, custom_headers:custom_headers).value!
    end
    ...
    def list_by_service_async(resource_group_name, service_name, api_id, issue_id, filter:nil, top:nil, skip:nil, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/issues/{issueId}/attachments'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2018_06_01_preview::Models::IssueAttachmentCollection.mapper()
    ...
    #
    #
    def get_entity_tag(resource_group_name, service_name, api_id, issue_id, attachment_id, custom_headers:nil)
      response = get_entity_tag_async(resource_group_name, service_name, api_id, issue_id, attachment_id, custom_headers:custom_headers).value!
      nil
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def get_entity_tag_with_http_info(resource_group_name, service_name, api_id, issue_id, attachment_id, custom_headers:nil)
      get_entity_tag_async(resource_group_name, service_name, api_id, issue_id, attachment_id, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_entity_tag_async(resource_group_name, service_name, api_id, issue_id, attachment_id, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'service_name is nil' if service_name.nil?
      fail ArgumentError, "'service_name' should satisfy the constraint - 'MaxLength': '50'" if !service_name.nil? && service_name.length > 50
      fail ArgumentError, "'service_name' should satisfy the constraint - 'MinLength': '1'" if !service_name.nil? && service_name.length < 1
    ...
    # will be added to the HTTP request.
    #
    # @return [IssueAttachmentContract] operation results.
    #
    ...
    def get_async(resource_group_name, service_name, api_id, issue_id, attachment_id, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2018_06_01_preview::Models::IssueAttachmentContract.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # @param attachment_id [String] Attachment identifier within an Issue. Must be
    # unique in the current Issue.
    # @param parameters [IssueAttachmentContract] Create parameters.
    ...
    def create_or_update_async(resource_group_name, service_name, api_id, issue_id, attachment_id, parameters, if_match:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2018_06_01_preview::Models::IssueAttachmentContract.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [IssueAttachmentCollection] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [IssueAttachmentCollection] which provide lazy access to pages of the
    # response.
    #
    def list_by_service_as_lazy(resource_group_name, service_name, api_id, issue_id, filter:nil, top:nil, skip:nil, custom_headers:nil)
      response = list_by_service_async(resource_group_name, service_name, api_id, issue_id, filter:filter, top:top, skip:skip, custom_headers:custom_headers).value!
      unless response.nil?
        page = response.body
