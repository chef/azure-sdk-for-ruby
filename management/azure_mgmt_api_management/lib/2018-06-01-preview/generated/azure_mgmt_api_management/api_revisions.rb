...
module Azure::ApiManagement::Mgmt::V2018_06_01_preview
  ...
  class ApiRevisions
    ...
    #
    # Creates and initializes a new instance of the ApiRevisions class.
    ...
    def list_async(resource_group_name, service_name, api_id, filter:nil, top:nil, skip:nil, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/revisions'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2018_06_01_preview::Models::ApiRevisionCollection.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [ApiRevisionCollection] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [ApiRevisionCollection] which provide lazy access to pages of the
    # response.
    #
