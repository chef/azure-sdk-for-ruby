...
module Azure::ApiManagement::Mgmt::V2018_06_01_preview
  ...
  class TagDescription
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2018_06_01_preview::Models::TagDescriptionCollection.mapper()
    ...
    def get_entity_state(resource_group_name, service_name, api_id, tag_id, custom_headers:nil)
      response = get_entity_state_async(resource_group_name, service_name, api_id, tag_id, custom_headers:custom_headers).value!
      nil
    end
    ...
    def get_entity_state_with_http_info(resource_group_name, service_name, api_id, tag_id, custom_headers:nil)
      get_entity_state_async(resource_group_name, service_name, api_id, tag_id, custom_headers:custom_headers).value!
    end
    ...
    def get_async(resource_group_name, service_name, api_id, tag_id, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2018_06_01_preview::Models::TagDescriptionContract.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, service_name, api_id, tag_id, parameters, if_match:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2018_06_01_preview::Models::TagDescriptionCreateParameters.mapper()
