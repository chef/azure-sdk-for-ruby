...
module Azure::ApiManagement::Mgmt::V2018_06_01_preview
  ...
  class UserIdentities
    ...
    #
    def list(resource_group_name, service_name, user_id, custom_headers:nil)
    ...
    #
    def list_with_http_info(resource_group_name, service_name, user_id, custom_headers:nil)
    ...
    #
    def list_async(resource_group_name, service_name, user_id, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{userId}/identities'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2018_06_01_preview::Models::UserIdentityCollection.mapper()
    ...
    # response.
    #
    def list_as_lazy(resource_group_name, service_name, user_id, custom_headers:nil)
      response = list_async(resource_group_name, service_name, user_id, custom_headers:custom_headers).value!
      unless response.nil?
        page = response.body
