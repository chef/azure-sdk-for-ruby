...
module Azure::ApiManagement::Mgmt::V2018_06_01_preview
  ...
  class Notification
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2018_06_01_preview::Models::NotificationCollection.mapper()
    ...
    def get_async(resource_group_name, service_name, notification_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2018_06_01_preview::Models::NotificationContract.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update(resource_group_name, service_name, notification_name, if_match:nil, custom_headers:nil)
      response = create_or_update_async(resource_group_name, service_name, notification_name, if_match:if_match, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_with_http_info(resource_group_name, service_name, notification_name, if_match:nil, custom_headers:nil)
      create_or_update_async(resource_group_name, service_name, notification_name, if_match:if_match, custom_headers:custom_headers).value!
    end
