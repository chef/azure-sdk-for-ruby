...
module Azure::ApiManagement::Mgmt::V2018_06_01_preview
  ...
  class ApiRelease
    ...
    # |-------------|------------------------|-----------------------------------|
    #
    # |notes | ge, le, eq, ne, gt, lt | substringof, contains, startswith,
    # endswith|
    #
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2018_06_01_preview::Models::ApiReleaseCollection.mapper()
    ...
    def get_entity_tag_async(resource_group_name, service_name, api_id, release_id, custom_headers:nil)
      ...
      options = {
          middlewares: [[MsRest2::RetryPolicyMiddleware, times: 3, retry: 0.02], [:cookie_jar]],
          path_params: {'resourceGroupName' => resource_group_name,'serviceName' => service_name,'apiId' => api_id,'releaseId' => release_id,'subscriptionId' => @client.subscription_id},
    ...
    def get_async(resource_group_name, service_name, api_id, release_id, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2018_06_01_preview::Models::ApiReleaseContract.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # @return [ApiReleaseContract] operation results.
    #
    def create(resource_group_name, service_name, api_id, release_id, parameters, if_match:nil, custom_headers:nil)
      response = create_async(resource_group_name, service_name, api_id, release_id, parameters, if_match:if_match, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def create_with_http_info(resource_group_name, service_name, api_id, release_id, parameters, if_match:nil, custom_headers:nil)
      create_async(resource_group_name, service_name, api_id, release_id, parameters, if_match:if_match, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def create_async(resource_group_name, service_name, api_id, release_id, parameters, if_match:nil, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'service_name is nil' if service_name.nil?
      fail ArgumentError, "'service_name' should satisfy the constraint - 'MaxLength': '50'" if !service_name.nil? && service_name.length > 50
      fail ArgumentError, "'service_name' should satisfy the constraint - 'MinLength': '1'" if !service_name.nil? && service_name.length < 1
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2018_06_01_preview::Models::ApiReleaseContract.mapper()
