...
module Azure::ApiManagement::Mgmt::V2018_06_01_preview
  ...
  class NotificationRecipientEmail
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2018_06_01_preview::Models::RecipientEmailCollection.mapper()
    ...
    def check_entity_exists(resource_group_name, service_name, notification_name, email, custom_headers:nil)
      response = check_entity_exists_async(resource_group_name, service_name, notification_name, email, custom_headers:custom_headers).value!
      nil
    end
    ...
    def create_or_update_async(resource_group_name, service_name, notification_name, email, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 201
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2018_06_01_preview::Models::RecipientEmailContract.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
