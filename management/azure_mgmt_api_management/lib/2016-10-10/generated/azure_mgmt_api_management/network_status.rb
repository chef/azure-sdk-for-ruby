...
module Azure::ApiManagement::Mgmt::V2016_10_10
  ...
  class NetworkStatus
    ...
    #
    def get_by_service(resource_group_name, service_name, custom_headers:nil)
    ...
    #
    def get_by_service_with_http_info(resource_group_name, service_name, custom_headers:nil)
      get_by_service_async(resource_group_name, service_name, custom_headers:custom_headers).value!
    end
    ...
    #
    def get_by_service_async(resource_group_name, service_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2016_10_10::Models::NetworkStatusContract.mapper()
