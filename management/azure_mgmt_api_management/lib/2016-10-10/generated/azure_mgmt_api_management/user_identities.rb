...
module Azure::ApiManagement::Mgmt::V2016_10_10
  ...
  class UserIdentities
    ...
    #
    def list_by_users(resource_group_name, service_name, uid, custom_headers:nil)
    ...
    #
    def list_by_users_with_http_info(resource_group_name, service_name, uid, custom_headers:nil)
    ...
    #
    def list_by_users_async(resource_group_name, service_name, uid, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2016_10_10::Models::UserIdentityCollection.mapper()
