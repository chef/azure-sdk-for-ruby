...
module Azure::ApiManagement::Mgmt::V2016_10_10
  ...
  class AuthorizationServers
    ...
    #
    # @return [Array<OAuth2AuthorizationServerContract>] operation results.
    #
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2016_10_10::Models::AuthorizationServerCollection.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [OAuth2AuthorizationServerContract] operation results.
    #
    ...
    def get_async(resource_group_name, service_name, authsid, custom_headers:nil)
      ...
      fail ArgumentError, "'authsid' should satisfy the constraint - 'MaxLength': '256'" if !authsid.nil? && authsid.length > 256
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2016_10_10::Models::OAuth2AuthorizationServerContract.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # @param service_name [String] The name of the API Management service.
    # @param authsid [String] Identifier of the authorization server.
    # @param parameters [OAuth2AuthorizationServerContract] Create or update
    # parameters.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    #
    def create_or_update(resource_group_name, service_name, authsid, parameters, custom_headers:nil)
      response = create_or_update_async(resource_group_name, service_name, authsid, parameters, custom_headers:custom_headers).value!
      nil
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def create_or_update_with_http_info(resource_group_name, service_name, authsid, parameters, custom_headers:nil)
      create_or_update_async(resource_group_name, service_name, authsid, parameters, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def create_or_update_async(resource_group_name, service_name, authsid, parameters, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'service_name is nil' if service_name.nil?
      fail ArgumentError, "'service_name' should satisfy the constraint - 'MaxLength': '50'" if !service_name.nil? && service_name.length > 50
      fail ArgumentError, "'service_name' should satisfy the constraint - 'MinLength': '1'" if !service_name.nil? && service_name.length < 1
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2016_10_10::Models::OAuth2AuthorizationServerContract.mapper()
    ...
    # @param service_name [String] The name of the API Management service.
    # @param authsid [String] Identifier of the authorization server.
    # @param parameters [OAuth2AuthorizationServerUpdateContract] OAuth2 Server
    # settings Update parameters.
    # @param if_match [String] The entity state (Etag) version of the authorization
    ...
    def update_async(resource_group_name, service_name, authsid, parameters, if_match, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2016_10_10::Models::OAuth2AuthorizationServerUpdateContract.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    # @param service_name [String] The name of the API Management service.
    # @param authsid [String] Identifier of the authorization server.
    # @param if_match [String] The entity state (Etag) version of the
