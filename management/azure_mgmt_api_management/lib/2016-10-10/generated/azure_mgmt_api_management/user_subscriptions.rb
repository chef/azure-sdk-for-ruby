...
module Azure::ApiManagement::Mgmt::V2016_10_10
  ...
  class UserSubscriptions
    ...
    #
    # Creates and initializes a new instance of the UserSubscriptions class.
    ...
    #
    def list_by_users(resource_group_name, service_name, uid, filter:nil, top:nil, skip:nil, custom_headers:nil)
      first_page = list_by_users_as_lazy(resource_group_name, service_name, uid, filter:filter, top:top, skip:skip, custom_headers:custom_headers)
    ...
    #
    def list_by_users_with_http_info(resource_group_name, service_name, uid, filter:nil, top:nil, skip:nil, custom_headers:nil)
      list_by_users_async(resource_group_name, service_name, uid, filter:filter, top:top, skip:skip, custom_headers:custom_headers).value!
    end
    ...
    #
    def list_by_users_async(resource_group_name, service_name, uid, filter:nil, top:nil, skip:nil, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{uid}/subscriptions'
    ...
    #
    def list_by_users_next(next_page_link, custom_headers:nil)
      response = list_by_users_next_async(next_page_link, custom_headers:custom_headers).value!
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def list_by_users_next_with_http_info(next_page_link, custom_headers:nil)
      list_by_users_next_async(next_page_link, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def list_by_users_next_async(next_page_link, custom_headers:nil)
