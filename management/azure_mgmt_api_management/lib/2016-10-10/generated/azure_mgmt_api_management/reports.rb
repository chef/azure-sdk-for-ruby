...
module Azure::ApiManagement::Mgmt::V2016_10_10
  ...
  class Reports
    ...
    # @param interval [Duration] By time interval. This value is only applicable to
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2016_10_10::Models::ReportCollection.mapper()
