...
module Azure::ApiManagement::Mgmt::V2016_10_10
  ...
  class Certificates
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2016_10_10::Models::CertificateCollection.mapper()
    ...
    def get_async(resource_group_name, service_name, certificate_id, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2016_10_10::Models::CertificateContract.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, service_name, certificate_id, parameters, if_match:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2016_10_10::Models::CertificateCreateOrUpdateParameters.mapper()
