...
module Azure::ApiManagement::Mgmt::V2017_03_01
  ...
  class NotificationRecipientEmail
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2017_03_01::Models::RecipientEmailCollection.mapper()
    ...
    #
    #
    def get(resource_group_name, service_name, notification_name, email, custom_headers:nil)
      response = get_async(resource_group_name, service_name, notification_name, email, custom_headers:custom_headers).value!
      nil
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def get_with_http_info(resource_group_name, service_name, notification_name, email, custom_headers:nil)
      get_async(resource_group_name, service_name, notification_name, email, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_async(resource_group_name, service_name, notification_name, email, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'service_name is nil' if service_name.nil?
      fail ArgumentError, "'service_name' should satisfy the constraint - 'MaxLength': '50'" if !service_name.nil? && service_name.length > 50
      fail ArgumentError, "'service_name' should satisfy the constraint - 'MinLength': '1'" if !service_name.nil? && service_name.length < 1
    ...
    def create_or_update(resource_group_name, service_name, notification_name, email, custom_headers:nil)
      response = create_or_update_async(resource_group_name, service_name, notification_name, email, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_async(resource_group_name, service_name, notification_name, email, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 201
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2017_03_01::Models::RecipientEmailContract.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def delete(resource_group_name, service_name, notification_name, email, custom_headers:nil)
      response = delete_async(resource_group_name, service_name, notification_name, email, custom_headers:custom_headers).value!
      nil
    end
