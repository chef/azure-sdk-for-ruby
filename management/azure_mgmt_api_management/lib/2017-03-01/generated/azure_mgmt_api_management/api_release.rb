...
module Azure::ApiManagement::Mgmt::V2017_03_01
  ...
  class ApiRelease
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2017_03_01::Models::ApiReleaseCollection.mapper()
    ...
    def get_async(resource_group_name, service_name, api_id, release_id, custom_headers:nil)
      ...
      fail ArgumentError, "'release_id' should satisfy the constraint - 'MaxLength': '256'" if !release_id.nil? && release_id.length > 256
      fail ArgumentError, "'release_id' should satisfy the constraint - 'MinLength': '1'" if !release_id.nil? && release_id.length < 1
      fail ArgumentError, "'release_id' should satisfy the constraint - 'Pattern': '^[^*#&+:<>?]+$'" if !release_id.nil? && release_id.match(Regexp.new('^^[^*#&+:<>?]+$$')).nil?
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2017_03_01::Models::ApiReleaseContract.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # @return [ApiReleaseContract] operation results.
    #
    def create(parameters, resource_group_name, service_name, api_id, release_id, custom_headers:nil)
      response = create_async(parameters, resource_group_name, service_name, api_id, release_id, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def create_with_http_info(parameters, resource_group_name, service_name, api_id, release_id, custom_headers:nil)
      create_async(parameters, resource_group_name, service_name, api_id, release_id, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def create_async(parameters, resource_group_name, service_name, api_id, release_id, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2017_03_01::Models::ApiReleaseContract.mapper()
    ...
    #
    #
    def update(parameters, if_match, resource_group_name, service_name, api_id, release_id, custom_headers:nil)
      response = update_async(parameters, if_match, resource_group_name, service_name, api_id, release_id, custom_headers:custom_headers).value!
      nil
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def update_with_http_info(parameters, if_match, resource_group_name, service_name, api_id, release_id, custom_headers:nil)
      update_async(parameters, if_match, resource_group_name, service_name, api_id, release_id, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def update_async(parameters, if_match, resource_group_name, service_name, api_id, release_id, custom_headers:nil)
      fail ArgumentError, 'parameters is nil' if parameters.nil?
    ...
    #
    #
    def delete(if_match, resource_group_name, service_name, api_id, release_id, custom_headers:nil)
      response = delete_async(if_match, resource_group_name, service_name, api_id, release_id, custom_headers:custom_headers).value!
      nil
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def delete_with_http_info(if_match, resource_group_name, service_name, api_id, release_id, custom_headers:nil)
      delete_async(if_match, resource_group_name, service_name, api_id, release_id, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def delete_async(if_match, resource_group_name, service_name, api_id, release_id, custom_headers:nil)
      fail ArgumentError, 'if_match is nil' if if_match.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'service_name is nil' if service_name.nil?
      fail ArgumentError, "'service_name' should satisfy the constraint - 'MaxLength': '50'" if !service_name.nil? && service_name.length > 50
