...
module Azure::ApiManagement::Mgmt::V2017_03_01
  ...
  class ApiSchema
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2017_03_01::Models::SchemaCollection.mapper()
    ...
    def get_entity_tag_async(resource_group_name, service_name, api_id, schema_id, custom_headers:nil)
      ...
      fail ArgumentError, "'schema_id' should satisfy the constraint - 'MaxLength': '256'" if !schema_id.nil? && schema_id.length > 256
    ...
    def get_async(resource_group_name, service_name, api_id, schema_id, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2017_03_01::Models::SchemaContract.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def create_or_update_with_http_info(resource_group_name, service_name, api_id, schema_id, parameters, if_match:nil, custom_headers:nil)
      create_or_update_async(resource_group_name, service_name, api_id, schema_id, parameters, if_match:if_match, custom_headers:custom_headers).value!
    end
    ...
    def create_or_update_async(resource_group_name, service_name, api_id, schema_id, parameters, if_match:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2017_03_01::Models::SchemaContract.mapper()
