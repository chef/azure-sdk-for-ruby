...
module Azure::ApiManagement::Mgmt::V2017_03_01
  ...
  class SignUpSettings
    ...
    #
    # Creates and initializes a new instance of the SignUpSettings class.
    ...
    #
    #
    def head(resource_group_name, service_name, custom_headers:nil)
      response = head_async(resource_group_name, service_name, custom_headers:custom_headers).value!
      nil
    end
    ...
    #
    def head_with_http_info(resource_group_name, service_name, custom_headers:nil)
      head_async(resource_group_name, service_name, custom_headers:custom_headers).value!
    end
    ...
    #
    def head_async(resource_group_name, service_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/portalsettings/signup'
    ...
    # will be added to the HTTP request.
    #
    # @return [PortalSignupSettings] operation results.
    #
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2017_03_01::Models::PortalSignupSettings.mapper()
    ...
    # @param resource_group_name [String] The name of the resource group.
    # @param service_name [String] The name of the API Management service.
    # @param parameters [PortalSignupSettings] Update Sign-Up settings.
    ...
    def update_async(resource_group_name, service_name, parameters, if_match, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2017_03_01::Models::PortalSignupSettings.mapper()
    ...
    # @param resource_group_name [String] The name of the resource group.
    # @param service_name [String] The name of the API Management service.
    # @param parameters [PortalSignupSettings] Create or update parameters.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [PortalSignupSettings] operation results.
