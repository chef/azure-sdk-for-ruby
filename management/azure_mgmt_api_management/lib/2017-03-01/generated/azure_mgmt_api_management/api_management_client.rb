...
module Azure::ApiManagement::Mgmt::V2017_03_01
  ...
  class ApiManagementClient < MsRestAzure::AzureServiceClient
    ...
    # @return [ApiIssues] api_issues
    attr_reader :api_issues

    # @return [ApiIssue] api_issue
    attr_reader :api_issue

    # @return [ApiIssueComments] api_issue_comments
    attr_reader :api_issue_comments

    # @return [ApiIssuComment] api_issu_comment
    attr_reader :api_issu_comment

    # @return [ApiIssueComment] api_issue_comment
    attr_reader :api_issue_comment

    # @return [ApiIssueAttachments] api_issue_attachments
    attr_reader :api_issue_attachments

    # @return [ApiIssuAttachment] api_issu_attachment
    attr_reader :api_issu_attachment
