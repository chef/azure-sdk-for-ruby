...
module Azure::ApiManagement::Mgmt::V2017_03_01
  ...
  class SignInSettings
    ...
    # will be added to the HTTP request.
    #
    # @return [PortalSigninSettings] operation results.
    #
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2017_03_01::Models::PortalSigninSettings.mapper()
    ...
    # @param resource_group_name [String] The name of the resource group.
    # @param service_name [String] The name of the API Management service.
    # @param parameters [PortalSigninSettings] Update Sign-In settings.
    ...
    def update_async(resource_group_name, service_name, parameters, if_match, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2017_03_01::Models::PortalSigninSettings.mapper()
    ...
    # @param resource_group_name [String] The name of the resource group.
    # @param service_name [String] The name of the API Management service.
    # @param parameters [PortalSigninSettings] Create or update parameters.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [PortalSigninSettings] operation results.
