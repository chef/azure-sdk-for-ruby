...
module Azure::ApiManagement::Mgmt::V2018_01_01
  ...
  class UserIdentities
    ...
    #
    # Creates and initializes a new instance of the UserIdentities class.
    ...
    #
    def list(resource_group_name, service_name, uid, custom_headers:nil)
      first_page = list_as_lazy(resource_group_name, service_name, uid, custom_headers:custom_headers)
    ...
    #
    def list_with_http_info(resource_group_name, service_name, uid, custom_headers:nil)
      list_async(resource_group_name, service_name, uid, custom_headers:custom_headers).value!
    end
    ...
    #
    def list_async(resource_group_name, service_name, uid, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{uid}/identities'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2018_01_01::Models::UserIdentityCollection.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [UserIdentityCollection] which provide lazy access to pages of the
    # response.
    #
    def list_as_lazy(resource_group_name, service_name, uid, custom_headers:nil)
      response = list_async(resource_group_name, service_name, uid, custom_headers:custom_headers).value!
      unless response.nil?
        page = response.body
