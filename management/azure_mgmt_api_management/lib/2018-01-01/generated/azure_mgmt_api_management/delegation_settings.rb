...
module Azure::ApiManagement::Mgmt::V2018_01_01
  ...
  class DelegationSettings
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2018_01_01::Models::PortalDelegationSettings.mapper()
    ...
    def update_async(resource_group_name, service_name, parameters, if_match, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2018_01_01::Models::PortalDelegationSettings.mapper()
