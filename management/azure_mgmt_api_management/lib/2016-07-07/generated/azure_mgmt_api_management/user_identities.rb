...
module Azure::ApiManagement::Mgmt::V2016_07_07
  ...
  class UserIdentities
    ...
    #
    def list_by_user(resource_group_name, service_name, uid, custom_headers:nil)
      response = list_by_user_async(resource_group_name, service_name, uid, custom_headers:custom_headers).value!
    ...
    #
    def list_by_user_with_http_info(resource_group_name, service_name, uid, custom_headers:nil)
    ...
    #
    def list_by_user_async(resource_group_name, service_name, uid, custom_headers:nil)
