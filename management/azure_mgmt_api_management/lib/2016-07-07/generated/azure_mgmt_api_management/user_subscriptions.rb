...
module Azure::ApiManagement::Mgmt::V2016_07_07
  ...
  class UserSubscriptions
    ...
    #
    def list_by_user(resource_group_name, service_name, uid, filter:nil, top:nil, skip:nil, custom_headers:nil)
      first_page = list_by_user_as_lazy(resource_group_name, service_name, uid, filter:filter, top:top, skip:skip, custom_headers:custom_headers)
    ...
    #
    def list_by_user_with_http_info(resource_group_name, service_name, uid, filter:nil, top:nil, skip:nil, custom_headers:nil)
      list_by_user_async(resource_group_name, service_name, uid, filter:filter, top:top, skip:skip, custom_headers:custom_headers).value!
    end
    ...
    #
    def list_by_user_async(resource_group_name, service_name, uid, filter:nil, top:nil, skip:nil, custom_headers:nil)
    ...
    # response.
    #
    def list_by_user_as_lazy(resource_group_name, service_name, uid, filter:nil, top:nil, skip:nil, custom_headers:nil)
      response = list_by_user_async(resource_group_name, service_name, uid, filter:filter, top:top, skip:skip, custom_headers:custom_headers).value!
      unless response.nil?
        page = response.body
