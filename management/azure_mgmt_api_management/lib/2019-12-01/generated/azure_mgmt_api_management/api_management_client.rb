...
module Azure::ApiManagement::Mgmt::V2019_12_01
  ...
  class ApiManagementClient < MsRestAzure::AzureServiceClient
    ...
    # @return [GatewayHostnameConfiguration] gateway_hostname_configuration
    attr_reader :gateway_hostname_configuration

    # @return [GatewayApi] gateway_api
    attr_reader :gateway_api
    ...
    # @return [NamedValue] named_value
    attr_reader :named_value
    ...
    # @return [PolicyDescription] policy_description
    ...
    def initialize(credentials = nil, base_url = nil, options = nil)
      ...
      @gateway_hostname_configuration = GatewayHostnameConfiguration.new(self)
      @gateway_api = GatewayApi.new(self)
      @group = Group.new(self)
      @group_user = GroupUser.new(self)
      @identity_provider = IdentityProvider.new(self)
      @issue = Issue.new(self)
      @logger = Logger.new(self)
      @named_value = NamedValue.new(self)
      ...
      @policy_description = PolicyDescription.new(self)
