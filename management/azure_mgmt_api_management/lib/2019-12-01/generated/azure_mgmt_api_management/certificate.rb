...
module Azure::ApiManagement::Mgmt::V2019_12_01
  ...
  class Certificate
    ...
    #
    # Creates and initializes a new instance of the Certificate class.
    ...
    # | </br>| subject | filter | ge, le, eq, ne, gt, lt | substringof, contains,
    # startswith, endswith | </br>| thumbprint | filter | ge, le, eq, ne, gt, lt |
    # substringof, contains, startswith, endswith | </br>| expirationDate | filter
    # | ge, le, eq, ne, gt, lt |     | </br>
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2019_12_01::Models::CertificateCollection.mapper()
    ...
    #
    #
    def get_entity_tag(resource_group_name, service_name, certificate_id, custom_headers:nil)
      response = get_entity_tag_async(resource_group_name, service_name, certificate_id, custom_headers:custom_headers).value!
      nil
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def get_entity_tag_with_http_info(resource_group_name, service_name, certificate_id, custom_headers:nil)
      get_entity_tag_async(resource_group_name, service_name, certificate_id, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_entity_tag_async(resource_group_name, service_name, certificate_id, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'service_name is nil' if service_name.nil?
      fail ArgumentError, "'service_name' should satisfy the constraint - 'MaxLength': '50'" if !service_name.nil? && service_name.length > 50
      fail ArgumentError, "'service_name' should satisfy the constraint - 'MinLength': '1'" if !service_name.nil? && service_name.length < 1
      ...
      fail ArgumentError, "'certificate_id' should satisfy the constraint - 'MaxLength': '80'" if !certificate_id.nil? && certificate_id.length > 80
      fail ArgumentError, "'certificate_id' should satisfy the constraint - 'MinLength': '1'" if !certificate_id.nil? && certificate_id.length < 1
      fail ArgumentError, "'certificate_id' should satisfy the constraint - 'Pattern': '^[^*#&+:<>?]+$'" if !certificate_id.nil? && certificate_id.match(Regexp.new('^^[^*#&+:<>?]+$$')).nil?
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
    ...
    def get(resource_group_name, service_name, certificate_id, custom_headers:nil)
      response = get_async(resource_group_name, service_name, certificate_id, custom_headers:custom_headers).value!
    ...
    def get_async(resource_group_name, service_name, certificate_id, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2019_12_01::Models::CertificateContract.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # @param certificate_id [String] Identifier of the certificate entity. Must be
    # unique in the current API Management service instance.
    # @param parameters [CertificateCreateOrUpdateParameters] Create or Update
    # parameters.
    ...
    def create_or_update(resource_group_name, service_name, certificate_id, parameters, if_match:nil, custom_headers:nil)
      response = create_or_update_async(resource_group_name, service_name, certificate_id, parameters, if_match:if_match, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    def create_or_update_with_http_info(resource_group_name, service_name, certificate_id, parameters, if_match:nil, custom_headers:nil)
      create_or_update_async(resource_group_name, service_name, certificate_id, parameters, if_match:if_match, custom_headers:custom_headers).value!
    end
    ...
    def create_or_update_async(resource_group_name, service_name, certificate_id, parameters, if_match:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2019_12_01::Models::CertificateCreateOrUpdateParameters.mapper()
    ...
    def delete(resource_group_name, service_name, certificate_id, if_match, custom_headers:nil)
      response = delete_async(resource_group_name, service_name, certificate_id, if_match, custom_headers:custom_headers).value!
      nil
    end
    ...
    def delete_with_http_info(resource_group_name, service_name, certificate_id, if_match, custom_headers:nil)
      delete_async(resource_group_name, service_name, certificate_id, if_match, custom_headers:custom_headers).value!
    end
