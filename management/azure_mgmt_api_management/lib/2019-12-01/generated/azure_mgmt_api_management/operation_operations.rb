...
module Azure::ApiManagement::Mgmt::V2019_12_01
  ...
  class OperationOperations
    ...
    #
    # Creates and initializes a new instance of the OperationOperations class.
    ...
    # contains, startswith, endswith | </br>| apiName | filter | ge, le, eq, ne,
    # gt, lt | substringof, contains, startswith, endswith | </br>| description |
    # filter | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith
    ...
    def list_by_tags_async(resource_group_name, service_name, api_id, filter:nil, top:nil, skip:nil, include_not_tagged_operations:nil, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/operationsByTags'
