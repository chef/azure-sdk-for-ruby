...
module Azure::ApiManagement::Mgmt::V2019_12_01
  ...
  class PolicyDescription
    ...
    #
    # @return [PolicyDescriptionCollection] operation results.
    #
    ...
    def list_by_service_async(resource_group_name, service_name, scope:nil, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/policyDescriptions'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2019_12_01::Models::PolicyDescriptionCollection.mapper()
