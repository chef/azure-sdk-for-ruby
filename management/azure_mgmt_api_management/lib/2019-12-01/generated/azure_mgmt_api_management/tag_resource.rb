...
module Azure::ApiManagement::Mgmt::V2019_12_01
  ...
  class TagResource
    ...
    # | </br>| name | filter | ge, le, eq, ne, gt, lt | substringof, contains,
    # startswith, endswith | </br>| displayName | filter | ge, le, eq, ne, gt, lt |
    ...
    # ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith | </br>|
    # terms | filter | ge, le, eq, ne, gt, lt | substringof, contains, startswith,
    # endswith | </br>| state | filter | eq |     | </br>| isCurrent | filter | eq
    # |     | </br>
