...
module Azure::ApiManagement::Mgmt::V2019_12_01
  ...
  class Product
    ...
    #
    # Creates and initializes a new instance of the Product class.
    ...
    # ne, gt, lt | substringof, contains, startswith, endswith | </br>| terms |
    # filter | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith
    # | </br>| state | filter | eq |     | </br>| groups | expand |     |     |
    # </br>
    ...
    # @param tags [String] Products which are part of a specific tag.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [Array<ProductContract>] operation results.
    #
    def list_by_service(resource_group_name, service_name, filter:nil, top:nil, skip:nil, expand_groups:nil, tags:nil, custom_headers:nil)
      first_page = list_by_service_as_lazy(resource_group_name, service_name, filter:filter, top:top, skip:skip, expand_groups:expand_groups, tags:tags, custom_headers:custom_headers)
    ...
    #
    def list_by_service_with_http_info(resource_group_name, service_name, filter:nil, top:nil, skip:nil, expand_groups:nil, tags:nil, custom_headers:nil)
      list_by_service_async(resource_group_name, service_name, filter:filter, top:top, skip:skip, expand_groups:expand_groups, tags:tags, custom_headers:custom_headers).value!
    end
    ...
    #
    def list_by_service_async(resource_group_name, service_name, filter:nil, top:nil, skip:nil, expand_groups:nil, tags:nil, custom_headers:nil)
      ...
      options = {
          ...
          query_params: {'$filter' => filter,'$top' => top,'$skip' => skip,'expandGroups' => expand_groups,'tags' => tags,'api-version' => @client.api_version},
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2019_12_01::Models::ProductCollection.mapper()
    ...
    def get_async(resource_group_name, service_name, product_id, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ApiManagement::Mgmt::V2019_12_01::Models::ProductContract.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, service_name, product_id, parameters, if_match:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2019_12_01::Models::ProductContract.mapper()
    ...
    def update_async(resource_group_name, service_name, product_id, parameters, if_match, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2019_12_01::Models::ProductUpdateParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    # entity state from the header response of the GET request or it should be *
    # for unconditional update.
    # @param delete_subscriptions [Boolean] Delete existing subscriptions
    ...
    # ne, gt, lt | substringof, contains, startswith, endswith | </br>| terms |
    # filter | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith
    # | </br>| state | filter | eq | substringof, contains, startswith, endswith |
    # </br>
    # @param top [Integer] Number of records to return.
    # @param skip [Integer] Number of records to skip.
    # @param include_not_tagged_products [Boolean] Include not tagged Products.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [Array<TagResourceContract>] operation results.
    #
    def list_by_tags(resource_group_name, service_name, filter:nil, top:nil, skip:nil, include_not_tagged_products:nil, custom_headers:nil)
      first_page = list_by_tags_as_lazy(resource_group_name, service_name, filter:filter, top:top, skip:skip, include_not_tagged_products:include_not_tagged_products, custom_headers:custom_headers)
      first_page.get_all_items
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def list_by_tags_with_http_info(resource_group_name, service_name, filter:nil, top:nil, skip:nil, include_not_tagged_products:nil, custom_headers:nil)
      list_by_tags_async(resource_group_name, service_name, filter:filter, top:top, skip:skip, include_not_tagged_products:include_not_tagged_products, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def list_by_tags_async(resource_group_name, service_name, filter:nil, top:nil, skip:nil, include_not_tagged_products:nil, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'service_name is nil' if service_name.nil?
      fail ArgumentError, "'service_name' should satisfy the constraint - 'MaxLength': '50'" if !service_name.nil? && service_name.length > 50
      fail ArgumentError, "'service_name' should satisfy the constraint - 'MinLength': '1'" if !service_name.nil? && service_name.length < 1
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/productsByTags'
      ...
      options = {
          middlewares: [[MsRest2::RetryPolicyMiddleware, times: 3, retry: 0.02], [:cookie_jar]],
          path_params: {'resourceGroupName' => resource_group_name,'serviceName' => service_name,'subscriptionId' => @client.subscription_id},
          query_params: {'$filter' => filter,'$top' => top,'$skip' => skip,'includeNotTaggedProducts' => include_not_tagged_products,'api-version' => @client.api_version},
          headers: request_headers.merge(custom_headers || {}),
          base_url: request_url
      }
      promise = @client.make_request_async(:get, path_template, options)
    ...
    # response.
    #
    def list_by_service_as_lazy(resource_group_name, service_name, filter:nil, top:nil, skip:nil, expand_groups:nil, tags:nil, custom_headers:nil)
      response = list_by_service_async(resource_group_name, service_name, filter:filter, top:top, skip:skip, expand_groups:expand_groups, tags:tags, custom_headers:custom_headers).value!
      unless response.nil?
        page = response.body
    ...
    # response.
    #
    def list_by_tags_as_lazy(resource_group_name, service_name, filter:nil, top:nil, skip:nil, include_not_tagged_products:nil, custom_headers:nil)
      response = list_by_tags_async(resource_group_name, service_name, filter:filter, top:top, skip:skip, include_not_tagged_products:include_not_tagged_products, custom_headers:custom_headers).value!
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
