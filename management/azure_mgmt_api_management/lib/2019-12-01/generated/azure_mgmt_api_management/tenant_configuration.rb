...
module Azure::ApiManagement::Mgmt::V2019_12_01
  ...
  class TenantConfiguration
    ...
    def deploy_async(resource_group_name, service_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::ApiManagement::Mgmt::V2019_12_01::Models::OperationResultContract.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ApiManagement::Mgmt::V2019_12_01::Models::TenantConfigurationSyncStateContract.mapper()
    ...
    def begin_deploy_async(resource_group_name, service_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2019_12_01::Models::DeployConfigurationParameters.mapper()
    ...
    def begin_save_async(resource_group_name, service_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ApiManagement::Mgmt::V2019_12_01::Models::SaveConfigurationParameter.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
