...
module Azure::ApiManagement::Mgmt::V2019_12_01
  module Models
    ...
    class IssueCollection
      ...
      #
      # @return [IssueCollection] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for IssueCollection class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'IssueCollection',
          type: {
            name: 'Composite',
            class_name: 'IssueCollection',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'IssueContractElementType',
                      type: {
                        name: 'Composite',
