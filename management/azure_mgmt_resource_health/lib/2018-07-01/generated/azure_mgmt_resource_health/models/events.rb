...
module Azure::ResourceHealth::Mgmt::V2018_07_01
  module Models
    ...
    class Events
      ...
      # @return [String] The URI to fetch the next page of events. Call
      # ListNext() with this URI to fetch the next page of events.
      ...
      #
      # @return [Events] with next page content.
      #
      def get_next_page
