...
module Azure::ResourceHealth::Mgmt::V2018_08_01_preview
  ...
  class Metadata
    ...
    #
    # Creates and initializes a new instance of the Metadata class.
    ...
    def get_async(name, custom_headers:nil)
      ...
      path_template = 'providers/Microsoft.ResourceHealth/metadata/{name}'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ResourceHealth::Mgmt::V2018_08_01_preview::Models::MetadataEntity.mapper()
        ...
        if status_code == 404
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ResourceHealth::Mgmt::V2018_08_01_preview::Models::ErrorResponse.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_async(custom_headers:nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'providers/Microsoft.ResourceHealth/metadata'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ResourceHealth::Mgmt::V2018_08_01_preview::Models::MetadataEntityListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
