...
module Azure::ResourceHealth::Mgmt::V2018_08_01_preview
  ...
  #
  class ImpactedResources
    include MsRestAzure

    #
    # Creates and initializes a new instance of the ImpactedResources class.
    ...
    #
    # Lists the current availability status for impacted resources in the
    # subscription.
    #
    ...
    #
    # @return [Array<ImpactedResourceStatus>] operation results.
    #
    ...
    def list_by_subscription_id_async(filter:nil, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/providers/Microsoft.ResourceHealth/impactedResources'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ResourceHealth::Mgmt::V2018_08_01_preview::Models::ImpactedResourceListResult.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [ImpactedResourceListResult] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [ImpactedResourceListResult] which provide lazy access to pages of
    # the response.
    #
