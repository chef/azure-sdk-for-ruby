...
module Azure::ContainerService::Mgmt::V2020_12_01
  ...
  class ManagedClusters
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ContainerService::Mgmt::V2020_12_01::Models::ManagedClusterListResult.mapper()
    ...
    def get_upgrade_profile_async(resource_group_name, resource_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ContainerService::Mgmt::V2020_12_01::Models::ManagedClusterUpgradeProfile.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_access_profile_async(resource_group_name, resource_name, role_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ContainerService::Mgmt::V2020_12_01::Models::ManagedClusterAccessProfile.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_cluster_admin_credentials_async(resource_group_name, resource_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ContainerService::Mgmt::V2020_12_01::Models::CredentialResults.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_async(resource_group_name, resource_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ContainerService::Mgmt::V2020_12_01::Models::ManagedCluster.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, resource_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ContainerService::Mgmt::V2020_12_01::Models::ManagedCluster.mapper()
    ...
    def begin_update_tags_async(resource_group_name, resource_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ContainerService::Mgmt::V2020_12_01::Models::TagsObject.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_reset_service_principal_profile_async(resource_group_name, resource_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ContainerService::Mgmt::V2020_12_01::Models::ManagedClusterServicePrincipalProfile.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_reset_aadprofile_async(resource_group_name, resource_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ContainerService::Mgmt::V2020_12_01::Models::ManagedClusterAADProfile.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
