...
module Azure::ContainerService::Mgmt::V2020_12_01
  module Models
    ...
    class MaintenanceConfigurationListResult
      ...
      # @return [String] The URL to get the next set of maintenance
      ...
      #
      # @return [MaintenanceConfigurationListResult] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for MaintenanceConfigurationListResult class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'MaintenanceConfigurationListResult',
          type: {
            name: 'Composite',
            class_name: 'MaintenanceConfigurationListResult',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
