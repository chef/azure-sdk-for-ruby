...
module Azure::ContainerService::Mgmt::V2020_09_01
  ...
  class AgentPools
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ContainerService::Mgmt::V2020_09_01::Models::AgentPoolListResult.mapper()
    ...
    def get_async(resource_group_name, resource_name, agent_pool_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ContainerService::Mgmt::V2020_09_01::Models::AgentPool.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_upgrade_profile_async(resource_group_name, resource_name, agent_pool_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ContainerService::Mgmt::V2020_09_01::Models::AgentPoolUpgradeProfile.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_available_agent_pool_versions_async(resource_group_name, resource_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ContainerService::Mgmt::V2020_09_01::Models::AgentPoolAvailableVersions.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, resource_name, agent_pool_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::ContainerService::Mgmt::V2020_09_01::Models::AgentPool.mapper()
