...
module Azure::ContainerRegistry::Mgmt::V2018_02_01_preview
  module Models
    ...
    class BuildArgumentList
      ...
      # @return [Array<BuildArgument>] The collection value.
      attr_accessor :value
      ...
      #
      # @return [BuildArgumentList] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for BuildArgumentList class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'BuildArgumentList',
          type: {
            name: 'Composite',
            class_name: 'BuildArgumentList',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
