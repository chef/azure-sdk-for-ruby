...
module Azure::ContainerRegistry::Mgmt::V2018_02_01_preview
  module Models
    ...
    class BuildListResult
      ...
      # @return [Array<Build>] The collection value.
      attr_accessor :value
      ...
      #
      # @return [BuildListResult] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for BuildListResult class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'BuildListResult',
          type: {
            name: 'Composite',
            class_name: 'BuildListResult',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
