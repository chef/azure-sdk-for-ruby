...
module Azure::ContainerRegistry::Mgmt::V2019_04_01
  module Models
    ...
    class RunListResult
      ...
      #
      # @return [RunListResult] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for RunListResult class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'RunListResult',
          type: {
            name: 'Composite',
            class_name: 'RunListResult',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'RunElementType',
                      type: {
                        name: 'Composite',
                        class_name: 'Run'
                      }
