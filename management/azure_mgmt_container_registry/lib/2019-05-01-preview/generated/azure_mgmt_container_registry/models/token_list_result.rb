...
module Azure::ContainerRegistry::Mgmt::V2019_05_01_preview
  module Models
    ...
    class TokenListResult
      ...
      # @return [Array<Token>] The list of tokens. Since this list may be
      ...
      #
      # @return [TokenListResult] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for TokenListResult class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'TokenListResult',
          type: {
            name: 'Composite',
            class_name: 'TokenListResult',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'TokenElementType',
                      type: {
                        name: 'Composite',
                        class_name: 'Token'
                      }
