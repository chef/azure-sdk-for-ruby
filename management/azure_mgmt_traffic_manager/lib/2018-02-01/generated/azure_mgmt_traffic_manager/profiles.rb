...
module Azure::TrafficManager::Mgmt::V2018_02_01
  ...
  class Profiles
    ...
    def check_traffic_manager_relative_dns_name_availability_async(parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::TrafficManager::Mgmt::V2018_02_01::Models::CheckTrafficManagerRelativeDnsNameAvailabilityParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::TrafficManager::Mgmt::V2018_02_01::Models::TrafficManagerNameAvailability.mapper()
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::TrafficManager::Mgmt::V2018_02_01::Models::ProfileListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_async(resource_group_name, profile_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::TrafficManager::Mgmt::V2018_02_01::Models::Profile.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, profile_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::TrafficManager::Mgmt::V2018_02_01::Models::Profile.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def delete_async(resource_group_name, profile_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::TrafficManager::Mgmt::V2018_02_01::Models::DeleteOperationResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
