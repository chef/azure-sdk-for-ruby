...
module Azure::BatchAI::Mgmt::V2018_03_01
  ...
  class FileServers
    ...
    def create_async(resource_group_name, file_server_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::BatchAI::Mgmt::V2018_03_01::Models::FileServer.mapper()
    ...
    def list_async(file_servers_list_options:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::BatchAI::Mgmt::V2018_03_01::Models::FileServerListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_async(resource_group_name, file_server_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::BatchAI::Mgmt::V2018_03_01::Models::FileServerCreateParameters.mapper()
