...
describe 'Virtual machine api' do
  ...
  it 'should list virtual machines and interfaces' do
    ...
    result.each do |network_interface|
      ...
      expect(network_interface.virtual_machine).to be_an_instance_of(Azure::Network2::Mgmt::V2017_09_01::Models::SubResource)
    end
  end
...
def build_storage_account_create_parameters(name)
  sku = Azure::Storage2::Mgmt::V2017_06_01::Models::Sku.new
  sku.name = 'Standard_GRS'

  params = Azure::Storage2::Mgmt::V2017_06_01::Models::StorageAccountCreateParameters.new
  params.location = @location
  params.sku = sku
  params.kind = Azure::Storage2::Mgmt::V2017_06_01::Models::Kind::Storage
