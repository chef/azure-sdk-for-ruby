...
require '../azure_mgmt_compute2/lib/module_definition'
require '../azure_mgmt_compute2/lib/version'

Gem::Specification.new do |spec|
  spec.name          = 'azure_mgmt_compute2'
  spec.version       = Azure::Compute2::Mgmt::VERSION
