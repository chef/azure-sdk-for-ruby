...
module Azure::Compute2::Mgmt::V2020_09_30
  module Models
    ...
    class Snapshot < Resource
      ...
      # @return [ExtendedLocation] The extended location where the snapshot
      ...
      # @return [PurchasePlan] Purchase plan information for the image from
      ...
      # @return [DiskState] The state of the snapshot. Possible values include:
