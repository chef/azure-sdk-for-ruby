...
module Azure::Compute2::Mgmt::V2020_09_30
  module Models
    ...
    class ResourceUriList
      ...
      # @return [String] The uri to fetch the next page of encrypted resources.
      # Call ListNext() with this to fetch the next page of encrypted
      # resources.
      ...
      #
      # @return [ResourceUriList] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for ResourceUriList class as Ruby Hash.
