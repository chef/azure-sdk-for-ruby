...
module Azure::Compute2::Mgmt::V2020_09_30
  module Models
    ...
    class Disk < Resource
      ...
      # @return [ExtendedLocation] The extended location where the disk will be
      ...
      # which the OS disk was created. E.g. - {name: 2019-Datacenter,
      ...
      # @return [Boolean] Set to true to enable bursting beyond the provisioned
      # performance target of the disk. Bursting is disabled by default. Does
      # not apply to Ultra disks.
      attr_accessor :bursting_enabled
