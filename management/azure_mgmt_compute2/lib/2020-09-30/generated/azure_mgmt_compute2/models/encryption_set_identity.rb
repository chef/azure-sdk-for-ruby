...
module Azure::Compute2::Mgmt::V2020_09_30
  module Models
    ...
    class EncryptionSetIdentity
      ...
      # used by the DiskEncryptionSet. Only SystemAssigned is supported for new
      # creations. Disk Encryption Sets can be updated with Identity type None
      # during migration of subscription to a new Azure Active Directory
      # tenant; it will cause the encrypted resources to lose access to the
      # keys. Possible values include: 'SystemAssigned', 'None'
      attr_accessor :type
