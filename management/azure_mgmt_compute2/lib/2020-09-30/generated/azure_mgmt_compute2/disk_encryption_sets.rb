...
module Azure::Compute2::Mgmt::V2020_09_30
  ...
  class DiskEncryptionSets
    ...
    # @param disk_encryption_set_name [String] The name of the disk encryption set
    # that is being created. The name can't be changed after the disk encryption
    # set is created. Supported characters for the name are a-z, A-Z, 0-9 and _.
    # The maximum name length is 80 characters.
    # @param disk_encryption_set [DiskEncryptionSet] disk encryption set object
    # supplied in the body of the Put disk encryption set operation.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [DiskEncryptionSet] operation results.
    #
    ...
    def create_or_update_async(resource_group_name, disk_encryption_set_name, disk_encryption_set, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Compute2::Mgmt::V2020_09_30::Models::DiskEncryptionSet.mapper()
    ...
    # set is created. Supported characters for the name are a-z, A-Z, 0-9 and _.
    # The maximum name length is 80 characters.
    # @param disk_encryption_set [DiskEncryptionSetUpdate] disk encryption set
    # object supplied in the body of the Patch disk encryption set operation.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [DiskEncryptionSet] operation results.
    ...
    # will be added to the HTTP request.
    #
    # @return [Array<DiskEncryptionSet>] operation results.
    #
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute2::Mgmt::V2020_09_30::Models::DiskEncryptionSetList.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_associated_resources_async(resource_group_name, disk_encryption_set_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute2::Mgmt::V2020_09_30::Models::ResourceUriList.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, disk_encryption_set_name, disk_encryption_set, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2020_09_30::Models::DiskEncryptionSet.mapper()
    ...
    def begin_update_async(resource_group_name, disk_encryption_set_name, disk_encryption_set, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2020_09_30::Models::DiskEncryptionSetUpdate.mapper()
      request_content = @client.serialize(request_mapper,  disk_encryption_set)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    # will be added to the HTTP request.
    #
    # @return [DiskEncryptionSetList] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [ResourceUriList] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [DiskEncryptionSetList] which provide lazy access to pages of the
    # response.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [ResourceUriList] which provide lazy access to pages of the response.
    #
