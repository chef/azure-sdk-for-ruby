...
module Azure::Compute2::Mgmt::V2020_09_30
  ...
  class DiskAccesses
    ...
    # @param disk_access_name [String] The name of the disk access resource that is
    # being created. The name can't be changed after the disk encryption set is
    # created. Supported characters for the name are a-z, A-Z, 0-9 and _. The
    # maximum name length is 80 characters.
    # @param disk_access [DiskAccess] disk access object supplied in the body of
    # the Put disk access operation.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [DiskAccess] operation results.
    #
    ...
    def create_or_update_async(resource_group_name, disk_access_name, disk_access, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Compute2::Mgmt::V2020_09_30::Models::DiskAccess.mapper()
    ...
    # created. Supported characters for the name are a-z, A-Z, 0-9 and _. The
    # maximum name length is 80 characters.
    # @param disk_access [DiskAccessUpdate] disk access object supplied in the body
    # of the Patch disk access operation.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [DiskAccess] operation results.
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute2::Mgmt::V2020_09_30::Models::DiskAccessList.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def get_private_link_resources_async(resource_group_name, disk_access_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute2::Mgmt::V2020_09_30::Models::PrivateLinkResourceListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # endpoint connection
    # @param private_endpoint_connection [PrivateEndpointConnection] private
    # endpoint connection object supplied in the body of the Put private endpoint
    ...
    def update_aprivate_endpoint_connection_async(resource_group_name, disk_access_name, private_endpoint_connection_name, private_endpoint_connection, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Compute2::Mgmt::V2020_09_30::Models::PrivateEndpointConnection.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def list_private_endpoint_connections_async(resource_group_name, disk_access_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute2::Mgmt::V2020_09_30::Models::PrivateEndpointConnectionListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, disk_access_name, disk_access, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2020_09_30::Models::DiskAccess.mapper()
    ...
    def begin_update_async(resource_group_name, disk_access_name, disk_access, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2020_09_30::Models::DiskAccessUpdate.mapper()
      request_content = @client.serialize(request_mapper,  disk_access)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_update_aprivate_endpoint_connection_async(resource_group_name, disk_access_name, private_endpoint_connection_name, private_endpoint_connection, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2020_09_30::Models::PrivateEndpointConnection.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [DiskAccessList] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [DiskAccessList] which provide lazy access to pages of the response.
    #
