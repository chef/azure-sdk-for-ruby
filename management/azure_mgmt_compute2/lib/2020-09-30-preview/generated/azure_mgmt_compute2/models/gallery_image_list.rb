...
module Azure::Compute2::Mgmt::V2020_09_30_preview
  module Models
    ...
    class GalleryImageList
      ...
      #
      # @return [GalleryImageList] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for GalleryImageList class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'GalleryImageList',
          type: {
            name: 'Composite',
            class_name: 'GalleryImageList',
            model_properties: {
              value: {
                client_side_validation: true,
                required: true,
