...
module Azure::Compute2::Mgmt::V2020_09_30_preview
  module Models
    ...
    class GalleryApplicationVersionUpdate < UpdateResourceDefinition
      ...
      #
      # Mapper for GalleryApplicationVersionUpdate class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'GalleryApplicationVersionUpdate',
          type: {
            name: 'Composite',
            class_name: 'GalleryApplicationVersionUpdate',
            model_properties: {
              id: {
                client_side_validation: true,
                required: false,
