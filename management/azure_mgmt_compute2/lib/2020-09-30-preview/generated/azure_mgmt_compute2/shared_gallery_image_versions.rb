...
module Azure::Compute2::Mgmt::V2020_09_30_preview
  ...
  #
  class SharedGalleryImageVersions
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Compute2::Mgmt::V2020_09_30_preview::Models::SharedGalleryImageVersionList.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [SharedGalleryImageVersion] operation results.
    #
    ...
    def get_async(location, gallery_unique_name, gallery_image_name, gallery_image_version_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute2::Mgmt::V2020_09_30_preview::Models::SharedGalleryImageVersion.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # will be added to the HTTP request.
    #
    # @return [SharedGalleryImageVersionList] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [SharedGalleryImageVersionList] which provide lazy access to pages of
    # the response.
    #
