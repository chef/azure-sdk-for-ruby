...
module Azure::Compute2::Mgmt::V2020_09_30_preview
  ...
  class GalleryImageVersions
    ...
    #
    # Creates and initializes a new instance of the GalleryImageVersions class.
    ...
    def create_or_update_async(resource_group_name, gallery_name, gallery_image_name, gallery_image_version_name, gallery_image_version, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Compute2::Mgmt::V2020_09_30_preview::Models::GalleryImageVersion.mapper()
    ...
    # the Image Definition resides.
    # @param gallery_image_name [String] The name of the gallery image definition
    # in which the Image Version is to be updated.
    # @param gallery_image_version_name [String] The name of the gallery image
    # version to be updated. Needs to follow semantic version name pattern: The
    # allowed characters are digit and period. Digits must be within the range of a
    # 32-bit integer. Format: <MajorVersion>.<MinorVersion>.<Patch>
    # @param gallery_image_version [GalleryImageVersionUpdate] Parameters supplied
    # to the update gallery image version operation.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [GalleryImageVersion] operation results.
    #
    def update(resource_group_name, gallery_name, gallery_image_name, gallery_image_version_name, gallery_image_version, custom_headers:nil)
      response = update_async(resource_group_name, gallery_name, gallery_image_name, gallery_image_version_name, gallery_image_version, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # response.
    #
    def update_async(resource_group_name, gallery_name, gallery_image_name, gallery_image_version_name, gallery_image_version, custom_headers:nil)
      # Send request
      promise = begin_update_async(resource_group_name, gallery_name, gallery_image_name, gallery_image_version_name, gallery_image_version, custom_headers:custom_headers)
    ...
    #
    def list_by_gallery_image(resource_group_name, gallery_name, gallery_image_name, custom_headers:nil)
      first_page = list_by_gallery_image_as_lazy(resource_group_name, gallery_name, gallery_image_name, custom_headers:custom_headers)
    ...
    # @return [MsRestAzure2::AzureOperationResponse] HTTP response information.
    #
    def list_by_gallery_image_with_http_info(resource_group_name, gallery_name, gallery_image_name, custom_headers:nil)
      list_by_gallery_image_async(resource_group_name, gallery_name, gallery_image_name, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def list_by_gallery_image_async(resource_group_name, gallery_name, gallery_image_name, custom_headers:nil)
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'gallery_name is nil' if gallery_name.nil?
      fail ArgumentError, 'gallery_image_name is nil' if gallery_image_name.nil?
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/images/{galleryImageName}/versions'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute2::Mgmt::V2020_09_30_preview::Models::GalleryImageVersionList.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, gallery_name, gallery_image_name, gallery_image_version_name, gallery_image_version, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2020_09_30_preview::Models::GalleryImageVersion.mapper()
    ...
    # @return [GalleryImageVersion] operation results.
    #
    def begin_update(resource_group_name, gallery_name, gallery_image_name, gallery_image_version_name, gallery_image_version, custom_headers:nil)
      response = begin_update_async(resource_group_name, gallery_name, gallery_image_name, gallery_image_version_name, gallery_image_version, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure2::AzureOperationResponse] HTTP response information.
    #
    def begin_update_with_http_info(resource_group_name, gallery_name, gallery_image_name, gallery_image_version_name, gallery_image_version, custom_headers:nil)
      begin_update_async(resource_group_name, gallery_name, gallery_image_name, gallery_image_version_name, gallery_image_version, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def begin_update_async(resource_group_name, gallery_name, gallery_image_name, gallery_image_version_name, gallery_image_version, custom_headers:nil)
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'gallery_name is nil' if gallery_name.nil?
      fail ArgumentError, 'gallery_image_name is nil' if gallery_image_name.nil?
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2020_09_30_preview::Models::GalleryImageVersionUpdate.mapper()
      request_content = @client.serialize(request_mapper,  gallery_image_version)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    # will be added to the HTTP request.
    #
    # @return [GalleryImageVersionList] operation results.
    #
    def list_by_gallery_image_next(next_page_link, custom_headers:nil)
      response = list_by_gallery_image_next_async(next_page_link, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure2::AzureOperationResponse] HTTP response information.
    #
    def list_by_gallery_image_next_with_http_info(next_page_link, custom_headers:nil)
      list_by_gallery_image_next_async(next_page_link, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def list_by_gallery_image_next_async(next_page_link, custom_headers:nil)
    ...
    # will be added to the HTTP request.
    #
    # @return [GalleryImageVersionList] which provide lazy access to pages of the
    # response.
    #
    def list_by_gallery_image_as_lazy(resource_group_name, gallery_name, gallery_image_name, custom_headers:nil)
      response = list_by_gallery_image_async(resource_group_name, gallery_name, gallery_image_name, custom_headers:custom_headers).value!
      unless response.nil?
        page = response.body
        page.next_method = Proc.new do |next_page_link|
          list_by_gallery_image_next_async(next_page_link, custom_headers:custom_headers)
        end
        page
      end
    end
