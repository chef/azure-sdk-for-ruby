...
module Azure::Compute2::Mgmt::V2020_09_30_preview
  ...
  class GalleryImages
    ...
    def create_or_update_async(resource_group_name, gallery_name, gallery_image_name, gallery_image, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Compute2::Mgmt::V2020_09_30_preview::Models::GalleryImage.mapper()
    ...
    # @param resource_group_name [String] The name of the resource group.
    # @param gallery_name [String] The name of the Shared Image Gallery in which
    # the Image Definition is to be updated.
    # @param gallery_image_name [String] The name of the gallery image definition
    # to be updated. The allowed characters are alphabets and numbers with dots,
    # dashes, and periods allowed in the middle. The maximum length is 80
    # characters.
    # @param gallery_image [GalleryImageUpdate] Parameters supplied to the update
    ...
    def list_by_gallery_async(resource_group_name, gallery_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute2::Mgmt::V2020_09_30_preview::Models::GalleryImageList.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, gallery_name, gallery_image_name, gallery_image, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2020_09_30_preview::Models::GalleryImage.mapper()
    ...
    def begin_update_async(resource_group_name, gallery_name, gallery_image_name, gallery_image, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2020_09_30_preview::Models::GalleryImageUpdate.mapper()
      request_content = @client.serialize(request_mapper,  gallery_image)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
