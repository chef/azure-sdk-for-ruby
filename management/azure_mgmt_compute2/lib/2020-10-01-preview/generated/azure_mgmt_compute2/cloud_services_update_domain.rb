...
module Azure::Compute2::Mgmt::V2020_10_01_preview
  ...
  class CloudServicesUpdateDomain
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Compute2::Mgmt::V2020_10_01_preview::Models::UpdateDomain.mapper()
    ...
    def list_update_domains_async(resource_group_name, cloud_service_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute2::Mgmt::V2020_10_01_preview::Models::UpdateDomainListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_walk_update_domain_async(resource_group_name, cloud_service_name, update_domain, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2020_10_01_preview::Models::UpdateDomain.mapper()
