...
module Azure::Compute2::Mgmt::V2020_12_01
  ...
  class VirtualMachineRunCommands
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Compute2::Mgmt::V2020_12_01::Models::RunCommandListResult.mapper()
    ...
    def get_async(location, command_id, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute2::Mgmt::V2020_12_01::Models::RunCommandDocument.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, vm_name, run_command_name, run_command, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Compute2::Mgmt::V2020_12_01::Models::VirtualMachineRunCommand.mapper()
    ...
    def list_by_virtual_machine_async(resource_group_name, vm_name, expand:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute2::Mgmt::V2020_12_01::Models::VirtualMachineRunCommandsListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, vm_name, run_command_name, run_command, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2020_12_01::Models::VirtualMachineRunCommand.mapper()
    ...
    def begin_update_async(resource_group_name, vm_name, run_command_name, run_command, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2020_12_01::Models::VirtualMachineRunCommandUpdate.mapper()
      request_content = @client.serialize(request_mapper,  run_command)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
