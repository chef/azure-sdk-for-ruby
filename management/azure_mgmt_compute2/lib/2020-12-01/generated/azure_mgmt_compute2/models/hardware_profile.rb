...
module Azure::Compute2::Mgmt::V2020_12_01
  module Models
    ...
    class HardwareProfile
      ...
      # machine. <br><br> The enum data type is currently deprecated and will
      # be removed by December 23rd 2023. <br><br> Recommended way to get the
      # list of available sizes is using these APIs: <br><br> [List all
