...
module Azure::Compute2::Mgmt::V2020_12_01
  module Models
    ...
    class VirtualMachineScaleSet < Resource
      ...
      # group that the virtual machine scale set resides in. <br><br>Minimum
      ...
      # @return [OrchestrationMode] Specifies the orchestration mode for the
      # virtual machine scale set. Possible values include: 'Uniform',
      # 'Flexible'
      attr_accessor :orchestration_mode

      # @return [VirtualMachineScaleSetIdentity] The identity of the virtual
      # machine scale set, if configured.
      attr_accessor :identity

      # @return [Array<String>] The virtual machine scale set zones. NOTE:
      # Availability zones can only be set when you create the scale set
      attr_accessor :zones

      # @return [ExtendedLocation] The extended location of the Virtual Machine
      # Scale Set.
          ...
          type: {
            ...
            model_properties: {
              ...
              orchestration_mode: {
                client_side_validation: true,
                required: false,
                serialized_name: 'properties.orchestrationMode',
                type: {
                  name: 'String'
                }
              },
