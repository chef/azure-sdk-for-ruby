...
module Azure::Compute2::Mgmt::V2020_12_01
  module Models
    ...
    class OSProfile
      ...
      # 65535 bytes. <br><br> **Note: Do not pass any secrets or passwords in
      ...
      # allowed on the virtual machine. <br><br>This may only be set to False
      ...
      # required to infer provision success of the virtual machine.  **Note:
      # This property is for private testing only, and all customers must not
