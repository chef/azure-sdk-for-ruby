...
module Azure::Compute2::Mgmt::V2020_12_01
  module Models
    ...
    class RollingUpgradePolicy
      ...
      # @return [Boolean] Allow VMSS to ignore AZ boundaries when constructing
      # upgrade batches. Take into consideration the Update Domain and
      # maxBatchInstancePercent to determine the batch size.
      attr_accessor :enable_cross_zone_upgrade

      # @return [Boolean] Upgrade all unhealthy instances in a scale set before
      # any healthy instances.
      attr_accessor :prioritize_unhealthy_instances
