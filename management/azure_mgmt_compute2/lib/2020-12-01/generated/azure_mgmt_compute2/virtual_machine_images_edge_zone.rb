...
module Azure::Compute2::Mgmt::V2020_12_01
  ...
  # Compute Client
  #
  class VirtualMachineImagesEdgeZone
    ...
    # @param edge_zone [String] The name of the edge zone.
    ...
    # @param top [Integer] An integer value specifying the number of images to
    # return that matches supplied values.
    # @param orderby [String] Specifies the order of the results returned.
    # Formatted as an OData query.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
