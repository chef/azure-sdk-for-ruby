...
module Azure::Compute2::Mgmt::V2020_12_01
  ...
  class DedicatedHosts
    ...
    # @param host_name [String] The name of the dedicated host .
    # @param parameters [DedicatedHost] Parameters supplied to the Create Dedicated
    # Host.
    ...
    def create_or_update_async(resource_group_name, host_group_name, host_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Compute2::Mgmt::V2020_12_01::Models::DedicatedHost.mapper()
    ...
    # @param host_group_name [String] The name of the dedicated host group.
    # @param host_name [String] The name of the dedicated host .
    # @param parameters [DedicatedHostUpdate] Parameters supplied to the Update
    # Dedicated Host operation.
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [DedicatedHost] operation results.
    ...
    def list_by_host_group_async(resource_group_name, host_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute2::Mgmt::V2020_12_01::Models::DedicatedHostListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, host_group_name, host_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2020_12_01::Models::DedicatedHost.mapper()
    ...
    def begin_update_async(resource_group_name, host_group_name, host_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2020_12_01::Models::DedicatedHostUpdate.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    # will be added to the HTTP request.
    #
    # @return [DedicatedHostListResult] which provide lazy access to pages of the
    # response.
    #
