  ...
  class Snapshots
    ...
    def create_or_update_async(resource_group_name, snapshot_name, snapshot, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Compute2::Mgmt::V2020_06_30::Models::Snapshot.mapper()
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute2::Mgmt::V2020_06_30::Models::SnapshotList.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def grant_access_async(resource_group_name, snapshot_name, grant_access_data, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Compute2::Mgmt::V2020_06_30::Models::AccessUri.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def begin_create_or_update_async(resource_group_name, snapshot_name, snapshot, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2020_06_30::Models::Snapshot.mapper()
    ...
    def begin_update_async(resource_group_name, snapshot_name, snapshot, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2020_06_30::Models::SnapshotUpdate.mapper()
      request_content = @client.serialize(request_mapper,  snapshot)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def begin_grant_access_async(resource_group_name, snapshot_name, grant_access_data, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2020_06_30::Models::GrantAccessData.mapper()
