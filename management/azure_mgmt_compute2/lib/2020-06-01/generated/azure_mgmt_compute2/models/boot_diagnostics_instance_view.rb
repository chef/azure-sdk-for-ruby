...
module Azure::Compute2::Mgmt::V2020_06_01
  module Models
    ...
    class BootDiagnosticsInstanceView
      ...
      # @return [String] The console screenshot blob URI. <br><br>NOTE: This
      # will **not** be set if boot diagnostics is currently enabled with
      # managed storage.
      attr_accessor :console_screenshot_blob_uri

      # @return [String] The serial console log blob Uri. <br><br>NOTE: This
      # will **not** be set if boot diagnostics is currently enabled with
      # managed storage.
