...
module Azure::Compute2::Mgmt::V2020_06_01
  ...
  class VirtualMachineImages
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Compute2::Mgmt::V2020_06_01::Models::VirtualMachineImage.mapper()
    ...
    #
    def list(location, publisher_name, offer, skus, expand:nil, top:nil, orderby:nil, custom_headers:nil)
      response = list_async(location, publisher_name, offer, skus, expand:expand, top:top, orderby:orderby, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure2::AzureOperationResponse] HTTP response information.
    #
    def list_with_http_info(location, publisher_name, offer, skus, expand:nil, top:nil, orderby:nil, custom_headers:nil)
      list_async(location, publisher_name, offer, skus, expand:expand, top:top, orderby:orderby, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def list_async(location, publisher_name, offer, skus, expand:nil, top:nil, orderby:nil, custom_headers:nil)
      fail ArgumentError, 'location is nil' if location.nil?
      fail ArgumentError, 'publisher_name is nil' if publisher_name.nil?
      fail ArgumentError, 'offer is nil' if offer.nil?
      fail ArgumentError, 'skus is nil' if skus.nil?
