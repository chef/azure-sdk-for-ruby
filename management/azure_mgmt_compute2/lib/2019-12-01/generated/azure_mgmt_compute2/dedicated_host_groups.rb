...
module Azure::Compute2::Mgmt::V2019_12_01
  ...
  class DedicatedHostGroups
    ...
    def create_or_update_async(resource_group_name, host_group_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2019_12_01::Models::DedicatedHostGroup.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Compute2::Mgmt::V2019_12_01::Models::DedicatedHostGroup.mapper()
    ...
    def update_async(resource_group_name, host_group_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Compute2::Mgmt::V2019_12_01::Models::DedicatedHostGroupUpdate.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    # @return [DedicatedHostGroup] operation results.
    #
    def get(resource_group_name, host_group_name, custom_headers:nil)
      response = get_async(resource_group_name, host_group_name, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure2::AzureOperationResponse] HTTP response information.
    #
    def get_with_http_info(resource_group_name, host_group_name, custom_headers:nil)
      get_async(resource_group_name, host_group_name, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def get_async(resource_group_name, host_group_name, custom_headers:nil)
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, 'host_group_name is nil' if host_group_name.nil?
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
    ...
    def list_by_resource_group_async(resource_group_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Compute2::Mgmt::V2019_12_01::Models::DedicatedHostGroupListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
