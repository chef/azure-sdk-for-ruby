...
module Azure::OperationalInsights::Mgmt::V2020_08_01
  ...
  class StorageInsightConfigs
    ...
    def create_or_update_async(resource_group_name, workspace_name, storage_insight_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::OperationalInsights::Mgmt::V2020_08_01::Models::StorageInsight.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 201
          begin
            ...
            result_mapper = Azure::OperationalInsights::Mgmt::V2020_08_01::Models::StorageInsight.mapper()
    ...
    def list_by_workspace_async(resource_group_name, workspace_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::OperationalInsights::Mgmt::V2020_08_01::Models::StorageInsightListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
