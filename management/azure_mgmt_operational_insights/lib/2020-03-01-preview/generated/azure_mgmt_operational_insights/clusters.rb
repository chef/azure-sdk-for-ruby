...
module Azure::OperationalInsights::Mgmt::V2020_03_01_preview
  ...
  class Clusters
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::OperationalInsights::Mgmt::V2020_03_01_preview::Models::ClusterListResult.mapper()
    ...
    def create_or_update_async(resource_group_name, cluster_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::OperationalInsights::Mgmt::V2020_03_01_preview::Models::Cluster.mapper()
    ...
    def update_async(resource_group_name, cluster_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::OperationalInsights::Mgmt::V2020_03_01_preview::Models::ClusterPatch.mapper()
    ...
    def begin_create_or_update_async(resource_group_name, cluster_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::OperationalInsights::Mgmt::V2020_03_01_preview::Models::Cluster.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
