...
module Azure::OperationalInsights::Mgmt::V2020_03_01_preview
  ...
  class WorkspacePurge
    ...
    def purge_async(resource_group_name, workspace_name, body, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::OperationalInsights::Mgmt::V2020_03_01_preview::Models::WorkspacePurgeBody.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 202
          begin
            ...
            result_mapper = Azure::OperationalInsights::Mgmt::V2020_03_01_preview::Models::WorkspacePurgeResponse.mapper()
    ...
    def get_purge_status_async(resource_group_name, workspace_name, purge_id, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::OperationalInsights::Mgmt::V2020_03_01_preview::Models::WorkspacePurgeStatusResponse.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
