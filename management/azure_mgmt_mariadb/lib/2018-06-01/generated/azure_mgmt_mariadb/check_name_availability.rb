...
module Azure::MariaDB::Mgmt::V2018_06_01
  ...
  class CheckNameAvailability
    ...
    def execute_async(name_availability_request, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::MariaDB::Mgmt::V2018_06_01::Models::NameAvailabilityRequest.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::MariaDB::Mgmt::V2018_06_01::Models::NameAvailability.mapper()
