...
module Azure::MixedReality::Mgmt::V2020_05_01
  ...
  class SpatialAnchorsAccounts
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::MixedReality::Mgmt::V2020_05_01::Models::SpatialAnchorsAccountPage.mapper()
    ...
    def get_async(resource_group_name, account_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::MixedReality::Mgmt::V2020_05_01::Models::SpatialAnchorsAccount.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def update_async(resource_group_name, account_name, spatial_anchors_account, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::MixedReality::Mgmt::V2020_05_01::Models::SpatialAnchorsAccount.mapper()
    ...
    def list_keys_async(resource_group_name, account_name, custom_headers:nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MixedReality/spatialAnchorsAccounts/{accountName}/listKeys'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::MixedReality::Mgmt::V2020_05_01::Models::AccountKeys.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def regenerate_keys_async(resource_group_name, account_name, regenerate, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::MixedReality::Mgmt::V2020_05_01::Models::AccountKeyRegenerateRequest.mapper()
      request_content = @client.serialize(request_mapper,  regenerate)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil

      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MixedReality/spatialAnchorsAccounts/{accountName}/regenerateKeys'
