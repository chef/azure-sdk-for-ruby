...
module Azure::CostManagement::Mgmt::V2019_03_01_preview
  ...
  class Forecast
    ...
    #
    # Creates and initializes a new instance of the Forecast class.
    ...
    def usage_by_subscription_async(parameters, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/providers/Microsoft.CostManagement/Forecast'
    ...
    def usage_by_resource_group_async(resource_group_name, parameters, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.CostManagement/Forecast'
    ...
    def usage_by_billing_account_async(billing_account_id, parameters, custom_headers:nil)
      ...
      path_template = 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/providers/Microsoft.CostManagement/Forecast'
    ...
    def usage_by_enrollment_account_async(billing_account_id, enrollment_account_id, parameters, custom_headers:nil)
      ...
      path_template = 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/enrollmentAccounts/{enrollmentAccountId}/providers/Microsoft.CostManagement/Forecast'
    ...
    def usage_by_department_async(billing_account_id, department_id, parameters, custom_headers:nil)
      ...
      path_template = 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/departments/{departmentId}/providers/Microsoft.CostManagement/Forecast'
    ...
    def usage_by_management_group_async(management_group_id, parameters, custom_headers:nil)
      ...
      path_template = 'providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.CostManagement/Forecast'
    ...
    # @return [QueryResult] operation results.
    #
    def usage_by_external_billing_account(external_billing_account_name, parameters, custom_headers:nil)
      response = usage_by_external_billing_account_async(external_billing_account_name, parameters, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def usage_by_external_billing_account_with_http_info(external_billing_account_name, parameters, custom_headers:nil)
      usage_by_external_billing_account_async(external_billing_account_name, parameters, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def usage_by_external_billing_account_async(external_billing_account_name, parameters, custom_headers:nil)
      fail ArgumentError, '@client.api_version is nil' if @client.api_version.nil?
      ...
      path_template = 'providers/Microsoft.CostManagement/externalBillingAccounts/{externalBillingAccountName}/Forecast'
