...
module Azure::RecoveryServicesSiteRecovery::Mgmt::V2018_01_10
  ...
  class TargetComputeSizes
    ...
    #
    # Creates and initializes a new instance of the TargetComputeSizes class.
    ...
    #
    # @return [Array<TargetComputeSize>] operation results.
    #
    ...
    def list_by_replication_protected_items_async(fabric_name, protection_container_name, replicated_protected_item_name, custom_headers:nil)
      ...
      path_template = 'Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectedItems/{replicatedProtectedItemName}/targetComputeSizes'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::RecoveryServicesSiteRecovery::Mgmt::V2018_01_10::Models::TargetComputeSizeCollection.mapper()
    ...
    # will be added to the HTTP request.
    #
    # @return [TargetComputeSizeCollection] operation results.
    #
    ...
    # will be added to the HTTP request.
    #
    # @return [TargetComputeSizeCollection] which provide lazy access to pages of
    # the response.
    #
