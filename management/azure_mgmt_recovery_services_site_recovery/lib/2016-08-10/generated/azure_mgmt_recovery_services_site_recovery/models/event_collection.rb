...
module Azure::RecoveryServicesSiteRecovery::Mgmt::V2016_08_10
  module Models
    ...
    class EventCollection
      ...
      # @return [Array<Event>] The list of events.
      attr_accessor :value
      ...
      #
      # @return [EventCollection] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for EventCollection class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'EventCollection',
          type: {
            name: 'Composite',
