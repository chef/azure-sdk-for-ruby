...
module Azure::ADHybridHealthService::Mgmt::V2014_01_01
  module Models
    ...
    class Alerts
      ...
      # @return [Array<Alert>] The value returned by the operation.
      attr_accessor :value

      # @return [String] The link used to get the next page of operations.
      attr_accessor :next_link

      # @return [Integer] The total count of alert elements.
      ...
      #
      # @return [Alerts] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for Alerts class as Ruby Hash.
