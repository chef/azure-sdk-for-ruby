...
module Azure::ADHybridHealthService::Mgmt::V2014_01_01
  module Models
    ...
    class MetricMetadataList
      ...
      # @return [Array<MetricMetadata>] The value returned by the operation.
      attr_accessor :value
      ...
      #
      # @return [MetricMetadataList] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for MetricMetadataList class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'MetricMetadataList',
          type: {
            name: 'Composite',
            class_name: 'MetricMetadataList',
            model_properties: {
              next_link: {
                client_side_validation: true,
                required: false,
              ...
              value: {
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'MetricMetadataElementType',
                      type: {
                        name: 'Composite',
