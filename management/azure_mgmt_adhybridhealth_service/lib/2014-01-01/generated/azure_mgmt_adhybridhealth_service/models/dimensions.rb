...
module Azure::ADHybridHealthService::Mgmt::V2014_01_01
  module Models
    ...
    class Dimensions
      ...
      # @return [Array<Dimension>] The value returned by the operation.
      attr_accessor :value

      # @return [Integer] The total count of dimensions.
      ...
      #
      # @return [Dimensions] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for Dimensions class as Ruby Hash.
