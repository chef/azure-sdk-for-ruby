...
module Azure::ADHybridHealthService::Mgmt::V2014_01_01
  ...
  class AddsService
    ...
    #
    # Creates and initializes a new instance of the AddsService class.
    ...
    def get_metrics_async(service_name, metric_name, group_name, group_key:nil, from_date:nil, to_date:nil, custom_headers:nil)
      ...
      path_template = 'providers/Microsoft.ADHybridHealthService/addsservices/{serviceName}/metrics/{metricName}/groups/{groupName}'
