...
module Azure::ADHybridHealthService::Mgmt::V2014_01_01
  ...
  #
  class AddsServicesReplicationStatus
    include MsRestAzure

    #
    # Creates and initializes a new instance of the AddsServicesReplicationStatus class.
    ...
    #
    # Gets Replication status for a given Active Directory Domain Service, that is
    ...
    def get_async(service_name, custom_headers:nil)
      ...
      path_template = 'providers/Microsoft.ADHybridHealthService/addsservices/{serviceName}/replicationstatus'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::ADHybridHealthService::Mgmt::V2014_01_01::Models::ReplicationStatus.mapper()
