...
module Azure::Mysql::Mgmt::V2017_12_01
  ...
  class FirewallRules
    ...
    def create_or_update_async(resource_group_name, server_name, firewall_rule_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Mysql::Mgmt::V2017_12_01::Models::FirewallRule.mapper()
    ...
    def list_by_server_async(resource_group_name, server_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Mysql::Mgmt::V2017_12_01::Models::FirewallRuleListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_or_update_async(resource_group_name, server_name, firewall_rule_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Mysql::Mgmt::V2017_12_01::Models::FirewallRule.mapper()
