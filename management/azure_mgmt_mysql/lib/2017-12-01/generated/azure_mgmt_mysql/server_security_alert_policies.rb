...
module Azure::Mysql::Mgmt::V2017_12_01
  ...
  class ServerSecurityAlertPolicies
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Mysql::Mgmt::V2017_12_01::Models::ServerSecurityAlertPolicy.mapper()
    ...
    def begin_create_or_update_async(resource_group_name, server_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Mysql::Mgmt::V2017_12_01::Models::ServerSecurityAlertPolicy.mapper()
