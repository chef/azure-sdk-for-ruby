...
module Azure::Storage::Mgmt::V2016_12_01
  ...
  class StorageAccounts
    ...
    def check_name_availability_async(account_name, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Storage::Mgmt::V2016_12_01::Models::StorageAccountCheckNameAvailabilityParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Storage::Mgmt::V2016_12_01::Models::CheckNameAvailabilityResult.mapper()
    ...
    def create_async(resource_group_name, account_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        ...
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Storage::Mgmt::V2016_12_01::Models::StorageAccount.mapper()
    ...
    def update_async(resource_group_name, account_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Storage::Mgmt::V2016_12_01::Models::StorageAccountUpdateParameters.mapper()
    ...
    def list_async(custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Storage::Mgmt::V2016_12_01::Models::StorageAccountListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_keys_async(resource_group_name, account_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Storage::Mgmt::V2016_12_01::Models::StorageAccountListKeysResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def regenerate_key_async(resource_group_name, account_name, regenerate_key, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Storage::Mgmt::V2016_12_01::Models::StorageAccountRegenerateKeyParameters.mapper()
    ...
    def list_account_sas_async(resource_group_name, account_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Storage::Mgmt::V2016_12_01::Models::AccountSasParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Storage::Mgmt::V2016_12_01::Models::ListAccountSasResponse.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_service_sas_async(resource_group_name, account_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Storage::Mgmt::V2016_12_01::Models::ServiceSasParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Storage::Mgmt::V2016_12_01::Models::ListServiceSasResponse.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_create_async(resource_group_name, account_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Storage::Mgmt::V2016_12_01::Models::StorageAccountCreateParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
