...
module Azure::Storage::Mgmt::V2019_04_01
  ...
  class ManagementPolicies
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Storage::Mgmt::V2019_04_01::Models::ManagementPolicy.mapper()
    ...
    def create_or_update_async(resource_group_name, account_name, properties, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Storage::Mgmt::V2019_04_01::Models::ManagementPolicy.mapper()
