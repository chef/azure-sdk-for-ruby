...
module Azure::Storage::Mgmt::V2020_08_01_preview
  ...
  class ObjectReplicationPoliciesOperations
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Storage::Mgmt::V2020_08_01_preview::Models::ObjectReplicationPolicies.mapper()
    ...
    def get_async(resource_group_name, account_name, object_replication_policy_id, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Storage::Mgmt::V2020_08_01_preview::Models::ObjectReplicationPolicy.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, account_name, object_replication_policy_id, properties, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Storage::Mgmt::V2020_08_01_preview::Models::ObjectReplicationPolicy.mapper()
