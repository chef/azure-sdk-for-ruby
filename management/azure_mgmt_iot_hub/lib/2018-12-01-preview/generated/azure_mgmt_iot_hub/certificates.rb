...
module Azure::IotHub::Mgmt::V2018_12_01_preview
  ...
  class Certificates
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::IotHub::Mgmt::V2018_12_01_preview::Models::CertificateListDescription.mapper()
    ...
    def get_async(resource_group_name, resource_name, certificate_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::IotHub::Mgmt::V2018_12_01_preview::Models::CertificateDescription.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def create_or_update_async(resource_group_name, resource_name, certificate_name, certificate_description, if_match:nil, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::IotHub::Mgmt::V2018_12_01_preview::Models::CertificateBodyDescription.mapper()
    ...
    def generate_verification_code_async(resource_group_name, resource_name, certificate_name, if_match, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::IotHub::Mgmt::V2018_12_01_preview::Models::CertificateWithNonceDescription.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def verify_async(resource_group_name, resource_name, certificate_name, certificate_verification_body, if_match, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::IotHub::Mgmt::V2018_12_01_preview::Models::CertificateVerificationDescription.mapper()
