...
module Azure::IotHub::Mgmt::V2019_03_22_preview
  module Models
    ...
    class EndpointHealthDataListResult
      ...
      # @return [String] Link to more results
      ...
      #
      # @return [EndpointHealthDataListResult] with next page content.
      #
      def get_next_page
      ...
      #
      # Mapper for EndpointHealthDataListResult class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'EndpointHealthDataListResult',
          type: {
            name: 'Composite',
            class_name: 'EndpointHealthDataListResult',
            model_properties: {
              value: {
                client_side_validation: true,
                required: false,
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'EndpointHealthDataElementType',
                      type: {
                        name: 'Composite',
