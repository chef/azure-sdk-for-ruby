...
module Azure::Monitor::Mgmt::V2019_06_01
  ...
  class ActionGroups
    ...
    def create_or_update_async(resource_group_name, action_group_name, action_group, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Monitor::Mgmt::V2019_06_01::Models::ActionGroupResource.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Monitor::Mgmt::V2019_06_01::Models::ActionGroupResource.mapper()
    ...
    def update_async(resource_group_name, action_group_name, action_group_patch, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Monitor::Mgmt::V2019_06_01::Models::ActionGroupPatchBody.mapper()
    ...
    def list_by_subscription_id_async(custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Monitor::Mgmt::V2019_06_01::Models::ActionGroupList.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def enable_receiver_async(resource_group_name, action_group_name, enable_request, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Monitor::Mgmt::V2019_06_01::Models::EnableRequest.mapper()
