...
module Azure::Monitor::Mgmt::V2015_05_01
  ...
  class Workbooks
    ...
    #
    def list_by_resource_group(resource_group_name, category, tags:nil, can_fetch_content:nil, custom_headers:nil)
      response = list_by_resource_group_async(resource_group_name, category, tags:tags, can_fetch_content:can_fetch_content, custom_headers:custom_headers).value!
    ...
    #
    def list_by_resource_group_with_http_info(resource_group_name, category, tags:nil, can_fetch_content:nil, custom_headers:nil)
      list_by_resource_group_async(resource_group_name, category, tags:tags, can_fetch_content:can_fetch_content, custom_headers:custom_headers).value!
    end
    ...
    #
    def list_by_resource_group_async(resource_group_name, category, tags:nil, can_fetch_content:nil, custom_headers:nil)
      ...
      options = {
          ...
          query_params: {'category' => category,'tags' => tags.nil? ? nil : tags.join(','),'canFetchContent' => can_fetch_content,'api-version' => @client.api_version},
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Monitor::Mgmt::V2015_05_01::Models::WorkbooksListResult.mapper()
    ...
    def get_async(resource_group_name, resource_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Monitor::Mgmt::V2015_05_01::Models::Workbook.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # @return [Workbook] operation results.
    #
    def create_or_update(resource_group_name, resource_name, workbook_properties, custom_headers:nil)
      response = create_or_update_async(resource_group_name, resource_name, workbook_properties, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def create_or_update_with_http_info(resource_group_name, resource_name, workbook_properties, custom_headers:nil)
      create_or_update_async(resource_group_name, resource_name, workbook_properties, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def create_or_update_async(resource_group_name, resource_name, workbook_properties, custom_headers:nil)
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, "'@client.subscription_id' should satisfy the constraint - 'MinLength': '1'" if !@client.subscription_id.nil? && @client.subscription_id.length < 1
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MaxLength': '90'" if !resource_group_name.nil? && resource_group_name.length > 90
      ...
      # Serialize Request
      request_mapper = Azure::Monitor::Mgmt::V2015_05_01::Models::Workbook.mapper()
    ...
    # @return [Workbook] operation results.
    #
    def update(resource_group_name, resource_name, workbook_properties, custom_headers:nil)
      response = update_async(resource_group_name, resource_name, workbook_properties, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def update_with_http_info(resource_group_name, resource_name, workbook_properties, custom_headers:nil)
      update_async(resource_group_name, resource_name, workbook_properties, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def update_async(resource_group_name, resource_name, workbook_properties, custom_headers:nil)
      fail ArgumentError, '@client.subscription_id is nil' if @client.subscription_id.nil?
      fail ArgumentError, "'@client.subscription_id' should satisfy the constraint - 'MinLength': '1'" if !@client.subscription_id.nil? && @client.subscription_id.length < 1
      fail ArgumentError, 'resource_group_name is nil' if resource_group_name.nil?
      fail ArgumentError, "'resource_group_name' should satisfy the constraint - 'MaxLength': '90'" if !resource_group_name.nil? && resource_group_name.length > 90
