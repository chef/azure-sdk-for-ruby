...
module Azure::Monitor::Mgmt::V2015_05_01
  ...
  #
  class WebTestLocations
    include MsRestAzure

    #
    # Creates and initializes a new instance of the WebTestLocations class.
    ...
    #
    # @return [ApplicationInsightsWebTestLocationsListResult] operation results.
    #
    ...
    def list_async(resource_group_name, resource_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/components/{resourceName}/syntheticmonitorlocations'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Monitor::Mgmt::V2015_05_01::Models::ApplicationInsightsWebTestLocationsListResult.mapper()
