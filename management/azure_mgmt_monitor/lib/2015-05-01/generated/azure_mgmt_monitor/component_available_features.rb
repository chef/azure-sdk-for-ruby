...
module Azure::Monitor::Mgmt::V2015_05_01
  ...
  class ComponentAvailableFeatures
    ...
    #
    # Creates and initializes a new instance of the ComponentAvailableFeatures class.
    ...
    #
    # @return [ApplicationInsightsComponentAvailableFeatures] operation results.
    #
    ...
    def get_async(resource_group_name, resource_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/components/{resourceName}/getavailablebillingfeatures'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Monitor::Mgmt::V2015_05_01::Models::ApplicationInsightsComponentAvailableFeatures.mapper()
