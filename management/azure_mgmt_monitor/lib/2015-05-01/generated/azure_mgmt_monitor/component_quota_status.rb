...
module Azure::Monitor::Mgmt::V2015_05_01
  ...
  class ComponentQuotaStatus
    ...
    #
    # Creates and initializes a new instance of the ComponentQuotaStatus class.
    ...
    #
    # @return [ApplicationInsightsComponentQuotaStatus] operation results.
    #
    ...
    def get_async(resource_group_name, resource_name, custom_headers:nil)
      ...
      path_template = 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/components/{resourceName}/quotastatus'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Monitor::Mgmt::V2015_05_01::Models::ApplicationInsightsComponentQuotaStatus.mapper()
