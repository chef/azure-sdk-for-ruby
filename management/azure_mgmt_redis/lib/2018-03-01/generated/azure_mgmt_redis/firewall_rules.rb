...
module Azure::Redis::Mgmt::V2018_03_01
  ...
  class FirewallRules
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Redis::Mgmt::V2018_03_01::Models::RedisFirewallRuleListResult.mapper()
    ...
    def create_or_update_async(resource_group_name, cache_name, rule_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Redis::Mgmt::V2018_03_01::Models::RedisFirewallRuleCreateParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Redis::Mgmt::V2018_03_01::Models::RedisFirewallRule.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest2::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
