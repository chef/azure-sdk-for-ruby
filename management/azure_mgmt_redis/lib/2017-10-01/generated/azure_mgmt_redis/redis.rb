...
module Azure::Redis::Mgmt::V2017_10_01
  ...
  class Redis
    ...
    def check_name_availability_async(parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Redis::Mgmt::V2017_10_01::Models::CheckNameAvailabilityParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Azure::Redis::Mgmt::V2017_10_01::Models::NotificationListResponse.mapper()
